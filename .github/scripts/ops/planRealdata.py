...
INFRA_PREFIXES: tuple[str, ...] = (
    ...
    ".github/scripts/planRealdata.py",
    "scripts/audit/publicApiScenarios.yml",
    "scripts/audit/productSmoke.py",
    "scripts/audit/publicApiCoverage.py",
    "scripts/audit/memoryBudgetAudit.py",
    "scripts/audit/resourceBudgets.json",
    "scripts/dev/test-realdata.sh",
    "scripts/dev/test-lock.sh",
