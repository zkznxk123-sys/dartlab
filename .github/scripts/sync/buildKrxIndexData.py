...
Examples
--------
``uv run python -X utf8 .github/scripts/sync/buildKrxIndexData.py --mode incremental --push``
``uv run python -X utf8 .github/scripts/sync/buildKrxIndexData.py --mode backfill --start 2010-01-01 --end 2026-04-28 --push``
