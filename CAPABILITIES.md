...
| `fields` | 필드카탈로그 | 조건형 스크리닝용 필드 검색 (finance/report/docs/krx/krxIndex) | query | - | DataFrame |
| `screen` | 스크리닝 | 멀티팩터 프리셋 + spec 기반 조건형 스크리닝 | target | - | DataFrame |
