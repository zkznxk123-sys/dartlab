...
>
> <img src=".github/assets/sections-example.webp" alt="c.panel() 출력 예시 — 삼성전자 공시 항목 × 기간" width="720">

```python

c.panel("IS")                       # 손익계산서 — 분기가 기본 (finance 정규화)
```

> 분기별 재무제표가 기본 — snakeId + 한글 항목명 동시 제공
>
> <img src=".github/assets/show-is-quarterly.webp" alt="c.panel('IS') — 삼성전자 분기 손익계산서" width="720">
...
> 같은 데이터, 연간으로 — 소문자=native(사업보고서 깊은 history) / 대문자=finance(정규화)
>
> <img src=".github/assets/show-is-annual.webp" alt="c.panel('IS', freq='year') — 삼성전자 연간 손익계산서" width="720">
