...
여기서 dartlab 의 한계가 정직하게 드러난다. dartlab 은 한국 공시 데이터 엔진이다. 미국 18~24세 여성의 TikTok 검색 트렌드는 못 본다. 그래서 이 글의 결론은 정량 모델의 답이 아니라 사용자 본인이 매 분기 직접 4가지 신호를 검증해야 한다는 것이다.
