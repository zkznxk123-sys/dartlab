...
c.story()              # 6막 자동 보고서
c.credit("등급")         # 신용평가
c.show("dividend")       # DPS 9년 시계열 (analysis 결손 우회)
```
...
\* CF상 dividendsPaid 분기 합산값. 본문 5막에서 인용한 주당배당금(2025년 4,800원)는 별도 출처(`c.show("dividend").dps`)이며 두 경로의 절대값이 다르다 — CF상 200억과 주당배당금×발행주식 추정 약 360억대의 차이는 별도 audit으로 추적 예정.
