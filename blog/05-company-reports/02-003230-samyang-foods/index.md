...
먼저 삼양식품 9년 손익계산서를 한 화면에 펼쳐 보자. 매출이 4,584억에서 23,518억으로 5.1배 늘었다. 그런데 매출원가는 3,372억에서 13,023억으로 3.9배만 늘었다. 매출이 5배가 되는 동안 원가는 4배에만 머물렀다 — 그 차이가 그대로 매출총이익에 떨어졌다. 매출총이익은 1,212억에서 10,495억으로 **8.7배**다. 그리고 판관비는 727억에서 5,253억으로 7.2배 — 판관비가 매출보다 빠르게 늘어나는 흔한 현상이 여기서는 일어나지 않았다. 결과: 영업이익이 485억에서 5,242억으로 **10.8배**.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 매출액 | **23,518** | 17,280 | 11,929 | 9,090 | 6,420 | 6,485 | 5,435 | 4,693 | 4,584 |
| 매출원가 | 13,023 | 10,032 | 7,847 | 6,627 | 4,690 | 4,608 | 3,919 | 3,394 | 3,372 |
| 매출총이익 | **10,495** | 7,248 | 4,082 | 2,463 | 1,730 | 1,877 | 1,516 | 1,299 | 1,212 |
| 판관비 | 5,253 | 3,773 | 2,761 | 1,640 | 1,069 | 1,033 | 807 | 728 | 727 |
| 영업이익 | **5,242** | 3,475 | 1,321 | 904 | 685 | 844 | 710 | 572 | 485 |
| 당기순이익 | **3,860** | 2,679 | 1,344 | 772 | 617 | 732 | 594 | 390 | 283 |
...
먼저 9년 BS와 CF를 한 화면에 펼쳐 보자. 자산총계는 4,007억에서 22,030억으로 5.5배가 됐다. 거의 전부가 자본총계 증가(2,026 → 12,758억, 6.3배)에서 왔다 — 회사가 영업이익으로 자본을 키운 그림이 그대로다. 부채총계도 1,981 → 9,272억으로 4.7배 늘었지만 자산 대비 비중은 49%에서 42%로 오히려 줄었다. 핵심은 차입에 의존하지 않고 영업이익으로 회사를 키웠다는 것이다.

```python
c.select("BS", ["자산총계","부채총계","자본총계","현금및현금성자산","단기금융상품"])
```

| 항목 (억원, Q4) | 2025 | 2024 | 2023 | 2022 | 2021 | 2020 | 2019 | 2018 | 2017 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 자산총계 | **22,030** | 15,930 | 11,720 | 9,239 | 7,464 | 5,621 | 4,699 | 4,143 | 4,007 |
| 부채총계 | 9,272 | 7,711 | 5,895 | 4,743 | 3,615 | 2,089 | 1,793 | 1,761 | 1,981 |
| 자본총계 | **12,758** | 8,219 | 5,825 | 4,496 | 3,949 | 3,531 | 2,906 | 2,381 | 2,026 |
| 현금및현금성 | 3,328 | 3,343 | 2,236 | 974 | 1,074 | 969 | 893 | 521 | 500 |
| 단기금융상품 | 0 | 0 | 176 | 0 | 0 | 0 | 0 | 0 | 0 |
...
| 당기순이익 | 0.39 | 0.27 | 0.13 | 0.08 | 0.06 | 0.07 | 0.06 | 0.04 | 0.03 | 0.02 |
