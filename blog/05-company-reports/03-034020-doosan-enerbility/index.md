...
| 단기금융상품 | 0.11 | 0.14 | 0.12 | 0.11 | 0.52 | 0.32 | 0.27 | 0.39 | 0.24 | 0.21 |
...
| 9년 영업이익 매년 흑자 (4,092~14,673억) | `c.select("IS", ["영업이익"], freq="Y")` 분기 합산 | ✅ 실측 |
| 매출 9년 14~17조 평탄 | `c.select("IS", ["매출액"], freq="Y")` 분기 합산 | ✅ 실측 |
| (지배주주)순이익 2016~2020 적자, 2021 +4,953억 일시 흑자, 2022 -7,725억, 2023~2025 3년 연속 흑자(+556/+1,114/+848억) | `c.select("IS", ["(지배주주지분)당기순이익"], freq="Y")` 분기 합산 | ✅ 실측 |
| 2025 1년치 영업이익 7,627억 | 분기 합산 | ✅ 실측 |
| 2025 1년치 금융비용 12,206억 | `c.select("IS", ["금융비용"], freq="Y")` 분기 합산 | ✅ 실측 |
