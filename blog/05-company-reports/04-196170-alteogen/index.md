...
## 5막 — 2025, 진짜 폭발. 매출 31배 / 영업이익률 49.52% / ROIC 49.27%

2025년 결산. 매출 **2,159억** (전년 대비 +110%). 영업이익 **+1,069억** (전년 대비 +321%). 당기순이익 **+1,452억** (전년 대비 +139%). 영업이익률 **49.52%**. 매출총이익률 **76.73%**. ROIC **49.27%** (WACC 약 11%, spread +38pp). 차입금 약 50억 (사실상 무차입). 현금성자산 + 단기금융상품 합계 약 4,300억.
...
**한국 상장사 중 영업이익률 49%를 1년 평균으로 찍는 회사는 손에 꼽는다.** 그리고 dartlab의 ROIC Tree가 알테오젠을 자동 분류한 결과는 다음과 같다.
...
![9년 누적 영업손실 회수 폭포 — 한 해에 다 회수](./assets/04-cumulative-recovery.svg)

이 그래프가 본 글의 가장 결정적인 한 화면이다. 2016년부터 2023년까지 8년 동안 알테오젠의 누적 영업이익은 약 -776억(거의 매년 적자, 2020년만 +1억). 2024년에 +254억으로 처음 의미 있는 흑자를 냈고, 2025년에 +1,069억으로 폭발했다. **2025년 한 해 영업이익이 9년 누적 영업손실보다 293억 더 크다.** 즉 9년의 R&D 적자가 한 해의 흑자에 흡수되고도 흑자가 더 남았다.
...
| 영업CF − CAPEX | **+1,011** | +503 | -90 | -243 | -230 | -34 | +41 | -163 | -50 |
...
dartlab의 신용등급은 **dCR-AA-, score 9.89, healthScore 90.11, 긍정적 outlook**. divergenceExplanation은 "사업안정성 축이 40점으로 등급 하방 압력" — 즉 회사가 단일 라이선스(머크 키트루다 SC)에 매출 의존도가 매우 높다는 점이 등급 상승을 누르고 있다. 이게 다음 막에서 봐야 할 진짜 질문이다.
...
2025년 +1,069억은 일회성인가, 새 시대의 시작인가. dartlab이 답할 수 있는 것은 한계가 있다 — dartlab은 한국 공시 데이터 엔진이고, 머크 키트루다 SC의 글로벌 매출 진행이나 다이이찌산쿄/산도즈/인타스 같은 다른 빅파마와의 추가 라이선스 가능성은 직접 보지 못한다. 그래서 본 글의 결론은 정량 모델의 답이 아니라, 사용자 본인이 매 분기 직접 4가지 신호를 검증해야 한다는 것이다.
...
본문에서 다룬 모든 사건이 dartlab의 손익계산서·재무상태표·현금흐름표에 어떻게 찍혀 있는지 한 화면에 펼친다.

### 손익계산서 (IS) — 단위 조원, 1년치 합산
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 매출액 | 0.22 | 0.10 | 0.10 | 0.03 | 0.04 | 0.04 | 0.03 | 0.01 | 0.01 | 0.01 |
| 매출원가 | 0.05 | 0.04 | 0.07 | 0.02 | 0.03 | 0.02 | 0.02 | 0.01 | 0.01 | 0.01 |
| 매출총이익 | 0.17 | 0.06 | 0.03 | 0.00 | 0.01 | 0.02 | 0.01 | 0.00 | 0.00 | 0.00 |
| 판매비와관리비 | 0.06 | 0.04 | 0.04 | 0.03 | 0.02 | 0.02 | 0.01 | 0.01 | 0.01 | 0.01 |
| 영업이익 | 0.11 | 0.03 | -0.01 | -0.03 | -0.01 | 0.00 | -0.00 | -0.01 | -0.01 | -0.01 |
| 당기순이익 | 0.15 | 0.06 | -0.00 | -0.01 | -0.01 | -0.00 | -0.00 | -0.01 | -0.01 | -0.00 |


### 재무상태표 (BS) — 단위 조원, Q4 스냅샷
...
| 항목 | 2025 | 2024 | 2023 | 2022 | 2021 | 2020 | 2019 | 2018 | 2017 | 2016 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 자산총계 | 0.70 | 0.41 | 0.26 | 0.25 | 0.26 | 0.16 | 0.09 | 0.07 | 0.04 | 0.05 |
| 부채총계 | 0.24 | 0.13 | 0.11 | 0.10 | 0.13 | 0.02 | 0.02 | 0.00 | 0.00 | 0.00 |
| 자본총계 | 0.45 | 0.27 | 0.15 | 0.15 | 0.13 | 0.14 | 0.07 | 0.07 | 0.04 | 0.05 |
| 현금및현금성자산 | 0.07 | 0.02 | 0.03 | 0.05 | 0.01 | 0.04 | 0.00 | 0.01 | 0.01 | 0.01 |


### 현금흐름표 (CF) — 단위 억원, 1년치 합산
...
| 항목 | 2025 | 2024 | 2023 | 2022 | 2021 | 2020 | 2019 | 2018 | 2017 | 2016 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 영업활동현금흐름 | 1,241 | 530 | -78 | -179 | -94 | 17 | 105* | -91 | -43 | -32 |
| 유형자산의 취득 | — | — | — | — | — | — | — | — | — | — |
| 배당금지급 | — | — | — | — | — | — | — | — | — | — |
...
## 결론 — 한 사람의 17년이 한 회사의 인생을 바꿨다

2008년 5월 박순재가 LG생명과학을 그만두고 작은 바이오텍을 세우던 그 순간으로부터 17년 8개월. 그 사이 회사는 11년 동안 매년 영업적자였고, 2014년 코스닥에 상장했지만 시장은 거의 모르고 지나갔고, 2020년 머크와 라이선스 한 건을 맺었지만 시장은 일회성으로 받아들였고, 2021~2023년 다시 적자로 돌아갔고, 그 사이 박순재는 머크와 함께 키트루다 SC 임상을 준비했고, 2024년 2월 마침내 머크와의 계약이 exclusive로 전환됐고, 2025년 매출 2,159억, 영업이익 +1,069억으로 폭발했다.

dartlab으로 본 이 글의 결론은 다음 한 줄이다.

> **알테오젠의 +1,069억은 운이 아니다. 한 사람이 17년 동안 같은 효소 한 종류(ALT-B4)를 다듬은 결과이고, 그 효소가 마침내 글로벌 톱 매출 의약품의 핵심 변환 기술이 된 것이다. 9년의 적자가 한 해의 흑자에 흡수됐다.**

2026년에 가장 결정적인 한 줄이 무엇인지를 미리 적어 두자. **머크 키트루다 SC의 2026년 글로벌 매출이 50억 달러를 넘는가**. 그게 알테오젠 마일스톤 인식 속도와 로열티 2%의 실제 가치를 결정한다. 만약 키트루다 SC가 2026년 50억 달러를 넘으면, 2027년부터 알테오젠 연간 매출은 5,000억대를 넘는다 — 회사가 다른 단계로 진입한다. 만약 50억 달러를 못 넘으면, 2025년 +1,069억은 일회성 갱신금 인식의 정점이 된다.

박순재는 2026년에 72세가 된다. 그가 2008년에 50대 초반에 만든 회사는, 17년 만에 처음으로 그가 만든 효소가 진짜로 사람들 몸에 들어가기 시작한 해를 맞이한다.
...
| 본문 수치 | dartlab 호출 | 결과 |
|---|---|---|
| 2025 연간 매출 2,159억 | `c.select("IS",["매출액"])` 분기 합산 | ✅ 실측 |
| 2025 연간 영업이익 +1,069억 | `c.select("IS",["영업이익"])` 분기 합산 | ✅ 실측 |
| 2025 영업이익률 49.52% (1년치) | `c.analysis("수익성")["marginWaterfall"]` | ✅ 실측 |
| 2025 매출총이익률 76.73% (1년치) | 동일 | ✅ 실측 |
| 2025 ROIC 49.27% / WACC ~11% | `c.analysis("수익성")["roicTree"]` | ✅ 실측 |
| `marginDriver: '높은 가격결정력 (매출총이익률 > 40%)'` | 동일 | ✅ 자체 출력 인용 |
| 2025 당기순이익 +1,452억 | `c.select("IS",["당기순이익"])` 분기 합산 | ✅ 실측 |
| 2024 영업이익 +254억 | 동일 | ✅ 실측 |
| 2022 영업이익 -294억 (사상 최악) | 동일 | ✅ 실측 |
| 2020 영업이익 +1억 (첫 BEP) | 동일 | ✅ 실측 |
| 2016 매출 68억 → 2025 2,159억 = 31.7배 | 동일 | ✅ 실측 |
| 9년 누적 영업손실 약 -776억 | 2016~2023 합산 | ✅ 실측 |
| 차입금 합계 약 50억 (사실상 무차입) | `c.analysis("자금조달")["fundingSources"]["notesDetail"]["borrowings"]` | ✅ 실측 |
| 현금성자산 + 단기금융상품 ≈ 4,300억 | `c.select("BS",["현금및현금성자산","단기금융상품"])` Q4 | ✅ 실측 |
| dCR-AA- score 9.89 healthScore 90.11 / 긍정적 / 건강관리 | `c.credit("등급")` | ✅ 실측 |
| divergence: 사업안정성 40점 (등급 하방 압력) | 동일 | ✅ 자체 출력 인용 |
| 박순재 1954년 12월 22일 군산 출생 / 연세대 / 퍼듀대 / LG생명과학 | 외부 (businesspost) | 외부 인용 |
| 2008년 5월 알테오젠 창업 (아내 정혜신 한남대 교수와 함께) | 외부 (businesspost) | 외부 인용 |
| 2014년 12월 코스닥 상장 | 공시 | ✅ |
| 2020년 6월 17일 머크 1차 계약 (계약금 1,600만 달러) | 외부 (바이오스펙테이터) | 외부 인용 |
| 2024년 2월 머크 갱신 (exclusive 전환, 추가 2,000만 달러, 마일스톤 4억3,200만 달러 증액) | 외부 (바이오스펙테이터, businesspost) | 외부 인용 |
| 마일스톤 총액 약 10억 달러 (≈1조 4,770억원) | 외부 | 외부 인용 |
| 로열티 약 2% (마일스톤 후, 머크 SEC 공시) | 외부 (이투데이, businesspost) | 외부 인용 |
| 2025년 11월 유럽 허가 → 마일스톤 219억 수령 | 외부 (파이낸셜뉴스) | 외부 인용 |
| 키트루다 머크 매출의 약 40% / 2024년 약 295억 달러 | 외부 (머크 IR) | 외부 인용 |
| 경쟁사 Halozyme ENHANZE 플랫폼 (로슈/얀센/화이자/다케다) | 외부 (바이오타임즈) | 외부 인용 |

## 외부 출처

- [박순재 알테오젠 대표 인물 - businesspost](https://www.businesspost.co.kr/BP?command=article_view&num=368469)
- [머크 갱신 4.5억 달러 딜 - 바이오스펙테이터](https://www.biospectator.com/news/view/21147)
- [키트루다 SC 로열티 2% 입장문 - businesspost](https://www.businesspost.co.kr/BP?command=article_view&num=427595)
- [머크 SEC 공시 로열티 이슈 - 이투데이](https://www.etoday.co.kr/news/view/2549321)
- [키트루다 SC 유럽 허가 마일스톤 219억 - 파이낸셜뉴스](https://www.fnnews.com/news/202511280908399046)
- [알테오젠 vs 할로자임 SC 제형 전환 대전 - 바이오타임즈](https://www.biotimes.co.kr/news/articleView.html?idxno=17534)
- [Pembrolizumab - Wikipedia](https://en.wikipedia.org/wiki/Pembrolizumab)
...
c.select("BS", ["자산총계","부채총계","자본총계","현금및현금성자산","단기금융상품"])
c.select("CF", ["영업활동현금흐름","유형자산의 취득"])
c.select("ratios", ["영업이익률 (%)","매출총이익률 (%)","부채비율 (%)","ROE (%)"])

c.credit("등급")                           # dCR-AA- / 긍정적
c.analysis("financial", "수익성")           # marginWaterfall, roicTree, penmanDecomposition
c.analysis("financial", "자금조달")         # 차입금 합계
c.analysis("financial", "자본배분")         # 배당 (현재 무배당)
```
