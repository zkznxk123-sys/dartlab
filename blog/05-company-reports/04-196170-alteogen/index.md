...
| 단기금융상품 | 0.36 | 0.17 | 0.06 | 0.08 | 0.19 | 0.09 | 0.06 | 0.04 | 0.03 | 0.02 |
...
| 본문 수치 | dartlab 호출 | 결과 |
|---|---|---|
| 2025 연간 매출 2,159억 | `c.select("IS", ["매출액"], freq="Y")` 분기 합산 | ✅ 실측 |
| 2025 연간 영업이익 +1,069억 | `c.select("IS", ["영업이익"], freq="Y")` 분기 합산 | ✅ 실측 |
...
| 2025 당기순이익 +1,452억 | `c.select("IS", ["당기순이익"], freq="Y")` 분기 합산 | ✅ 실측 |
...
| 현금성자산 + 단기금융상품 ≈ 4,300억 | `c.select("BS", ["현금및현금성자산","단기금융상품"], freq="Y")` Q4 | ✅ 실측 |
