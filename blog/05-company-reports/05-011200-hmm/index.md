...
| 본문 수치 | dartlab 호출 | 결과 |
|---|---|---|
| 매출 9년: 4.59→5.03→5.22→5.51→6.41→13.79→18.58→8.40→11.70→10.89조 | `c.select("IS",["매출액"])` 분기 합산 | ✅ 실측 |
| 영업이익 9년: -0.83→-0.41→-0.56→-0.30→+0.98→+7.38→+9.95→+0.59→+3.51→+1.46조 | `c.select("IS",["영업이익"])` 분기 합산 | ✅ 실측 |
| 당기순이익 2022 +10.09조 | 동일 | ✅ 실측 |
| 자본총계 0.95→27.86조 (10년 31배) | `c.select("BS",["자본총계"])` Q4 | ✅ 실측 |
| 부채총계 3.45→6.99조 (10년 2배) | `c.select("BS",["부채총계"])` Q4 | ✅ 실측 |
