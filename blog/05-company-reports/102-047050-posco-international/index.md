...
정직하게 한정한다. 이 글은 감가상각비 절대액을 dartlab 표준 연간표에서 직접 뽑아 주장하지 않는다. 2025년 표준 CF row에서 감가상각 세부 행은 비어 있어, 단일 계정으로 못 박으면 검증표가 약해진다. 대신 회사 감사보고서가 직접 제시한 큰 분류를 사용한다. 비현금흐름조정 1조1,539억, 운전자본조정 5,056억, 영업활동에서 창출된 현금흐름 2조2,963억. 이 세 줄이면 충분하다.
...
정직한 해석은 이렇게 좁힌다. 2025년 연간 영업CF 1조9,415억은 강한 실측이다. 2026Q1 -194억은 그 현금 지문이 분기 운전자본에 민감하다는 경고다. 이 둘은 모순이 아니다. 오히려 같은 사실의 양면이다. 자산과 운전자본이 큰 회사는 연간으로 보면 현금이 잘 들어오지만, 분기별로는 운전자본의 방향에 따라 갑자기 꺾여 보일 수 있다.
...
<StackBar data={[{year:"2026Q1",segments:[{label:"부채",value:120128,color:"#ef4444"},{label:"자본",value:77321,color:"#22c55e"}]},{year:"2025",segments:[{label:"부채",value:109404,color:"#ef4444"},{label:"자본",value:78127,color:"#22c55e"}]},{year:"2024",segments:[{label:"부채",value:99869,color:"#ef4444"},{label:"자본",value:73495,color:"#22c55e"}]},{year:"2023",segments:[{label:"부채",value:99930,color:"#ef4444"},{label:"자본",value:66248,color:"#22c55e"}]},{year:"2022",segments:[{label:"부채",value:81182,color:"#ef4444"},{label:"자본",value:43981,color:"#22c55e"}]}]} title="부채 vs 자본 구조" unit="억원" />
...
| 자본총계 | 77,321 | 78,127 | 73,495 | 66,248 | 43,981 |
