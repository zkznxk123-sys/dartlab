...
그런데 한 가지 더. BS를 더 뜯으면 **단기당기손익공정가치금융자산**이라는 항목이 보인다. 2021년 0원 → 2022년 **24,506억**. 현금이 "사라진" 게 아니라 **금융자산으로 옮겨간 것**이다. 2025년에도 25,839억이 여기 있다.
...
2~4막에서 현금이 인수에 쓰인 과정을 봤다. 이제 그 인수가 **비용으로 어떻게 돌아오는지** 본다.
