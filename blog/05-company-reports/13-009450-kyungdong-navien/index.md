...
국내 브랜드 인지도는 귀뚜라미 > 린나이 > 경동 순서다. 그런데 **매출은 경동이 1위**, 수익성은 압도적 차이다. 2024년 귀뚜라미 보일러 본업 매출 3,225억, 영업손실 **-45억**. 2년 연속 적자다. 같은 기간 경동나비엔 매출 1.35조, 영업이익 **+1,325억**. 같은 보일러를 파는데 하나는 적자, 하나는 OPM 10%.

왜 이렇게 갈렸는가? 귀뚜라미는 내수 보일러에 남았고, 경동은 콘덴싱 기술로 해외(북미)를 열었다. 국내 보일러 시장은 연 150~170만 대로 정체. 새 아파트가 줄면 보일러 교체 수요만 남는다. 귀뚜라미는 이 정체된 시장에서 가격 경쟁에 갇혔고, 경동은 콘덴싱 프리미엄으로 빠져나갔다. **같은 출발선에서 20년이 지나면 기술 선택이 재무제표를 결정한다.**
...
그리고 이 콘덴싱 기술은 보일러와 온수기에서 끝나지 않는다. 5막에서 보겠지만, 경동은 이 기술을 **미국 퍼네스(온풍 난방)**라는 5배 큰 시장에 결합하고 있다. 2막의 기술 투자가 3막의 미국 온수기 1위를 만들었고, 같은 기술이 5막의 퍼네스 베팅을 가능하게 한다 — 30년 전 선택의 복리 효과다.
...
그리고 하나 더. **배당 0원**. 유보율 91%. 번 돈을 전부 재투자한다. 주주에게 현금을 돌려주는 대신, 미래에 베팅하고 있다. 이건 경영자의 확신이거나 도박이다.

2024년에는 SK매직의 주방가전 사업까지 인수해 **나비엔매직**이라는 브랜드를 출범시켰다. 정수기·식기세척기·인덕션. 보일러 회사가 주방까지 들어간 것이다. 이 인수 비용도 CAPEX와 차입금 급증의 한 축이다 — "난방"에서 "가정 내 열과 물을 다루는 모든 것"으로 범위를 넓히는 데 현금을 쓰고 있다.

그러면 CAPEX 1,622억의 구체적 행선지는 어디인가? 5막에서 답이 나온다.
