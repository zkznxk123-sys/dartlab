...
![OPM 비교](./assets/14-opm-comparison.svg)

한화오션은 잠수함을 짓는다. 군함 프리미엄이 붙는다. 그래서 OPM 9%. HD한국조선해양은 LNG선, VLCC, 컨테이너선까지 전 선종을 섭렵하는 세계 1위 조선소다. OPM 10%. 삼성중공업은 드릴십과 FLNG에서 기술 독점에 가까운 포지션이다. OPM 7%.

대한조선은 방산 한 척 없이, 잠수함 한 척 없이, **OPM 24%**다.

조선업 역사를 훑어봐도 이 숫자가 나온 적이 없다. 2007~2011년 조선 슈퍼사이클 때 현대중공업이 찍은 최고 OPM이 12.1%였다. 그 광란의 시절에도 24%는 없었다. 대한조선의 이 숫자는 산업의 문법 자체를 의심하게 만든다. 어떻게 가능한가?

더 이상한 건, 3년 전 이 숫자가 **0.48%**였다는 사실이다. 영업이익 33억 원. 연매출 6,937억을 올리는 조선소가 33억을 남겼다. 직원 한 명당 500만 원도 안 되는 이익이었다. 그리고 3년 만에 89배가 됐다.

| 회사 | OPM (2025) | 방산 비중 | 비고 |
|------|:---:|:---:|------|
...
영업이익 33억이라는 숫자가 의미하는 것은 명확하다. 2022년, 이 조선소는 배를 짓긴 지었지만 **남는 게 없었다**. 철판 사고, 용접공 월급 주고, 크레인 돌리면 끝이었다. 그런데 같은 조선소가, 같은 해남 땅에서, 같은 바다를 바라보면서, 3년 뒤 OPM 24%를 찍었다. 이건 조선소가 바뀐 게 아니다. 조선소를 **운영하는 사람**이 바뀐 것이다.
...
여기서 첫 번째 반전이 나온다. 김광호는 거의 같은 시기에 **케이조선**도 2,500억에 인수했다. 두 조선소를 합쳐 4,500억. **그런데 운명이 완전히 갈렸다.** 케이조선은 중국과 직접 경쟁하는 PC탱커(범용) → 적자 → 매각 추진. 대한조선은 중국이 못 짓는 수에즈막스(특수) → OPM 24%. 같은 사람이 같은 시기에 산 두 조선소가, **선종 선택 하나로** 정반대 결과를 낳았다.

인수 직후 **왕삼동 대표**를 영입했다. 대우조선해양 출신 생산관리 베테랑. 김광호가 돈과 방향을 잡고, 왕삼동이 현장을 바꿨다. 왕삼동이 한 일은 한 문장이다: **"우리가 가장 잘 짓는 배만 짓자."** 이 한 문장이 OPM 24%의 출발점이다.
...
여기에 **셔틀탱커**가 추가된다. 셔틀탱커는 해양 유전(FPSO)에서 원유를 직접 받아서 육상 터미널로 운반하는 특수선이다. DPS(Dynamic Positioning System, 자동위치유지장치)가 장착되어 파도 속에서도 FPSO에 접안할 수 있어야 한다. 수에즈막스보다 한 단계 더 복잡하다. 전 세계에서 셔틀탱커를 건조하는 조선소는 삼성중공업과 대한조선 정도다. 이 시장에서 대한조선은 주요 플레이어다.
...
그런데 선종 집중만으로는 OPM 24%가 설명되지 않는다. 같은 수에즈막스를 짓는다 해도 다른 조선소와 10%p 이상 차이가 나는 건 **공정 혁신** 때문이다.

---

## 4막 — 1,500톤 골리앗 크레인이 바꾼 것

이 막이 대한조선 스토리의 핵심이다. "조선소인데 왜 24%인가"에 대한 진짜 답이 여기 있다. 선종 집중은 **무엇을**의 문제고, 공정 혁신은 **어떻게**의 문제다. OPM 24%는 둘 다 맞아야 나오는 숫자다.
...
매출총이익률 **26.21%**. 여기서 판관비 2.26%를 빼면 OPM 23.95%. 매총이익 자체가 높은 데다, 판관비까지 극단적으로 낮으니 **마진이 겹겹이 쌓인다**. 2막의 "가장 잘 짓는 배만 짓자"는 전략이, 4막에서 숫자로 증명된 것이다.
...
여기까지 읽으면 대한조선이 완벽한 회사처럼 보인다. OPM 24%, 판관비 2%, 턴어라운드 성공. 그러나 재무제표를 한 꺼풀 더 벗기면 **불편한 숫자들**이 나온다.

```python
c.analysis("financial", "종합평가")
```

종합평가 스코어카드를 보자. 안정성 **A**, 수익성 **D**, 성장 **D**, 현금흐름 **D**. Piotroski **1/9**.

잠깐, OPM 24%인 회사의 수익성이 D? 이건 뭔가 잘못된 게 아닌가?
...
대한조선은 이 문제를 IPO로 해결했다. 2025년 8월 코스피 상장. 공모 규모 **약 4,000억 원**. 이 돈으로 차입금 **5,727억 원**을 상환했다. 부채비율이 **28.98%**로 떨어졌다. 조선소치고 부채비율 29%는 거의 무차입에 가깝다. 2009년 워크아웃, 2014년 법정관리를 겪은 회사가 부채비율 29%. 이것만으로도 턴어라운드의 깊이를 알 수 있다.
...
5막까지의 숫자를 정리하면 이렇다. 2022년 KHI컨소시엄이 2,000억에 인수. 3년간 수에즈막스 집중 + 공정 혁신으로 OPM을 0.5%에서 24%로 끌어올렸다. 2025년 8월 코스피 상장, 공모가 5만 원, 시초가는 공모가 대비 **+78.2%**인 8만 9,100원. 2026년 기준 시가총액 **약 3.3조 원**.
...
**첫째, 이 마진은 사이클의 선물이기도 하다.** 2020년부터 시작된 조선 업황 회복은 2023~2025년에 슈퍼사이클 진입 논의가 나올 정도로 강력했다. 선가가 오르면 마진이 올라가고, 대한조선처럼 고정비가 낮은 조선소일수록 레버리지 효과가 극대화된다. 역으로, 선가가 하락하면 이 레버리지가 반대로 작용한다. 수에즈막스 선가가 1억 달러에서 8,000만 달러로 20% 떨어지면, OPM은 24%에서 10% 아래로 급락할 수 있다.

2007~2011년 조선 슈퍼사이클의 평균 OPM이 12.1%였다. 그 시절에도 24%는 없었지만, 그 시절이 끝나자 OPM이 마이너스로 떨어졌다는 사실을 기억해야 한다.
...
**셋째, 선종 확장의 양날의 검.** 8,800TEU 컨테이너선 수주는 "성장"으로 읽힐 수 있지만, 반대로 읽으면 **수에즈막스만으로는 성장에 한계가 있다**는 뜻이기도 하다. 컨테이너선 시장에서는 HD현대, 한화오션, 삼성중공업, 그리고 중국 조선소와 정면으로 경쟁해야 한다. 수에즈막스에서의 독점적 지위가 컨테이너선에서도 유지될 리 없다. 선종 확장이 마진 희석으로 이어질 가능성은 열려 있다.

**넷째, 648명의 구조.** 직원 648명으로 매출 1.2조를 만드는 건 인상적이지만, 뒤집으면 **핵심 인력에 대한 의존도가 극단적**이라는 뜻이다. 조선소 용접공은 10년 이상 숙련이 필요한 기술직이다. 한 명이 빠지면 대체하는 데 오래 걸린다. 648명이라는 숫자는 효율의 증거인 동시에 취약점이기도 하다.
...
OPM 24%의 절반은 사이클의 선물이고, 절반은 공정 혁신의 구조다. 조선 업황이 꺾이면 24%는 당연히 유지되지 않는다. 그러나 수에즈막스 집중 전략과 판관비 2.26%라는 비용 구조가 사라지지 않는 한, **OPM 12~15%는 사이클 저점에서도 방어 가능**하다고 본다. 조선업 역사에서 저점에도 12%를 유지한 조선소는 없었다. 만약 대한조선이 이걸 해낸다면, 그것 자체가 업종의 새로운 기준이 된다.
...
|------|-----:|-----:|-----:|-----:|
| 매출 | 12,281 | 10,746 | 8,140 | 6,937 |
| 매출총이익 | 3,219 | 1,918 | — | — |
| 영업이익 | 2,941 | 1,582 | — | 33 |
| 당기순이익 | 2,082 | 1,142 | — | — |
| 매총이익률 | 26.21% | 17.85% | — | — |
| OPM | 23.95% | 14.72% | ~8% | 0.48% |
...
| 지표 | 값 | 비고 |
|------|------|------|
| 판관비율 | 2.26% | 업종 평균의 1/3 |
| Piotroski F-Score | 1/9 | 진행기준 회계 특성 |
| 수출 비중 | 99.3% | 사실상 수출 전량 |
| 직원 수 | 648명 | 1인당 매출 약 19억 |
| 고객 집중도 | 85.8% | 구조적 리스크 |
...
| 본문 수치 | 출처 |
|---|---|
| 매출 12,281억, OPM 23.95% | dartlab 실측 |
| 매총이익률 26.21% | dartlab 실측 |
| 판관비율 2.26% | dartlab 실측 |
| 영업이익 33→2,941억 (89배) | dartlab 실측 |
| 부채비율 28.98% | dartlab 실측 |
| Piotroski 1/9 | dartlab 실측 |
| 수출 99.3% | dartlab 실측 |
| 계약부채 2,154억 | dartlab 실측 |
| 직원 648명 | dartlab 실측 |
| 고객 집중도 85.8% | dartlab 실측 |
| 1987 신영조선공업 설립 | [위키백과 — 대한조선](https://ko.wikipedia.org/wiki/대한조선) |
| 2022 KHI 2,000억 인수 | [C저널 — KHI 김광호](https://www.c-journal.co.kr/articleView?num=1247) |
| 수에즈막스 5척 중 4척 | [인사이트코리아](https://www.insightkorea.co.kr/news/articleView.html?idxno=239394) |
| 공모가 5만원, 시초가 +78.2% | [한국경제](https://www.hankyung.com/article/2025071747286) |
| 시총 3.3조 | [38커뮤니케이션](https://www.38.co.kr/html/fund/?o=v&no=2210) |
| 골리앗 크레인 1,500톤, 텐덤 공법 | [더퍼블릭](https://www.thepublic.kr/news/articleView.html?idxno=296119) |
| 블록 내재화 27.6만톤 | [파이낸셜투데이](https://www.ftoday.co.kr/news/articleView.html?idxno=344830) |

---

*이 글의 모든 재무 수치는 dartlab으로 재현할 수 있다. `pip install dartlab` → 위 코드 블록을 실행하면 동일한 숫자를 확인할 수 있다.*
