...
### OPM 4.5% → 7.0% — 물류업 마진 2.5%p는 구조 변화 없이 불가능
...
### 해운 OPM 13.8% — 매출 18%인데 이익의 36%를 만든다
...
### 연간 잉여 OCF 1.4조 — 9조 중 7조는 자체 현금으로 커버

**9조가 무모한 도박인가?** 결론부터 — 아니다. 연간 OCF 2조에서 유지보수와 배당을 빼면 잉여 현금이 연 1.4조. 5년이면 7조. 9조 중 7조는 자체 현금으로 커버되고, 2조만 차입이 필요하다. 숫자로 따져보자:
