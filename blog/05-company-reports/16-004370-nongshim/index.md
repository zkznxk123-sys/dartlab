...
**만약 농심이 삼양처럼 신라면 하나에 올인하면?** 단순 시뮬을 해보자. 1,200억 마케팅 예산을 신라면 하나에 집중하고, 100개 SKU 중 마진이 낮은 하위 50개를 정리하면? 원가 집중으로 매총이익률 3~5%p 개선, 마케팅 효율 3배 → 해외 신라면 매출 30%+ 성장 시나리오가 나온다. **OPM 8~10%가 가능한 구조다.** 그런데 농심은 이걸 못 한다 — 신라면 이외의 100개 제품이 국내 유통 채널을 점유하고 있고, 유통사(편의점·마트)와의 관계가 다품종에 기반하기 때문이다. SKU를 줄이면 매대가 줄고, 매대가 줄면 경쟁사에 빼앗긴다. **다품종이 해자이자 감옥이다.**
...
**그런데 이 모든 문화 자본에도 불구하고, 농심의 OPM은 5.2%다.** 삼양식품의 22.3%의 1/4이다. 브랜드 인지도 1위가 이익률 1위로 이어지지 않는다. 왜?
...
농심의 재무 건강도는 아이러니하게도 탄탄하다. 부채비율 45%, 현금 4,891억, 영업CF 연 2,900억. 부도 위험 0. 삼양식품이 밀양 2공장 투자로 FCF 마이너스(-1,397억)인 것과 대비된다. **농심은 "돈을 못 버는 회사"가 아니라 "많이 못 버는 회사"다.** 안전하지만 짜릿하지 않다. 그래서 시총이 역전된 것이다 — 시장은 안전보다 성장에 값을 매긴다.

### 두 갈래 시나리오

여기서 농심의 미래가 두 갈래로 갈린다. 숫자로 그려보자.

| 시나리오 | 해외 프리미엄 비중 | 매총이익률 | OPM | 결과 |
|---------|:---:|:---:|:---:|------|
| **A. 툼바 성공** | 30%+ | **28%+** | **8~10%** | 구조적 천장 돌파. 삼양과의 격차 4배→2배 |
| **B. 현상 유지** | 10% 미만 | 24% | **5%** | 영원한 1위의 저주. 시총 역전 고착 |
...
숫자로 기준선을 그어두자. **매총이익률 28%를 넘으면 구조가 바뀌고 있다는 신호다.** 현재 24%. 툼바(마진 +30%)와 해외 프리미엄(판가 2배)이 전체 매출의 20%를 넘기면 매총이익률이 28%에 도달한다. 그 시점에서 OPM은 7%를 넘기고, 농심 역사상 처음으로 구조적 천장을 뚫는다.
...
농심의 주가는 OPM과 동행한다. OPM이 6%를 넘긴 2023년에 주가는 신고가를 찍었고, OPM이 4.7%로 내려간 2024년에 다시 빠졌다. 시장은 "매출 성장"이 아니라 "마진 변화"에 반응한다.
...
### 왜 PBR이 3배 차이인가 — ROE가 답한다

PBR = ROE × PER. 삼양의 ROE는 약 23%, 농심의 ROE는 약 6%. **자본수익률이 4배 차이**니까 PBR도 3배 차이 나는 것이다. ROE 6%는 한국 10년 국채 수익률(3.5%)의 2배도 안 된다. 투자자 입장에서 농심에 투자하는 것이 국채 대비 큰 메리트가 없다는 뜻이다.

농심의 ROE가 낮은 이유는 분자(순이익)가 작기 때문이고, 순이익이 작은 이유는 OPM이 5%이기 때문이고, OPM이 5%인 이유는 1~4막에서 추적한 구조적 천장 때문이다. **밸류에이션 할인은 구조적 마진 천장의 결과**다.

### 적정 시총 시뮬레이션

| 시나리오 | OPM | 영업이익 | 순이익 추정 | PER 15x 적용 시총 |
|---------|:---:|---:|---:|---:|
...
현재 시총 3.5조는 "가격 인상 반영 + 약간의 툼바 기대" 구간이다. **OPM 9%가 나오면 시총 4조.** 그때서야 삼양 시총의 80% 수준이 된다. 삼양을 따라잡는 건 불가능에 가깝다 — 구조가 다르기 때문이다. 하지만 **자기 역사적 PBR 밴드(0.9~1.8x)에서 상단으로 가는 것**은 툼바 성공 시 가능하다.
...
매출 기준으로 농심은 CJ제일제당 다음인 2위다. 그런데 OPM 기준으로는 삼양·오뚜기·CJ 뒤인 4위다. 풀무원만 겨우 앞선다. **규모는 크지만 수익은 적은, 어색한 위치**다.

이 비교에서 가장 흥미로운 대비는 **오뚜기 vs 농심**이다. 오뚜기도 라면(진라면, 참깨라면)을 만든다. 오뚜기도 다품종(라면+카레+소스+참치)이다. 그런데 오뚜기 OPM이 6.2%로 농심(5.2%)보다 1%p 높다. 이유는 간단하다 — **해외 비중**이다. 오뚜기의 해외 비중은 15%에 불과하다. 국내에서 프리미엄 가격을 잘 받고 있고, 중국처럼 마진을 깎는 해외 시장이 없다. 농심은 해외 비중 66%인데 그 해외의 질이 문제다(2막 참조).
...
삼양식품의 매출 CAGR 32%는 식품 업종에서 이례적이다. 식품은 원래 한 자릿수 성장 업종이다. 삼양이 예외인 것이다. 농심의 8% CAGR은 식품 업종 내에서는 양호한 편이다 — 하지만 시장은 8%짜리 성장에 프리미엄을 주지 않는다.
...
**매총이익률 28%. OPM 9%. PBR 1.5x.** 이 세 숫자가 동시에 찍히면 농심의 구조가 바뀌고 있다는 신호다.
...
| 기간 | 보고서 | 링크 |
|------|--------|------|
| 2025 | 사업보고서 (2025.12) | [DART에서 보기](https://dart.fss.or.kr/dsaf001/main.do?rcpNo=20260311003892) |
| 2025 | 분기보고서 (2025.09) | [DART에서 보기](https://dart.fss.or.kr/dsaf001/main.do?rcpNo=20251114001491) |
| 2025 | 반기보고서 (2025.06) | [DART에서 보기](https://dart.fss.or.kr/dsaf001/main.do?rcpNo=20250814002291) |
| 2025 | 분기보고서 (2025.03) | [DART에서 보기](https://dart.fss.or.kr/dsaf001/main.do?rcpNo=20250515001740) |
| 2024 | 사업보고서 (2024.12) | [DART에서 보기](https://dart.fss.or.kr/dsaf001/main.do?rcpNo=20250312000711) |
| 2024 | 분기보고서 (2024.09) | [DART에서 보기](https://dart.fss.or.kr/dsaf001/main.do?rcpNo=20241114001249) |
| 2024 | 반기보고서 (2024.06) | [DART에서 보기](https://dart.fss.or.kr/dsaf001/main.do?rcpNo=20240814002569) |
| 2024 | 분기보고서 (2024.03) | [DART에서 보기](https://dart.fss.or.kr/dsaf001/main.do?rcpNo=20240516000843) |
| 2023 | 사업보고서 (2023.12) | [DART에서 보기](https://dart.fss.or.kr/dsaf001/main.do?rcpNo=20240314000698) |
| 2023 | 분기보고서 (2023.09) | [DART에서 보기](https://dart.fss.or.kr/dsaf001/main.do?rcpNo=20231114001126) |
...
<ComboChart data={[{year:"2025",매출액:65562,영업이익:1839,당기순이익:1701},{year:"2024",매출액:39379,영업이익:1631,당기순이익:1576},{year:"2023",매출액:63406,영업이익:2121,당기순이익:1715},{year:"2022",매출액:64100,영업이익:1122,당기순이익:1160},{year:"2021",매출액:51608,영업이익:1061,당기순이익:996}]} lineKeys={["매출액"]} barKeys={["영업이익","당기순이익"]} lineColors={["#22c55e"]} barColors={["#3b82f6","#f59e0b"]} title="매출(라인) vs 영업이익·당기순이익(막대)" unit="억원" />

| 항목 | 2025 | 2024 | 2023 | 2022 | 2021 |
|---|---:|---:|---:|---:|---:|
| 매출액 | 65,562 | 39,379 | 63,406 | 64,100 | 51,608 |
| 매출원가 | 24,954 | 24,732 | 23,753 | 22,295 | 18,449 |
| 매출총이익 | 10,189 | 9,655 | 10,352 | 8,996 | 8,181 |
| 판매비와관리비 | 8,350 | 8,025 | 8,232 | 7,874 | 7,120 |
| 영업이익 | 1,839 | 1,631 | 2,121 | 1,122 | 1,061 |
| 금융수익 | — | — | — | — | — |
| 금융비용 | — | — | — | — | — |
...
| 항목 | 2025 | 2024 | 2023 | 2022 | 2021 |
|---|---:|---:|---:|---:|---:|
| 자산총계 | 38,221 | 35,975 | 32,348 | 30,347 | 28,999 |
| 유동자산 | 19,602 | 17,437 | 14,198 | 12,085 | 10,887 |
| 비유동자산 | 18,619 | 18,537 | 18,149 | 18,262 | 18,112 |
| 부채총계 | 9,909 | 9,249 | 7,939 | 7,194 | 6,991 |
...
<ComboChart data={[{year:"2025",영업CF:2687,투자CF:-1168,재무CF:0},{year:"2024",영업CF:2725,투자CF:-3819,재무CF:0},{year:"2023",영업CF:3272,투자CF:-2674,재무CF:0},{year:"2022",영업CF:1597,투자CF:-1069,재무CF:0},{year:"2021",영업CF:1627,투자CF:-3189,재무CF:0}]} barKeys={["영업CF","투자CF","재무CF"]} barColors={["#22c55e","#ef4444","#3b82f6"]} title="영업·투자·재무 현금흐름" unit="억원" />

| 항목 | 2025 | 2024 | 2023 | 2022 | 2021 |
|---|---:|---:|---:|---:|---:|
| 영업활동현금흐름 | 2,687 | 2,725 | 3,272 | 1,597 | 1,627 |
| 투자활동현금흐름 | -1,168 | -3,819 | -2,674 | -1,069 | -3,189 |
| 재무활동현금흐름 | — | — | — | — | — |
...
|---|---:|---:|---:|---:|---:|
| 회계정책변경 | — | — | — | — | — |
| 기초자본 | 26,720 | 24,302 | 1,237 | 162 | -1,209 |
| 유상증자 | — | — | — | — | — |
| 연결범위변동 | 0.0 | 0.0 | 0.0 | — | — |
| 전환사채 | 0.0 | 0.0 | — | — | — |
| 배당 | 0.0 | 0.0 | -289 | 231 | 231 |
| 기말자본 | 25,782 | 26,726 | 24,408 | 23,042 | 22,008 |
| FVOCI평가 | 0.0 | 0.9 | 36 | -21 | -12 |
| 해외사업환산 | 0.0 | 10 | 35 | 64 | 694 |
| 연결범위내거래 | — | — | — | — | — |
| 비지배지분변동 | 0.0 | 0.0 | 0.0 | -49 | 0.3 |
| 당기순이익 | 0.0 | 0.0 | 0.0 | 1,160 | 998 |
| 확정급여재측정 | 0.0 | -71 | -241 | 214 | 57 |
