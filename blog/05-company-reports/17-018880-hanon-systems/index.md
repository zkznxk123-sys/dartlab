...
| 연도 | 영업CF | CAPEX | 이자비용 | FCF (영업CF-CAPEX) | FCF-이자 |
|------|---:|---:|---:|---:|---:|
...
2024년이 참혹하다. 영업CF 4,450억에서 CAPEX 4,300억을 빼면 FCF가 150억밖에 남지 않는다. 여기서 이자 2,646억을 내야 한다. **이자를 내려면 추가 차입이 필요한 구조**다. "빚을 내서 이자를 내는" 단계에 도달한 것이다.
