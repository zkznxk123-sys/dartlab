...
금호석유화학의 5년 손익계산서를 보면 이 구조가 더 명확해진다.

```
dartlab
c = dartlab.Company("011780")
c.show("IS", period=["2020","2021","2022","2023","2024"])
```

매출은 2021년 8.47조(코로나 NB라텍스 특수) → 2022년 7.98조 → 2023년 6.33조 → 2024년 6.92조로 사이클을 탔다. 영업이익은 2021년 2.4조(사상 최대) → 2022년 1.1조 → 2023년 3,590억 → 2024년 2,717억으로 급감했지만, **적자로 떨어지지 않았다**. 사이클의 바닥에서도 8%대 영업이익률(2021년은 28%)을 유지했다. 이것이 NCC가 없는 구조의 실체다.
...
# 재무상태표
c.show("BS", period=["2020","2021","2022","2023","2024"])
