...
PBR 0.7x가 나왔던 2024년 6월이 매수 적기였을까? 사후적으로는 그렇다. 하지만 그때 시장은 "중국 346만 톤 증설"과 "OPM 3.8% 바닥"을 보고 있었다. 바닥에서 사려면 **"이보다 더 나빠질 수 없다"**는 확신이 필요하고, 그 확신을 주는 것이 **재무 안전성**이다.

### 사이클 바닥에서 안전한가 — 부채비율 36%의 의미

부채비율 36%. 현금 6,504억. 이자보상배율 약 8배(바닥에서도). **사이클 바닥에서 부도 가능성은 0**이다. 롯데케미칼(부채비율 120%, ICR 1배 미만)이나 한화솔루션(부채비율 150%)과 근본적으로 다르다. 이 안전성이 "바닥에서 매수해도 괜찮은" 근거다.

적정가 시뮬레이션:

| 시나리오 | OPM | 영업이익 | PER 8x 적용 시총 | 현재 대비 |
|---------|:---:|---:|---:|---:|
| 사이클 바닥 (현재) | 3.9% | 2,718억 | 2.2조 | — |
| 정상화 (OPM 8%) | 8.3% | 5,750억 | **4.6조** | +109% |
| 미니 호황 (OPM 15%) | 15% | 10,400억 | 8.3조 | +277% |
...
| 기업 | 매출 | OPM | 부채비율 | ICR | NCC 보유 | 핵심 방패 |
|------|---:|---:|---:|---:|:---:|---|
...
**3. 부채가 감당 가능한가?** 금호석화 부채비율 36%, ICR 8배. 나머지는 100% 이상에 ICR 적자. 불황이 2년 더 가면 롯데케미칼과 한화솔루션은 재무 압박이 심각해진다.
...
- **사이클 바닥 확인** → OPM 8%+ 회복이 트리거 (5막)
- **PBR 0.9x** → 비대칭 베팅 구간 (6막)
- **업종 내 유일한 안전 + 환원** → 기다릴 수 있는 사이클 주 (7막)

**OPM 8%. PBR 1.5x. 배당수익률 3% 이상 유지.** 이 세 조건이 동시에 충족되면 사이클이 중간을 넘겼고, 금호석화의 "지킨 것이 이긴 것"이 다시 한 번 증명되는 순간이다.
...
|---|---:|---:|---:|---:|---:|
| 회계정책변경 | — | — | — | — | — |
| 지분법자본변동 | 0.0 | 336 | 0.0 | 3 | 8 |
| 기초자본 | -319 | -382 | -902 | 90 | 31,482 |
| 유상증자 | 0.0 | 1 | 0.0 | -1 | — |
| 현금흐름위험회피 | 0.0 | 0.0 | -18 | — | — |
| 배당 | 0.0 | 767 | 0.0 | 2,809 | 0.0 |
| 기말자본 | 62,453 | -319 | 45 | 1,675 | 90 |
| 전기오류수정 | — | — | 0.0 | — | — |
| FVOCI평가 | 0.0 | 0.0 | 0.0 | -422 | -21 |
| 해외사업환산 | 3 | 0.0 | 0.0 | -38 | 50 |
| 연결범위내거래 | 0.0 | 0.0 | 0.0 | — | -0.6 |
| 당기순이익 | 0.0 | 3,486 | 0.0 | 3 | 19,655 |
| 기타 | — | 0.0 | 0.0 | — | — |
| 기타(기타 조정) | — | — | — | -3 | — |
| 기타(종속회사 매각) | — | — | — | — | — |
