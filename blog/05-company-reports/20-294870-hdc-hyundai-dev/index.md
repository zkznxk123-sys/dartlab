...
센테니얼 아이파크 준공(2026.2)이 끝나면 사고 관련 추가 비용은 소멸한다. 판관비율이 11%대로 내려가면 OPM은 7~8%대에 진입한다.
...
2025년 OCF가 양호한 이유는 수도권 3개 단지의 **분양 계약금이 일시에 유입**됐기 때문이다. 2026~2027년에 이 단지들이 준공되면서 잔금이 들어오면 OCF는 더 개선된다. 반면 2028년 이후에는 신규 분양 파이프라인이 메워져야 현금흐름이 유지된다.

**한 문장: HDC현산의 원가 우위는 "도급이 아니라 자체개발을 하는 회사"라는 구조적 선택에서 나온다. 이 구조가 빅4 중 유일한 6%+ OPM을 만든다.**
...
OPM 대비 PER이 가장 낮은 회사가 HDC현산이다. 수익성은 1위인데 밸류에이션은 최하위급. 시장이 "이 회사의 이익은 지속 가능한가?"에 의문을 갖고 있다는 뜻이다.
