...
|---|---:|---:|---:|---:|
| 2021 | 4,000 | 32% | 1.8% | ~1.2 |
| 2022 | 4,000 | 25% | 2.0% | ~1.6 |
| 2023 | 5,000 | 30% | 2.4% | ~1.7 |
| 2024 | 6,000 | 35% | 2.8% | ~1.7 |
| 2025 | 7,000 | 35% | 3.1% | ~2.0 |
...
### FCF 커버리지 — 배당은 충분히 감당 가능한가

모비스의 FCF(잉여현금흐름) 대비 배당 지급률을 보면:

| 연도 | OCF(조) | CAPEX(조) | FCF(조) | 배당 총액(조) | FCF/배당 |
|---|---:|---:|---:|---:|---:|
| 2022 | 3.2 | 0.7 | 2.5 | 0.4 | 6.3x |
| 2023 | 3.5 | 0.8 | 2.7 | 0.5 | 5.4x |
| 2024 | 3.8 | 0.9 | 2.9 | 0.6 | 4.8x |
| 2025 | 4.0 | 1.0 | 3.0 | 0.7 | 4.3x |

FCF가 배당의 4~6배. **배당을 2배로 올려도 FCF가 감당한다.** 문제는 "할 수 있는가"가 아니라 "할 의향이 있는가"다. 순환출자 구조에서 모비스의 현금이 주주에게 과도하게 돌아가면, 그룹 전체의 재원이 줄어든다. 현대차와 기아가 모비스 현금에 의존하는 부분이 있다.
...
| 연결 OPM 희석(해외 저마진) | -0.08 | 0.75 → 0.67 |
| **합계** | **-0.33** | **1.0 → 0.67** |

세 요인이 동시에 작용한다. Korea Discount는 모든 한국 대형주에 적용되는 구조적 할인이다. 순환출자·승계 불확실성은 모비스 특유의 할인이다. 연결 OPM 희석은 해외 법인의 구조적 저마진이다.
...
모비스는 **"별도 OPM 21%의 현금기계 + 배당 3% + 자사주 소각"이 PBR 0.67배에 살 수 있는 회사**다. 싸게 살 수 있는 이유는 하나: 정의선 승계가 언제 어떻게 풀릴지 아무도 모른다. 이 불확실성을 감내할 수 있으면 사고, 없으면 말라. 재무적으로는 답이 나와 있지만, 지배구조가 숫자를 덮고 있다.
