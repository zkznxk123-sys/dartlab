...
-946%는 이익 대비 현금흐름이 극도로 악화됐다는 뜻이다. 이유는 **일회성 충당금**. 소송 충당금, 보안 투자 충당금, 유심 교체 충당금 — 이들은 손익계산서에는 비용으로 찍히지만, 현금은 아직 나가지 않았다. 반대로, 일부는 현금이 먼저 나가고 회계상 자산화되기도 한다.
...
SKT는 이 인프라를 활용하려 한다. 데이터센터 구축 → HBM 기반 AI 서버 운영 → 에이닷·B2B 솔루션 서비스 → 다시 HBM 수요 창출. **그룹 내 수직 통합** 구도다.
