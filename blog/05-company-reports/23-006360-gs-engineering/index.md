...
이 와중에 GS건설은 "이미 털 건 다 털었다"는 포지션을 선점했다. 시공능력평가 순위가 2023년 6위에서 2024~2025년 5위로 회복된 배경에는, GS의 회복 속도뿐 아니라 경쟁사들의 동반 부진도 있다.
...
이 네 가지 중 어느 하나가 현실화되면, GS건설은 다시 한 번 선택의 기로에 설 것이다. 그리고 그때는 "빅배스 카드"를 다시 쓰기 어렵다. 이미 2023년에 한 번 썼다. 두 번째 빅배스는 시장에서 "상습 이익 관리"로 해석될 수 있다.
