...
공시에서 확인되는 단서는 하나다. 2023년 매출원가율 97%, 2025년 매출원가율 96% — 비율 차이는 1%p 미만이다. 그런데 OPM은 0.9%→7.3%로 6.4%p 올랐다. 이게 가능한 건 **매출 구성이 바뀌었기 때문**이다. 무역 매출이 6.3조→1.9조로 줄었는데 OI는 늘었다. 떨어진 1조짜리 매출들은 원가율 98~99%짜리 수수료 트레이딩이었을 것이다. 남은 1.9조 안에 자원 자회사 생산매출이 섞이면서 판관비 커버율이 급격히 개선됐다. **추정이 아니라 매출원가 구조가 말해주는 것**이다. 이익의 절대다수가 비(非)무역 부문에서 온다는 결론은 바뀌지 않는다.
