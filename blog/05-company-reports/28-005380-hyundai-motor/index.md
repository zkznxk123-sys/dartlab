...
문제는 이 구조가 **자본을 많이 먹는다는** 점이다. 금융업은 레버리지 사업이다. 빌려서 더 많이 빌려주는 구조. 자동차를 팔수록 금융 자산이 쌓이고, 이를 뒷받침하는 차입도 늘어난다. 연결 부채 241.2조원 중 상당 부분이 현대캐피탈의 차입이다.

| 항목 (조원) | 2025 | 2024 | 증감 |
|------------|-----:|-----:|-----:|
| 연결 자산 | 368.8 | 339.8 | +29.0 |
| 연결 부채 | 241.2 | 219.5 | +21.7 |
| 연결 자본 | 127.6 | 120.3 | +7.3 |
