...
# 제8막: "원자력 유니콘의 운명" — Oklo는 회사인가, 가설인가
...
이 회사의 시총은 재무제표가 만든 것이 아니다. **가설**이 만든 것이다. 그 가설은 이것이다:

**"AI가 전력을 먹는다. 그 전력의 끝에 원자력이 있다. Oklo가 그 원자력을 만든다."**

가설이 맞으면 시총 $13B는 시작일 수 있다. 14GW가 실제로 건설되면 수십조 규모의 매출이 만들어진다. 가설이 틀리면 — NRC가 또 거절하거나, HALEU가 준비되지 않거나, 고객이 떠나거나, 현금이 먼저 바닥나면 — 이 회사의 가치는 잔여 현금에 수렴한다.

Oklo는 회사가 아니라 질문이다. AI 시대에 원자력은 필수인가? 소형 원자로는 대형 원전을 대체할 수 있는가? 120명의 스타트업이 NRC를 통과할 수 있는가? 매출 $0인 회사에 18조원을 걸 수 있는가?

2027년, INL에서 Aurora 1호기가 임계에 도달하는 순간. 그때 이 질문들에 대한 첫 번째 답이 나온다. 재무제표의 매출 행에 0이 아닌 숫자가 적히는 날. 그날이 Oklo가 가설에서 회사로 전환하는 날이다.
...
<ComboChart data={[{year:"2025",매출액:null,영업이익:null,당기순이익:null},{year:"2024",매출액:null,영업이익:null,당기순이익:null},{year:"2023",매출액:null,영업이익:-4,당기순이익:12},{year:"2022",매출액:null,영업이익:-2,당기순이익:4},{year:"2021",매출액:null,영업이익:-1,당기순이익:-1}]} lineKeys={["매출액"]} barKeys={["영업이익","당기순이익"]} lineColors={["#22c55e"]} barColors={["#3b82f6","#f59e0b"]} title="매출(라인) vs 영업이익·당기순이익(막대)" unit="$M" />
...
<StackBar data={[{year:"2025",segments:[{label:"부채",value:41,color:"#ef4444"},{label:"자본",value:1206,color:"#22c55e"}]},{year:"2024",segments:[{label:"부채",value:49,color:"#ef4444"},{label:"자본",value:-3,color:"#22c55e"}]},{year:"2023",segments:[{label:"부채",value:19,color:"#ef4444"},{label:"자본",value:-13,color:"#22c55e"}]},{year:"2022",segments:[{label:"부채",value:18,color:"#ef4444"},{label:"자본",value:0.0,color:"#22c55e"}]},{year:"2021",segments:[{label:"부채",value:18,color:"#ef4444"},{label:"자본",value:0,color:"#22c55e"}]}]} title="부채 vs 자본 구조" unit="$M" />

| 항목 | 2025 | 2024 | 2023 | 2022 | 2021 |
|---|---:|---:|---:|---:|---:|
| 자산총계 | 1,246 | 15 | 510 | 505 | 505 |
| 유동자산 | 932 | 14 | 4 | 4 | 4 |
| 비유동자산 | — | — | — | — | — |
| 부채총계 | 41 | 49 | 19 | 18 | 18 |
| 유동부채 | 14 | 3 | 1 | 0.3 | 0.4 |
...
<ComboChart data={[{year:"2025",영업CF:0,투자CF:0,재무CF:0},{year:"2024",영업CF:0,투자CF:0,재무CF:0},{year:"2023",영업CF:-11,투자CF:225,재무CF:0},{year:"2022",영업CF:-1.0,투자CF:1,재무CF:0},{year:"2021",영업CF:-2,투자CF:-500,재무CF:0}]} barKeys={["영업CF","투자CF","재무CF"]} barColors={["#22c55e","#ef4444","#3b82f6"]} title="영업·투자·재무 현금흐름" unit="$M" />
