...
### FCF(잉여현금흐름) — 3년 연속 마이너스

잉여현금흐름(FCF, 영업활동으로 번 현금에서 설비투자를 뺀 금액)은 기업이 자유롭게 쓸 수 있는 현금이다. 배당도, 자사주 매입도, 차입금 상환도 FCF에서 나온다.
...
| CAPEX(설비투자) | 23,944 | 25,750 | 24,844 | 18,733 | 14,259 |
| **FCF** | **-15,656** | **-14,279** | **-9,411** | **11,258** | **21,125** |

2020년 FCF $21.1B. 2024년 FCF -$15.7B. **5년 만에 $37B(약 49조원)의 현금 흐름이 뒤집혔다.** 영업CF가 $35B에서 $8B로 줄었는데, CAPEX(설비투자, 새 공장이나 장비에 쓰는 돈)는 $14B에서 $24B로 늘었다. 들어오는 돈은 줄고, 나가는 돈은 늘었다. 그래서 FCF가 3년 연속 마이너스다.

### CAPEX $24B — 왜 적자인데 투자를 늘리는가

CAPEX $24B은 Intel 역사상 최대다. 적자인데 왜? 파운드리 때문이다. 반도체 공장은 착공에서 양산까지 3~4년이 걸린다. 지금 짓고 있는 공장(오하이오, 아리조나, 독일, 아일랜드)은 2021~2022년에 시작한 프로젝트다. 중간에 멈출 수 없다. 파운드리를 포기하지 않는 한 CAPEX를 줄일 수 없다.

| CAPEX 추이 ($B) | 2020 | 2021 | 2022 | 2023 | 2024 | 5년 합계 |
|----------------|-----:|-----:|-----:|-----:|-----:|---------:|
| 설비투자 | 14.3 | 18.7 | 24.8 | 25.8 | 23.9 | **107.5** |

5년간 CAPEX 합계 $107.5B(약 144조원). 이 기간 영업CF 합계는 $100.6B. **번 돈보다 투자한 돈이 더 많다.** 차액 $6.9B + 배당 $16.3B + 기타 지출은 전부 차입금으로 메웠다.
...
차입금이 $35B(2021) → $50B(2024)로 늘었다. $15B을 더 빌렸다. 부채비율(차입금/자본)은 45%(2021) → 53%(2024). 아직 위험 수준은 아니지만, 매년 $14~16B의 FCF 적자가 계속되면 2~3년 안에 부채비율이 급등한다.
...
매출 $79B에서 $53B로 33% 급락. PC 시장 축소 + 데이터센터 GPU 전환 + AMD 잠식이 동시에 왔다. 순손실 $18.8B — 빅배스로 과거를 정리했다. R&D $16.5B — 매출총이익의 95%를 연구에 쓴다. 줄일 수 없다. 줄이면 파운드리가 끝난다. 파운드리 적자 $10B — TSMC와의 격차는 5배. 그런데 포기하면 TSMC에 영원히 종속된다. 배당 중단 — 36년 기록이 끊겼다. FCF -$16B인데 CAPEX $24B을 멈출 수 없다.
...
| CAPEX $23.9B (2024) | dartlab EDGAR 실측 | ✅ |
| FCF -$15.7B (2024) | dartlab EDGAR 실측 | ✅ |
...
<ComboChart data={[{year:"2025",매출액:null,영업이익:null,당기순이익:null},{year:"2024",매출액:53101,영업이익:-11678,당기순이익:-18756},{year:"2023",매출액:54228,영업이익:93,당기순이익:1689},{year:"2022",매출액:63054,영업이익:2334,당기순이익:8014},{year:"2021",매출액:79024,영업이익:19456,당기순이익:19868}]} lineKeys={["매출액"]} barKeys={["영업이익","당기순이익"]} lineColors={["#22c55e"]} barColors={["#3b82f6","#f59e0b"]} title="매출(라인) vs 영업이익·당기순이익(막대)" unit="$M" />

| 항목 | 2025 | 2024 | 2023 | 2022 | 2021 |
|---|---:|---:|---:|---:|---:|
| 매출액 | — | 53,101 | 54,228 | 63,054 | 79,024 |
| 매출원가 | — | 35,756 | 32,517 | 36,188 | 35,209 |
| 매출총이익 | — | 17,345 | 21,711 | 26,866 | 43,815 |
| 판매비와관리비 | — | 5,507 | 5,634 | 7,002 | 6,543 |
| 영업이익 | — | -11,678 | 93 | 2,334 | 19,456 |
| 금융수익 | — | — | — | — | — |
| 금융비용 | — | — | — | — | — |
| 당기순이익 | — | -18,756 | 1,689 | 8,014 | 19,868 |

### 재무상태표 (BS) — 단위 $M

<StackBar data={[{year:"2025",segments:[{label:"부채",value:0,color:"#ef4444"},{label:"자본",value:126360,color:"#22c55e"}]},{year:"2024",segments:[{label:"부채",value:0,color:"#ef4444"},{label:"자본",value:95391,color:"#22c55e"}]},{year:"2023",segments:[{label:"부채",value:0,color:"#ef4444"},{label:"자본",value:81038,color:"#22c55e"}]},{year:"2022",segments:[{label:"부채",value:0,color:"#ef4444"},{label:"자본",value:77504,color:"#22c55e"}]},{year:"2021",segments:[{label:"부채",value:0,color:"#ef4444"},{label:"자본",value:77504,color:"#22c55e"}]}]} title="부채 vs 자본 구조" unit="$M" />

| 항목 | 2025 | 2024 | 2023 | 2022 | 2021 |
|---|---:|---:|---:|---:|---:|
| 자산총계 | 211,429 | 191,572 | 182,103 | 168,406 | 153,091 |
| 유동자산 | 63,688 | 43,269 | 50,407 | 58,558 | 47,249 |
| 비유동자산 | — | — | — | — | — |
| 부채총계 | — | — | — | — | — |
| 유동부채 | 31,575 | 28,053 | 32,155 | 27,462 | 24,754 |
| 비유동부채 | — | — | — | — | — |
| 자본총계 | 126,360 | 95,391 | 81,038 | 77,504 | 77,504 |

### 현금흐름표 (CF) — 단위 $M

<ComboChart data={[{year:"2025",영업CF:0,투자CF:0,재무CF:0},{year:"2024",영업CF:8288,투자CF:-18256,재무CF:11138},{year:"2023",영업CF:11471,투자CF:-24041,재무CF:8505},{year:"2022",영업CF:15433,투자CF:-10477,재무CF:1361},{year:"2021",영업CF:29991,투자CF:-25167,재무CF:-5862}]} barKeys={["영업CF","투자CF","재무CF"]} barColors={["#22c55e","#ef4444","#3b82f6"]} title="영업·투자·재무 현금흐름" unit="$M" />

| 항목 | 2025 | 2024 | 2023 | 2022 | 2021 |
|---|---:|---:|---:|---:|---:|
| 영업활동현금흐름 | — | 8,288 | 11,471 | 15,433 | 29,991 |
| 투자활동현금흐름 | — | -18,256 | -24,041 | -10,477 | -25,167 |
| 재무활동현금흐름 | — | 11,138 | 8,505 | 1,361 | -5,862 |
