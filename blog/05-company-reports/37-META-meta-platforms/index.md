...
| 2025 영업활동현금흐름 $115.8B | `c.select("CF",["영업활동현금흐름"])` 분기 합산 | 실측 115,800M |
...
| 2025 잉여현금흐름 $46.1B | `c.analysis("financial","현금흐름")["cashFlowOverview"]` | 실측 46,109M |
| 2025 설비투자 $69.7B | `c.analysis("financial","투자효율")["investmentIntensity"]` | 실측 69,691M |
| 2025 설비투자/매출 34.7% | 같은 출처, capexToRevenue | 실측 34.68% |
| GP마진 82% | `c.analysis("financial","수익성")["marginWaterfall"]` | 실측 82.0% |
| 영업이익률 41.4% | 같은 출처 | 실측 41.44% |
...
| 기간 | 보고서 | 링크 |
|------|--------|------|
| 2025Q3 | 10-Q | [SEC에서 보기](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=META&type=10-Q&dateb=&owner=include&count=10) |
| 2025Q2 | 10-Q | [SEC에서 보기](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=META&type=10-Q&dateb=&owner=include&count=10) |
| 2025Q1 | 10-Q | [SEC에서 보기](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=META&type=10-Q&dateb=&owner=include&count=10) |
| 2025 | 10-K | [SEC에서 보기](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=META&type=10-K&dateb=&owner=include&count=10) |
| 2024Q3 | 10-Q | [SEC에서 보기](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=META&type=10-Q&dateb=&owner=include&count=10) |
| 2024Q2 | 10-Q | [SEC에서 보기](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=META&type=10-Q&dateb=&owner=include&count=10) |
| 2024Q1 | 10-Q | [SEC에서 보기](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=META&type=10-Q&dateb=&owner=include&count=10) |
| 2024 | 10-K | [SEC에서 보기](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=META&type=10-K&dateb=&owner=include&count=10) |
| 2023Q3 | 10-Q | [SEC에서 보기](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=META&type=10-Q&dateb=&owner=include&count=10) |
| 2023Q2 | 10-Q | [SEC에서 보기](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=META&type=10-Q&dateb=&owner=include&count=10) |
...
<ComboChart data={[{year:"2025Q4",매출액:59894,영업이익:24745,당기순이익:22768},{year:"2025Q3",매출액:51242,영업이익:20535,당기순이익:2709},{year:"2025Q2",매출액:47516,영업이익:20441,당기순이익:18337},{year:"2025Q1",매출액:42314,영업이익:17555,당기순이익:16644},{year:"2024Q4",매출액:48386,영업이익:23365,당기순이익:20838}]} lineKeys={["매출액"]} barKeys={["영업이익","당기순이익"]} lineColors={["#22c55e"]} barColors={["#3b82f6","#f59e0b"]} title="매출(라인) vs 영업이익·당기순이익(막대)" unit="$M" />

| 항목 | 2025Q4 | 2025Q3 | 2025Q2 | 2025Q1 | 2024Q4 |
|---|---:|---:|---:|---:|---:|
| 매출액 | 59,894 | 51,242 | 47,516 | 42,314 | 48,386 |
| 매출원가 | 10,906 | 9,206 | 8,491 | 7,572 | 8,838 |
| 매출총이익 | 48,988 | 42,036 | 39,025 | 34,742 | 39,548 |
| 판매비와관리비 | 3,697 | 3,512 | 2,663 | 2,280 | 762 |
| 영업이익 | 24,745 | 20,535 | 20,441 | 17,555 | 23,365 |
| 금융수익 | — | — | — | — | — |
| 금융비용 | — | — | — | — | — |
| 당기순이익 | 22,768 | 2,709 | 18,337 | 16,644 | 20,838 |

### 재무상태표 (BS) — 단위 $M

<StackBar data={[{year:"2025Q4",segments:[{label:"부채",value:148778,color:"#ef4444"},{label:"자본",value:217243,color:"#22c55e"}]},{year:"2025Q3",segments:[{label:"부채",value:109778,color:"#ef4444"},{label:"자본",value:194066,color:"#22c55e"}]},{year:"2025Q2",segments:[{label:"부채",value:99674,color:"#ef4444"},{label:"자본",value:185029,color:"#22c55e"}]},{year:"2025Q1",segments:[{label:"부채",value:95184,color:"#ef4444"},{label:"자본",value:185029,color:"#22c55e"}]},{year:"2024Q4",segments:[{label:"부채",value:76455,color:"#ef4444"},{label:"자본",value:124879,color:"#22c55e"}]}]} title="부채 vs 자본 구조" unit="$M" />

| 항목 | 2025Q4 | 2025Q3 | 2025Q2 | 2025Q1 | 2024Q4 |
|---|---:|---:|---:|---:|---:|
| 자산총계 | 366,021 | 303,844 | 294,744 | 280,213 | 229,623 |
| 유동자산 | 108,722 | 73,118 | 73,613 | 90,227 | 85,365 |
| 비유동자산 | 196,804 | — | — | — | 109,881 |
| 부채총계 | 148,778 | 109,778 | 99,674 | 95,184 | 76,455 |
| 유동부채 | 41,836 | 36,958 | 37,305 | 33,890 | 31,960 |
| 비유동부채 | — | — | — | — | — |
| 자본총계 | 217,243 | 194,066 | 185,029 | 185,029 | 124,879 |

### 현금흐름표 (CF) — 단위 $M

<ComboChart data={[{year:"2025Q4",영업CF:36214,투자CF:-34187,재무CF:25149},{year:"2025Q3",영업CF:29999,투자CF:-21848,재무CF:-10047},{year:"2025Q2",영업CF:25561,투자CF:-25958,재무CF:-15977},{year:"2025Q1",영업CF:24026,투자CF:-20010,재무CF:-19495},{year:"2024Q4",영업CF:27988,투자CF:0,재무CF:-5465}]} barKeys={["영업CF","투자CF","재무CF"]} barColors={["#22c55e","#ef4444","#3b82f6"]} title="영업·투자·재무 현금흐름" unit="$M" />

| 항목 | 2025Q4 | 2025Q3 | 2025Q2 | 2025Q1 | 2024Q4 |
|---|---:|---:|---:|---:|---:|
| 영업활동현금흐름 | 36,214 | 29,999 | 25,561 | 24,026 | 27,988 |
| 투자활동현금흐름 | -34,187 | -21,848 | -25,958 | -20,010 | — |
| 재무활동현금흐름 | 25,149 | -10,047 | -15,977 | -19,495 | -5,465 |
