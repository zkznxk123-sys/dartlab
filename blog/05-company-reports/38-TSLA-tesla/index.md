...
Damodaran의 기업 생애주기 모델은 **고성장 → 성숙 → 쇠퇴** 경로를 따른다. dartlab의 성장성 분석은 Tesla를 **"외형 위주 성장"**으로 분류한다. 8년 CAGR(연평균 성장률): 매출 +35.1%, 영업이익 +10.3%, 순이익 +21.6%. 매출이 이익보다 훨씬 빨리 성장했다. 이것이 2025년 역풍을 만났을 때 무엇을 의미하는지가 2막의 주제다.
...
## 제2막: OPM 16.8% → 4.6% — 마진 붕괴의 해부

![영업이익률 붕괴의 해부](./assets/38-margin-collapse.svg)

### 왜 자동차 회사의 이익이 가장 먼저 무너지는가

Tesla는 2022년 영업이익률 16.8%로 글로벌 자동차 업계 최고 수준이었다. 같은 해 Toyota의 OPM은 약 9%([Toyota FY2022 Annual Report](https://global.toyota/en/ir/library/annual/)), BMW는 약 9%였다([BMW Group Annual Report 2022](https://www.bmwgroup.com/en/investor-relations/financial-reports.html)). Tesla가 2배 가까이 높았다. 그런데 3년 만에 4.6%로 추락했다. **Toyota보다 낮다.**
...
자동차는 전형적인 **고정비 산업**이다. 공장, 설비, R&D, 본사 인건비는 매출이 늘든 줄든 비슷하다. 매출이 늘 때는 고정비가 희석되어 이익이 매출보다 빨리 커진다. 반대로 매출이 줄면 이익이 훨씬 빨리 줄어든다. 이것을 **영업레버리지(DOL, Degree of Operating Leverage)**라고 한다.
...
**DOL 13.1.** 매출 1% 변동에 영업이익 13% 변동. 2025년 매출 -2.9%가 영업이익 -38.4%로 증폭됐다. 자동차 회사의 구조적 특성이다. 이 숫자가 의미하는 것은 다음 경기 침체에서 Tesla의 이익이 더 극단적으로 깎일 수 있다는 것이다.
...
**첫째, ROIC 하락.** 2022년 41.1% → 2025년 4.27%. 투자한 자본 1달러가 벌어오는 이익이 41센트에서 4센트로 줄었다. 이것은 2막의 마진 붕괴 + 자본 팽창의 결과다.
...
## 제4막: OCF $14.75B vs NI $3.8B — 이익이 아닌 현금의 구조

![현금흐름 현재와 전망](./assets/38-cashflow-projection.svg)

### 왜 순이익 $3.8B인 회사가 현금 $14.75B를 벌었나

Tesla의 2025년 순이익은 $3.85B이지만 영업활동현금흐름은 $14.75B다. **OCF/NI = 389%**. 현금이 이익의 **3.9배**다.
...
2025년 Tesla의 감가상각비는 약 $6.6B다([Tesla 10-K, 2025](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001318605&type=10-K)). 여기에 주식보상비용(SBC) $2.5B 수준, 운전자본 변화, 기타 조정까지 더해져서 순이익 $3.85B가 OCF $14.75B로 늘어난다.
...
| CAPEX (설비투자) | 8.53 | 11.34 | 8.90 | 7.16 | 6.48 |
| 잉여현금흐름(FCF) | **6.22** | 3.58 | 4.36 | 7.56 | 5.02 |

**FCF $6.22B.** 이익이 아닌 현금 기준으로는 아직 가치를 만들고 있다. 2024년 $3.58B에서 오히려 늘었다. CAPEX를 $11.3B → $8.5B로 줄였기 때문이다.

### 하지만 dFV가 말하는 미래

dartlab의 dFV v2 DCF 모델은 Tesla의 FCF가 4년 후부터 **마이너스**로 돌아선다고 전망한다.
...
이 전망의 근거는 성장률 둔화 (초기 5.2% → 영구 3%) + CAPEX 유지 + 마진 회복 미전망이다. 현재의 FCF $6.2B는 CAPEX 축소 효과가 크고, 공장 증설을 재개하면 다시 줄어든다.
...
dartlab의 dFV v2 DCF 모델이 계산한 Tesla의 **기업가치는 -$3.7B**다. 마이너스다. 자산을 다 팔아치우고 부채를 갚으면 $3.7B이 모자란다는 뜻이 아니다. **미래 5년 FCF의 현재가치 합산이 투하자본을 하회한다**는 뜻이다.

왜 이런 결과가 나오는가?

1. **초기 성장률 5.19%** — 4년 전(8년 CAGR 35%) 대비 급락. 현재의 매출 역성장을 반영한 보수적 추정.
2. **WACC 9.32%** — 자동차 업종 기준 + Tesla의 현재 ROIC(4.27%) 반영.
3. **FCF 3~5년차 마이너스** — 현 추세 연장 시 CAPEX가 OCF를 초과.
4. **영구성장률 3%** — 자동차 산업 평균.
...
| 2022 OPM 16.8% | 과거 시계열 | 실측 16.77% |
| 2025 자본 $82.9B | `c.select("BS",["자본총계"])` Q4 | 실측 82,865M |
| 자본 YoY +165% | `c.analysis("financial","안정성")["leverageTrend"]` | 실측 +165.11% |
| 2025 OCF $14.75B | `c.select("CF",["영업활동현금흐름"])` 분기 합산 | 실측 14,747M |
| 2025 CAPEX $8.53B | `c.analysis("financial","투자효율")["investmentIntensity"]` | 실측 8,527M |
| 2025 FCF $6.22B | `c.analysis("financial","현금흐름")["cashFlowOverview"]` | 실측 6,220M |
| OCF/NI 389% | `c.analysis("financial","현금흐름")["cashQuality"]` | 실측 388.7% |
| 2025 EVA -$4.19B | `c.analysis("financial","투자효율")["evaTimeline"]` | 실측 -4,187M |
| ROIC 4.27%, WACC 9.89% | 같은 출처 | 실측 4.27 / 9.89 |
| DCF EV -$3.7B | `c.analysis("가치평가")["dcfValuation"]` | 실측 -3,741M |
| 가중 타겟 $963B (중앙값 $321B) | `c.analysis("가치평가")["priceTarget"]` | 실측 |
| DOL 13.1 | `c.analysis("financial","성장성")["growthQuality"]` | 실측 13.12 |
