...
![네이버 핵심 구조 — 별도 OPM 75%가 연결 18%로 떨어지는 경로](./assets/45-hero-map.svg)
...
![서울 테크 디스트릭트의 네이버 — 검색 광고라는 현금 인쇄기가 모든 투자의 원천이다](./assets/45-naver-hq.webp)
...
![네이버 vs 카카오 영업이익률 9년 추이 — 한 번도 역전되지 않은 마진 격차](./assets/45-opm-timeline.svg)

## 2막: 연결하면 18% — 사라진 57%포인트의 행방

왜 별도 75%인 회사가 연결하면 18%가 되는가. 자회사와 투자 자산의 구조를 분해하면 보인다.

![네이버 자산 41조 구성 — 투자 41%, 영업 21%, 현금 15%](./assets/45-asset-breakdown.svg)
...
![네이버의 데이터센터 — AI 인프라와 클라우드 확장에 CAPEX 1.32조를 쏟는다](./assets/45-datacenter.webp)
...
![2021Q1 순이익 15.31조 — LINE과 Z Holdings 합병의 재무제표 흔적](./assets/45-2021-anomaly.svg)
...
![도쿄 시부야 — LINE과 Yahoo Japan이 만나 Z Holdings가 된 곳](./assets/45-tokyo-line.webp)
...
![네이버 영업활동현금흐름 9년 추이 — 0.74조에서 3.10조, 4.2배 성장](./assets/45-cashflow-fortress.svg)
...
![네이버 투자 체크포인트 5가지](./assets/45-checklist.svg)
