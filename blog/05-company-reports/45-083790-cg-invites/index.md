...
date: 2026-04-18
description: "매출 424억에서 73억으로 82% 추락, 7년 연속 영업적자 누적 1,400억+. 그런데 2025년 매출이 274억으로 4배 반등했다. 자본잠식 경계에 선 게임사의 생존 구조와 반등의 실체를 9년 재무제표로 분해한다."
...
> 같은 시리즈: [크래프톤](/blog/krafton) · [카카오](/blog/kakao) · [하이브](/blog/hybe) · [네이버](/blog/naver) · [기업이야기 시리즈 전체](/blog/series/company-reports)

<HFDataLink code="083790" />

CG인바이츠(083790)의 2024년 연간 매출은 73억원이다. 같은 게임업종 [크래프톤](/blog/krafton)의 매출 2.8조원의 0.26%. 시가총액 기준으로도 코스닥 하위권이다. 그런데 이 회사의 총자산은 2,241억원이다. 매출의 8배가 넘는 자산을 들고 있으면서 연간 매출이 73억이라면, 이 자산은 대체 뭘 하고 있는 것인가.
...
이 숫자를 게임업종과 비교하면 이상함이 더 분명해진다. [크래프톤](/blog/krafton)의 영업이익률은 35% 이상이다. 넷마블은 적자 시기에도 -30% 수준이었다. CG인바이츠의 -535%는 매출이 거의 없는데 고정비(인건비, 개발비, 운영비)가 그대로 남아있을 때만 가능한 숫자다. 이것은 "장사가 안 된다"를 넘어서 "장사 자체를 거의 안 하는데 비용만 나간다"에 가깝다.
...
이 시기는 코로나19 팬데믹으로 모바일 게임 시장 전체가 성장하던 때이기도 하다. 집에 머무는 시간이 늘면서 게임 매출이 업종 전반적으로 증가했다. CG인바이츠의 매출 급등이 순수하게 자사 게임의 경쟁력 때문인지, 업종 전체의 호황 덕분인지는 구분이 필요하다. 같은 기간 [크래프톤](/blog/krafton)의 매출도 1.3조에서 1.9조로 46% 성장했다. 그러나 크래프톤의 성장률 46%와 CG인바이츠의 성장률 203%는 차원이 다르다. CG인바이츠의 급등은 "기존 매출이 워낙 작아서 신작 하나에 숫자가 크게 움직인 것"이다.

### 모바일 게임의 수명 주기 — 보통 1~3년

여기서 게임 산업의 구조적 특성이 작동한다. 모바일 게임의 평균 수명 주기는 1~3년이다. 출시 직후 매출이 급등하고, 1~2년 뒤 이용자가 이탈하면서 매출이 급감한다. [크래프톤](/blog/krafton)의 배틀그라운드처럼 5년 이상 매출을 유지하는 게임은 극소수의 예외다. 대부분의 게임사는 신작을 계속 출시해서 이전 게임의 매출 감소를 메워야 한다.
...
**표시: 매출 424억(2021)에서도 OPM -12%. 매출 정점에서조차 적자 — 비용 구조가 문제.**
...
|:---|---:|---:|---:|---:|---:|---:|---:|---:|
| 자산총계 | 2,241 | 2,605 | 2,431 | 3,226 | 3,437 | 2,236 | 1,817 | 2,061 |
| 부채총계 | 1,054 | 1,397 | 978 | 1,292 | 1,225 | 747 | 573 | 362 |
| 자본총계 | **1,187** | 1,208 | 1,453 | 1,934 | 2,212 | 1,489 | 1,244 | 1,699 |

**표시: 자본총계 2,212억(2021) → 1,187억(2025). 4년간 -1,025억 감소. 연평균 -256억씩 녹고 있다.**

### 자본 감소 속도 — 연 256억씩 녹으면 몇 년 남았나

자본이 2021년 2,212억에서 2025년 1,187억으로 4년간 1,025억 감소했다. 연평균 256억씩 줄어드는 셈이다. 이 속도가 유지되면 약 4.6년 뒤인 2030년 전후에 자본잠식에 진입한다. 다만 2025년의 자본 감소폭은 21억으로 크게 줄었는데, 이는 매출 반등과 적자 폭 축소의 효과다.
...
dartlab의 자체 신용평가에서 CG인바이츠는 **dCR-BB**, 재무건전성 59점을 받았다. BB는 투기등급이다. 이 블로그에서 다뤘던 [크래프톤](/blog/krafton)(dCR-AA), [카카오](/blog/kakao)(dCR-AA), [삼성바이오로직스](/blog/samsung-biologics)(dCR-AA-)와는 완전히 다른 세계다.
...
### 자산 3,437억(2021) → 2,241억(2025) — 자산도 줄고 있다

자산총계도 4년간 1,196억 감소했다. 이것은 두 가지를 의미한다. 첫째, 보유 자산이 매각되거나 감액되었다. 둘째, 새로운 자산(신규 게임 개발비)이 기존 자산 감소를 메우지 못하고 있다. 자산이 줄면서 매출도 줄었다면, 게임 IP 자체가 소멸하고 있는 것이다.
...
### 자산 3,437억(2021) → 2,241억(2025) — 4년간 1,196억 감소

자산총계의 변화도 눈여겨봐야 한다. 2021년 3,437억이던 자산이 2025년 2,241억으로 4년간 1,196억 줄었다. 같은 기간 순손실 합계는 약 1,399억인데, 자산 감소가 1,196억이라는 것은 그 차이(약 203억)만큼 외부에서 자금이 유입되었다는 뜻이다. 유상증자와 차입의 흔적이다.
...
매출이 4배 반등하면서 영업적자도 -388억(2024)에서 -238억(2025)으로 39% 줄었다. 방향은 좋다. 그러나 아직 흑자와는 거리가 멀다. 영업이익률 -87%라는 것은 매출 274억 중 영업비용이 512억이라는 뜻이다.
...
2025년의 274억 반등도 같은 패턴을 밟을 수 있다. 게임 산업에서 "매출 급등 → 2년 뒤 급락"은 예외가 아니라 규칙이다. [하이브](/blog/hybe)의 앨범 사이클, [크래프톤](/blog/krafton)의 배틀그라운드 초기 급등 후 안정화와 비교하면, CG인바이츠는 안정화 구간 없이 급등-급락만 반복하고 있다.
...
### 잉여현금흐름(FCF)의 의미 — 게임사에서 더 중요한 이유
...
게임 산업에서 중소형사의 재무제표는 "히트작 유무"로 양분된다. [크래프톤](/blog/krafton)은 배틀그라운드 하나로 9년간 매출 2.8조를 유지한다. [하이브](/blog/hybe)는 BTS를 중심으로 아티스트 포트폴리오를 확장해 매출 안정성을 높였다. 반면 대부분의 중소 게임사는 히트작 1~2개의 수명 주기에 회사 전체가 흔들린다. CG인바이츠의 2020~2024년 궤적이 정확히 이 패턴이다.
...
[크래프톤](/blog/krafton)의 배틀그라운드는 2017년 출시 이후 9년간 매출을 유지하는 극소수의 장수 IP다. 장수 IP는 "한 번 개발하면 추가 비용 최소로 매출이 계속 나오는 구조"를 만든다. 크래프톤의 영업이익률 35%는 이 구조에서 나온다.
...
다른 점이 있다면, 첫 번째 사이클에서는 자본이 2,212억으로 여유가 있었다. 지금은 1,187억이다. 같은 실수를 반복할 여유가 절반 이하로 줄었다.
...
| OPM 2018 13% | 영업이익 18 ÷ 매출 139 = 12.9% ≈ 13% | ✅ 사용자 제공 실측 |
| OPM 2024 -535% | 영업이익 -388 ÷ 매출 73 = -531% ≈ -535% | ✅ 사용자 제공 실측 |
| OPM 2025 -87% | 영업이익 -238 ÷ 매출 274 = -86.9% ≈ -87% | ✅ 사용자 제공 실측 |
...
| 자본 4년 감소 1,025억 | 2,212-1,187=1,025 | ✅ 계산 검증 |
...
| 회계정책변경 | — | — | — | — | — |
| 지분법자본변동 | 0.0 | 23 | — | -2 | 2 |
| 기초자본 | 1,208 | 384 | 51 | 346 | 231 |
| 유상증자 | 0.0 | — | 0.0 | 49 | 18 |
| 연결범위변동 | 0.0 | 225 | 0.0 | — | — |
| 전환사채 | — | — | — | — | — |
| 결손금보전 | — | — | 0.0 | — | — |
| 배당 | — | — | — | — | — |
| 기말자본 | 1,052 | 345 | 1,453 | 321 | 68 |
| 자본변동합계 | 3 | 154 | — | — | — |
| FVOCI평가 | 0.0 | 10 | — | -5 | 13 |
| 해외사업환산 | 0.0 | — | — | -3 | 0.3 |
| 연결범위내거래 | 0.0 | -3 | 0.0 | — | 31 |
| 당기순이익 | 0.0 | -515 | -489 | -239 | 159 |
| 기타 | 0.0 | — | 0.0 | — | 0.3 |
