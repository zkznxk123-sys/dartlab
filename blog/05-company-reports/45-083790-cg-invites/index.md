...
ai:
  ...
  dataAsOf: "2026-04-18"
carousel:
  title: 7년 적자 게임사가 아직 살아있는 이유 — 매출 73억의 진실
  caption: |-
    매출 424억에서 73억으로 82% 추락한 게임사. 7년 연속 영업적자, 누적 1,439억. 보통 이쯤이면 자본잠식이나 상장폐지인데, 이 회사는 아직 살아있다.

    비밀은 유상증자다. 적자로 자본이 녹으면 새 주식을 찍어 메우는 반복. 그래서 자본은 2021년 2,146억에서 2025년 1,187억으로 4년간 959억 줄었다. 그런데 2025년 매출이 274억으로 3.8배 반등했다. 순손실도 -518억에서 -125억으로 76% 축소, 영업적자도 -388억에서 -238억으로 39% 축소됐다.

    관전 포인트: 2020~2021년에도 매출이 3배 뛰었다가 2년 만에 추락했다. 이번 반등이 두 번째 사이클의 반복인지 진짜 턴어라운드인지는 분기 매출 70억 유지·영업적자 50억 이하 여부로 갈린다.
  pinnedComment: 투자 판단이 아닙니다. 모든 수치는 dartlab 실측(검증표 기준)이며, 업종 평균·수명주기 등은 (외부/업계 추정) 표기했습니다.
  slides:
  - layout: editorial
    date: 2026. 06. 26
    line: |-
  ...
  - layout: editorialBeat
    ...
    sub: |-
      ...
      2026년에 볼 두 숫자: 분기 매출 70억 유지·영업적자 50억 이하 전환
    image: empty-office
---
