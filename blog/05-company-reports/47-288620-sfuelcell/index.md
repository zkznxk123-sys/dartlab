...
문제는 두 가지다. 첫째, **태양광·풍력이 더 저렴해졌다.** RPS 의무를 맞추는 데 연료전지보다 태양광이 싸다. 태양광 균등화발전비용(균등화발전비용, 전기 1MWh를 생산하는 데 드는 평균 비용)는 $20~30/MWh까지 떨어졌다. 연료전지는 $80~120/MWh 수준이다. 같은 RPS 크레딧을 받으려면 발전사 입장에서 태양광이 3~4배 싸다.
...
2025년 설비투자(설비투자)는 매출의 0.7%인 1억원 수준이다. 2020년에는 22억원을 투자했다. 투자를 사실상 중단했다는 뜻이다. 적자 기업이 투자를 멈추면 현재 제품의 경쟁력 유지도 어려워진다 — 기술은 정체되고 시장은 앞으로 간다.
...
왜 2024년에 영업활동현금흐름가 +30억으로 잠깐 플러스였는가. 답은 "구조조정"이다.
...
| 설비투자 | -0.1 | -0.5 | -0.1 | -1.6 | -1.4 | -22.0 |
| 잉여현금흐름 | **-3.6** | 29.4 | 39.2 | 7.3 | 10.2 | 59.5 |

2024년 영업활동현금흐름 +30억원은 좋은 숫자처럼 보이지만, dartlab의 현금흐름 분석은 이를 **"구조조정형"**으로 분류했다. 집을 팔아서 월급을 메운 것처럼, 자산을 매각하고 부채를 상환하면서 일시적으로 현금이 늘어난 것이지 본업에서 벌어온 돈이 아니다. 2025년에 다시 -3.5억으로 돌아온 것이 그 증거다.
...
1. **경쟁 기술의 가격 하락**: 1막에서 봤듯이 태양광 균등화발전비용가 연료전지의 3~4분의 1이다. 뉴스케일의 SMR도 $89/MWh로 비싸지만, "24시간 가동" + "AI 데이터센터의 안정 전력 수요"라는 차별화가 있다. ChatGPT를 돌리는 데이터센터는 태양광처럼 낮에만 나오는 전기가 아니라, 365일 24시간 끊김 없는 전기가 필요하다. 이 시장에서 SMR은 경쟁력이 있지만, 연료전지는 아직 이 틈새를 찾지 못했다.
...
| 영업활동현금흐름 2025 -3.5억 | `c.select("CF",["영업활동현금흐름"])` | ✅ 실측 | |
| 영업활동현금흐름 2024 +29.9억 | CF 분기 합산 | ✅ 실측 | |
