...
> 같은 시리즈: [대한조선](/blog/daehan-shipbuilding) · [HMM](/blog/hmm) · [현대글로비스](/blog/hyundai-glovis) · [한화에어로스페이스](/blog/hanwha-aerospace) · [HD현대일렉트릭](/blog/hd-hyundai-electric) · [기업이야기 시리즈 전체](/blog/series/company-reports)

<HFDataLink code="042660" />

한화오션(042660)은 잠수함을 만드는 조선소다. KSS-III 장보고급 잠수함, 차기호위함, 상륙함 — 대한민국 해군의 핵심 전력을 건조한다. 방산 프리미엄이 붙어야 할 회사다. [한화에어로스페이스](/blog/hanwha-aerospace)의 K9 자주포가 OPM 10%를 넘긴 것처럼.

그런데 dartlab으로 재무제표를 열면 이상한 게 보인다. 2025년 OPM 9.1%. 나쁘지 않다. 하지만 같은 조선업인 [대한조선](/blog/daehan-shipbuilding)의 OPM은 24%다. **상선만 만드는 조선소가 방산을 하는 조선소보다 마진이 2.7배 높다.** 방산 프리미엄은 어디로 갔을까.

9년치 재무제표를 추적하면 답이 보인다 — OPM -39%(2021)에서 시작된 턴어라운드, 자본 0.74조에서 6.17조로의 부활, 그리고 방산이 마진을 올려주는 게 아니라 **"저가 수주에서 얼마나 빨리 빠져나왔는가"**가 마진을 결정한다는 조선업의 구조적 진실.
...
|:---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| OPM (%) | **9.1** | 2.2 | -2.7 | **-33.2** | **-39.1** | 2.2 | 3.5 | 10.6 | 6.6 |

2021~2022년 OPM이 -39%, -33%인 것은 "저가 수주 충당금"의 결과다. 2019~2020년에 수주한 선박을 계약 당시 가격으로 지어야 하는데, 원자재(철판·구동장치)와 인건비가 급등했다. 만들면 만들수록 손해가 나는 구조 — [에스퓨얼셀](/blog/sfuelcell)의 매출원가율 127%와 같은 메커니즘이지만, 조선소의 스케일에서 벌어진 것이다.

### 분기별 OPM — 2025년 전 분기 흑자

| 분기 | 2023Q1 | Q2 | Q3 | Q4 | 2024Q1 | Q2 | Q3 | Q4 | 2025Q1 | Q2 | Q3 | Q4 |
|:---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| OPM(%) | -4.4 | -8.7 | 3.9 | -2.2 | 2.3 | -0.4 | 1.0 | 5.2 | **8.2** | **11.3** | **9.6** | **7.5** |
...
매출원가율이 98.7%(2023) → 85.6%(2025)로 13%포인트 개선됐다. 2025년 OPM 개선 9.1%포인트 중 **86%가 원가율 개선**에서 왔다. 고선가 수주가 매출에 반영되기 시작한 것이다. 조선업에서 마진을 결정하는 것은 "지금의 원가"가 아니라 "2~3년 전의 수주 가격"이다. 한화오션이 2022~2023년에 높은 가격으로 수주한 선박이 2025년 매출에 찍히면서 마진이 돌아왔다.

*-39%에서 +9.1%로, 4년. 하지만 같은 조선업의 [대한조선](/blog/daehan-shipbuilding)은 24%다. 왜 방산을 하는 조선소의 마진이 더 낮을까.*
...
여기서 핵심 질문이 나온다. [한화에어로스페이스](/blog/hanwha-aerospace)는 K9 자주포·천무 다연장로켓 수출로 OPM 10%+ 를 달성했다. 방산은 원래 마진이 높은 사업 아닌가?

답은 **"조선 방산은 육상 방산과 구조가 다르다"**에 있다.

1. **생산 방식의 차이**: K9 자주포는 표준화된 생산라인에서 수백 대를 만든다. 잠수함은 1척씩 맞춤 제작이다. 규모의 경제가 작동하지 않는다.

2. **발주처 특성**: 잠수함·호위함의 발주처는 대한민국 해군이다. 예산이 정해져있고, 원가 기반 가격(cost-plus)으로 계약한다. 수출이 아닌 내수 방산은 마진이 제한된다. [현대로템](/blog/hyundai-rotem)의 K2 전차도 내수 OPM은 수출보다 낮다.

3. **납기와 충당금**: 방산 프로젝트는 10년+ 장기 계약이다. 원자재·인건비 변동을 정확히 예측하기 어렵고, 예상을 초과하면 충당금이 잡힌다. 2021~2022년 한화오션의 -39% OPM에는 방산 프로젝트 충당금도 포함됐다.
...
왜 대한조선 OPM 24%이고 한화오션은 9%인가. 답은 **선종 집중도**와 **저가 수주 탈출 속도**에 있다.

### 대한조선과의 결정적 차이

| 항목 | 한화오션 | [대한조선](/blog/daehan-shipbuilding) |
|:---|:---|:---|
| 매출 | 12.78조 | 1.2조 |
| OPM | 9.1% | **24%** |
...
### 조선업 OPM의 진짜 결정요인 — 2~3년 전의 수주 가격
...
2021~2022년 한화오션의 OPM -39%는 2019~2020년의 저가 수주 때문이었다. 코로나 시기에 선가가 바닥이었을 때 수주한 선박을 원자재 가격이 급등한 시점에 건조해야 했다. 반대로 2025년 OPM 9.1%는 2022~2023년의 고선가 수주가 반영된 것이다.

대한조선은 2022년 인수 후 **처음부터 높은 선가로만 수주**했다. 저가 수주 레거시가 없었다. 이것이 OPM 24%가 가능한 진짜 이유다 — 선종 집중 + 저가 수주 잔량 0.

### 영업레버리지(DOL) 20배 — 칼날 위의 수익성

dartlab 종합평가의 경고: **DOL(영업레버리지) 20배**. 매출이 10% 오르면 영업이익이 200% 오르고, 매출이 10% 빠지면 영업이익이 200% 빠진다. 조선업 특유의 높은 고정비 구조 때문이다. 2025년 OPM 9.1%가 좋아 보이지만, 다음 사이클에서 선가가 하락하면 -30%대로 돌아갈 수 있는 구조라는 뜻이다.
...
### 부채비율 226%, ICR 1.52배 — 회복됐지만 안전하진 않다
...
| ICR (배) | **1.52** | 0.20 | -0.22 | — |
| Altman Z | **1.59** | 1.10 | 0.58 | **-2.72** |
| 차입금 (조원) | 5.65 | 5.27 | 4.59 | — |

Altman Z가 -2.72(2022, 부실 위험) → 1.59(2025, 회색구간)로 회복됐다. 하지만 안전구간(2.6)에는 아직 못 미친다. ICR 1.52배는 "이자를 겨우 갚을 수 있다"는 수준이다. [네이버](/blog/naver)의 ICR 3.93배나 [SK하이닉스](/blog/skhynix)와 비교하면 여유가 없다.

차입금 5.65조원은 자본 6.17조원과 거의 같은 규모다. 조선업이 다시 침체기에 들어가면 이 부채가 부담이 된다. 2021~2022년처럼 OPM이 마이너스로 돌아서면 이자 부담만으로도 자본이 빠르게 줄어든다.
...
dartlab 신용등급 dCR-BBB. 투자등급이다. 하지만 건강점수 61점은 높지 않다. 유동성 축이 43점으로 **하방 압력의 주 원인**이다. 단기차입금 비중 58.5%가 유동성 리스크를 키우고 있다 — 장기 대출보다 단기 대출 비중이 높아서, 금리 변동에 취약하다.

*자본은 8.3배 복원됐지만, 부채 226%와 ICR 1.52배가 말해주는 것은 "회복은 됐지만 방어력이 아직 충분하지 않다"는 것이다.*

---

## 5막: 현금흐름의 진실 — 선수금과 미청구공사

왜 2024년 OCF가 -2.90조인데 회사가 살아있는가. 조선업 특유의 현금흐름 구조를 이해해야 한다.

### OCF 추이 — 마이너스가 나쁜 것은 아니다
...
조선업의 OCF는 일반 제조업과 해석이 다르다. 선박은 수주 → 건조(2~3년) → 인도의 순서로 진행된다. 건조 중에는 원자재·인건비가 나가지만 매출은 진행기준(완성 비율)으로 잡힌다. **실제 현금은 선수금(계약 시 30% + 중간금)으로 들어오고, 잔금(70%)은 인도 시 받는다.** 

2023~2024년 OCF 마이너스는 "대규모 수주로 건조가 시작됐지만 인도가 아직 안 된 배가 많다"는 뜻이다. 이것은 나쁜 신호가 아니라 **"앞으로 매출과 현금이 들어올 배가 많다"**는 신호다. 실제로 2025년에 OCF가 +1.31조로 돌아왔다 — 인도가 시작된 것이다.

### CAPEX 재개 — 0.72조, 성장 투자

2025년 CAPEX 7,166억원은 감가상각비 5,273억원의 1.36배다. 조선소 설비 확충이 시작됐다. 2021~2023년에는 CAPEX가 거의 0이었다 — 적자에 허덕이며 투자를 멈춘 시기였다. CAPEX 재개는 "이제 투자할 여유가 생겼다"는 뜻이고, 미래 건조 능력 확장을 위한 것이다.

*2024년까지의 OCF 마이너스는 수주 폭증의 증거였다. 2025년에 현금이 돌아오기 시작했다.*
...
한화오션의 방산은 지금까지 대부분 내수(대한민국 해군)였다. 내수 방산은 마진이 제한된다. 하지만 한화그룹의 전략은 **수출**이다. 한화에어로스페이스가 폴란드에 K9 자주포를 수출해서 OPM을 끌어올린 것처럼, 한화오션도 잠수함·호위함 수출을 추진하고 있다.
...
1. **분기 OPM 10% 이상 안착** — 2025년 8~11% 범위. 10%가 구조적 턴어라운드의 확인선. [대한조선](/blog/daehan-shipbuilding)의 24%와 비교하면 아직 갈 길이 있다.

2. **ICR 3.0배 돌파** — 현재 1.52배. 조선 사이클 하강 시 이자 부담이 커지므로 3.0배 이상이 안전 마진.
...
## 관통선 닫기: 방산 프리미엄의 진짜 의미

한화오션의 OPM 9.1%는 2021년 -39%에서의 극적 회복이다. 하지만 방산이 마진을 올려주진 않았다. 조선 방산은 "고마진 사업"이 아니라 **"경기를 타지 않는 안정적 일감"**이다. 방산 프리미엄은 마진이 아니라 생존력에 찍힌다 — 2021~2022년 OPM -39%에서도 해군 수주가 바닥을 깔아준 것이 그 증거다.

대한조선 OPM 24%와의 격차는 "방산 유무"가 아니라 **"선종 집중도"와 "저가 수주 탈출 속도"**가 결정했다. 한화오션은 다선종 구조의 규모 있는 조선소이고, 대한조선은 수에즈막스 한 선종에 올인한 작은 조선소다. 마진의 높이는 다르지만, 한화오션은 LNG선이라는 진입장벽과 방산 수출이라는 새 수익원을 가지고 있다.

2026년에 봐야 할 한 줄: **방산 수출 첫 수주.** 이것이 성사되면 "내수 방산 = 저마진"에서 "수출 방산 = 고마진"으로 전환되고, 9% OPM은 15%를 향해 올라간다. 한화가 이 조선소를 산 진짜 이유가 증명되는 순간이다.
...
| 2025 OPM 9.1% | 1.17/12.78 | ✅ 계산 | |
| 2021 OPM -39.1% | -1.75/4.49 | ✅ 계산 | |
...
| ICR 1.52배 | coverageTrend | ✅ 실측 | |
| Altman Z 1.59 | `c.analysis("financial","종합평가")` summaryFlags | ✅ 실측 | |
| Altman Z -2.72 (2022) | 종합평가 | ✅ 실측 | |
| DOL 20배 | summaryFlags | ✅ 실측 | |
| dCR-BBB | `c.credit("등급")` grade | ✅ 실측 | |
| OCF 2025 1.31조 | `c.select("CF",...)` 분기 합산 | ✅ 실측 | |
| CAPEX 2025 0.72조 | `c.analysis("financial","자산구조")` capexPattern | ✅ 실측 | |
| 판관비율 5.3% | marginWaterfall | ✅ 실측 | |
| 대한조선 OPM 24% | 대한조선 블로그 #14 | ✅ 교차 | |
