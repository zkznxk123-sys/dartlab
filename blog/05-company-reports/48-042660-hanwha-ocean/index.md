...
carousel:
  ...
  - term: 수주잔고
    body: 이미 계약했지만 아직 매출로 잡히지 않은 주문 총액입니다. 잔고가 커도 건조·납품을 지나야 이익이 됩니다.
  relatedNews:
  - title: "'장보고-N' 20조 수주 잭팟인가, 15년짜리 신기루인가…방산주 재평가"
    ...
    track: naver
    description: 네이버 보관 뉴스 기준. '수주가 잭팟이냐 신기루냐' — 카드가 말한 '수주잔고만으로는 부족'과 정확히 같은 질문입니다.
  - title: 캐나다 잠수함 60조 수주전 막바지…한화오션 등 K방산 원팀 총력전
    source: thepublic.kr
    date: '2026-06-28'
    url: https://www.thepublic.kr/news/articleView.html?idxno=309294
    track: naver
    description: 네이버 보관 뉴스 기준. 특수선(잠수함) 대형 수주전 — 특수선이 매출·이익으로 바뀌는지 보는 관전 포인트입니다.
