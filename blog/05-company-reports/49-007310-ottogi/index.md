...
ai:
  ...
  keyMetrics: {revenue: 0.8962, opm: 4.8, roe: 101.4, fcf: -0.0115}
  dataAsOf: "2026-04-18"
---
...
> 같은 시리즈: [삼양식품](/blog/samyang-foods) · [농심](/blog/nongshim) · [달바글로벌](/blog/dalba-global) · [에이피알](/blog/apr) · [기업이야기 시리즈 전체](/blog/series/company-reports)

<HFDataLink code="007310" />

[삼양식품](/blog/samyang-foods)의 2025년 영업이익률은 22%다. [농심](/blog/nongshim)은 5.2%. 오뚜기(007310)는 4.8%. 셋 다 라면을 만든다. 같은 밀가루에 같은 스프를 넣어 끓여 먹는 제품인데, 마진이 **4배** 차이 난다.

삼양만 다르다. 농심과 오뚜기는 거의 같다. dartlab으로 9년치 재무제표를 나란히 놓으면 답이 보인다 — **해외 매출 비중**이다. 삼양 77%, 농심 66%, 오뚜기 15%. 해외에서는 한국 라면에 프리미엄을 붙여 팔 수 있다. 국내에서는 편의점 가격 경쟁에 갇혀서 원가율 84%를 벗어나지 못한다. **내수 식품의 OPM 천장은 5~7%**다. 오뚜기의 진라면이 아무리 맛있어도, 이 천장을 깨려면 해외로 나가야 한다.

---

![라면 빅3 — 삼양·농심·오뚜기 삼각 비교](./assets/49-hero-map.svg)

## 1막: OPM 4.8% — "안정적이지만 성장하지 않는" 프랜차이즈

왜 오뚜기의 영업이익률은 7년째 5% 언저리에 갇혀있는가.

### 매출 5,165억(2017) → 8,962억(2025), 9년간 1.7배
...
**표시: 매출은 9년간 1.7배로 꾸준히 늘었다. 그런데 영업이익은 302억→193억으로 오히려 줄었다. 매출이 늘수록 이익이 줄어드는 구조.**
...
### 영업이익 302억→193억 — 매출이 늘었는데 이익이 줄었다

더 이상한 건 영업이익이다. 2017년 302억원이던 영업이익이 2025년 193억원으로 **36% 감소**했다. 매출은 73% 늘었는데 이익은 줄었다. 매출이 늘면 이익도 늘어야 정상인데, 오뚜기는 **역레버리지(DOL -5.27)**가 작동하고 있다. 매출이 늘어도 원가와 판관비가 더 빠르게 올라서 이익이 줄어드는 구조다. 이건 단순한 경기 변동이 아니라 **구조적 문제**다.

### OPM 추이 — 5~7% 범위에서 벗어나지 못한다
...
|:---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| OPM (%) | **4.8** | 6.3 | **7.4** | 5.8 | 6.1 | 4.6 | 3.5 | 6.1 | 5.9 |
| GPM (%) | 16.1 | 17.1 | **17.5** | 15.7 | 16.1 | — | — | — | — |
...
### 분기별 OPM — Q4마다 떨어지는 패턴

| 분기 | 2023Q1 | Q2 | Q3 | Q4 | 2024Q1 | Q2 | Q3 | Q4 | 2025Q1 | Q2 | Q3 | Q4 |
|:---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| OPM(%) | 7.6 | 7.6 | 9.1 | 5.0 | 8.3 | 7.2 | 7.0 | **2.7** | 6.2 | 5.0 | 5.8 | **2.2** |

Q4마다 OPM이 급락한다. 2024Q4 2.7%, 2025Q4 2.2%. 연말 프로모션 비용과 재고 조정이 4분기에 집중되기 때문이다. 식품업의 계절적 패턴이지만, 분기 OPM이 2%대로 떨어지는 것은 **고정비 구조에 여유가 없다**는 뜻이다.

이 패턴을 [한화오션](/blog/hanwha-ocean)의 OPM -39%→+9.1% 턴어라운드와 비교하면 대조적이다. 한화오션은 저가 수주를 소화한 후 마진이 급반등했다. 오뚜기는 **반등할 구간 자체가 없다** — 내수 식품의 원가 구조에서 OPM 7%가 사실상 정점이고, 원재료 사이클에 따라 5%와 7% 사이를 오간다.

*매출은 꾸준하지만 이익은 제자리. 왜 이 천장을 깨지 못하는가.*

---

![라면 빅3 OPM 9년 추이 — 삼양만 이탈, 농심·오뚜기는 같은 범위](./assets/49-opm-comparison.svg)
...
차이는 원가율에 있다. 84% vs 55%. 이 29%포인트 격차가 OPM 4배 차이를 만든다.
...
오뚜기의 해외 매출 비중은 15%에 불과하다. 매출의 85%가 국내에서 나온다. 국내 대형마트(40%)와 특약점(39%)이 주요 채널인데, 이 채널에서는 가격 인상이 극도로 어렵다. **"국민 식품"이라는 브랜드가 가격 인상의 족쇄가 된다** — [농심](/blog/nongshim)이 "1위의 저주"라면, 오뚜기는 "2위의 안정"이다. 올리면 농심으로 넘어가고, 안 올리면 마진이 줄어든다.
...
2025년 원재료 비용은 2조 2,802억원이다. 매출 8,962억원의 2.5배가 원재료에 들어간다 — 연결 기준이므로 자회사(오뚜기라면, 풍림식품 등)의 원재료가 포함된 것이지만, 원재료 의존도가 극도로 높다는 점은 명확하다.
...
### 농심의 교훈 — 해외 66%인데 왜 OPM이 5%인가

농심의 해외 비중은 66%로 낮지 않다. 그런데 OPM은 5.2%다. 이유는 [농심 블로그](/blog/nongshim)에서 분석했듯 **중국 시장(해외의 17%)이 마진을 깎기 때문**이다. 중국에서 신라면은 로컬 제품 대비 2배 가격이 상한선이고, 물류·마케팅·관세를 빼면 손익분기점 수준이다. "해외에 나갔다"와 "해외에서 돈을 벌었다"는 다르다.
...
문제는 실행이다. 삼양식품은 해외 법인 15개국, 현지 유통 파트너십, SNS 마케팅에 판관비의 상당 부분을 투자했다. 삼양의 판관비율 23%가 오뚜기(11%)의 2배인 이유다 — 해외 마케팅 비용이 판관비에 들어간다. **해외에서 돈을 벌려면 먼저 돈을 써야 한다.** 오뚜기가 해외 비중을 올리면 단기적으로 판관비가 늘고 OPM은 더 떨어진다. 이 투자 구간을 견딜 수 있는가가 경영진의 판단이다.
...
*해외 15%라는 숫자가 말해주는 것은 명확하다. 내수에서는 OPM 5%가 천장이고, 이 천장을 깨려면 해외 비중을 올려야 한다.*

---

## 4막: 그래도 안전한 회사 — dCR-A, 현금 4,127억

왜 OPM이 5%인데 위험하지 않은가. 오뚜기의 재무 체력을 보면 답이 나온다.
...
[에스퓨얼셀](/blog/sfuelcell)의 4개 F와 비교하면 하늘과 땅이다. 오뚜기는 **"죽지 않는 회사"**다. 다만 "크게 성장하지도 않는 회사"다.
...
dartlab 신용등급 dCR-A. 우량이다. 부채비율 65%로 안정적이고, 현금 4,127억원은 매출의 46%에 해당한다. [네이버](/blog/naver)의 dCR-AA보다 한 단계 아래지만, 식품업에서 이 정도면 최상위권이다.
...
| CAPEX | -543 | -771 | -532 | -348 | -300 |
| FCF | -115 | -300 | 117 | -559 | 489 |

2022년을 제외하면 OCF는 매년 400~800억 수준으로 안정적이다. 문제는 CAPEX가 OCF보다 크거나 비슷해서 FCF(잉여현금흐름, 영업현금에서 투자비를 뺀 진짜 남는 돈)가 마이너스인 해가 많다는 것이다. 공장 설비 투자가 버는 돈만큼 나간다 — 식품 제조업은 설비 유지·갱신에 지속적 투자가 필요한 자본집약적 사업이다.

[삼양식품](/blog/samyang-foods)도 2025년 FCF가 -1,397억원이었다. "호황의 정중앙에서 FCF 마이너스" — 삼양은 해외 공장 증설에 투자한 것이다. 오뚜기의 FCF 마이너스는 기존 설비 유지에 쓰인 것이라 성격이 다르다. 같은 마이너스지만 삼양은 "공격 투자", 오뚜기는 "유지 투자"다.

### 배당 — 20~24%에서 2025년 미지급

오뚜기의 배당성향은 2021~2024년 20~24% 범위였다. 하지만 2025년에는 순이익이 72억원으로 급감하면서 배당금 지급이 0원이었다(CF 기준). 순이익 감소의 원인은 영업이익 하락에 영업외손실 비중 37%가 겹친 것이다.

| 연도 | 배당금지급 (억원) | 순이익 (억원) | 배당성향 (%) |
|:---|---:|---:|---:|
| 2024 | 32 | 138 | 23.6 |
| 2023 | 33 | 268 | 20.2 |
| 2022 | 27 | 278 | 9.6 |
...
[삼양식품](/blog/samyang-foods)은 같은 기간 DPS(주당 배당금)를 150원에서 4,800원으로 32배 올렸다. 이익이 폭증하면서 배당도 함께 올린 것이다. 오뚜기는 이익이 줄면서 배당도 멈췄다. **성장하는 회사의 배당 증가 vs 정체된 회사의 배당 중단** — 같은 식품업에서 완전히 다른 궤적이다.

### 영업외손실 37% — 이익을 깎는 보이지 않는 비용

dartlab summaryFlags가 잡아낸 또 하나의 경고: **"영업외손실 비중 37%"**. 영업이익 193억원 중 37%에 해당하는 약 71억원이 영업 외 요인(이자비용, 외환손실, 지분법손실 등)으로 빠져나간다. 영업이익은 줄어드는데 영업외손실까지 커지면서 순이익이 72억원까지 떨어진 것이다. 자회사와 관계기업의 실적이 본사 순이익에 영향을 주는 구조다.

또한 **이연법인세자산 2.6배 급증**도 주목할 만하다. 이연법인세자산이 늘어난다는 것은 "미래에 세금을 줄여줄 손실이 쌓이고 있다"는 뜻이다. 현재는 이 손실이 자산으로 인식되지만, 향후 수익성이 회복되지 않으면 감액 대상이 된다.
...
왜 삼양만 이탈했는가. 2017년에는 셋 다 OPM 5~9% 범위에 있었다. 2025년에 삼양만 22%다.

### 9년의 갈림길 — 불닭이 만든 구조적 분리

2017년 삼양식품의 OPM은 9.4%였다. 오뚜기(5.9%)보다 높았지만, 4배 차이는 아니었다. 갈림길은 **2023년**부터다. 삼양 OPM이 11% → 18% → 22%로 3년 연속 급등했다. 불닭볶음면의 글로벌 매출이 폭발하면서 해외 비중이 50%를 넘고 70%를 넘긴 것이다.

같은 기간 농심은 4.7~6.6%, 오뚜기는 4.8~7.4%로 **같은 범위에 갇혔다**. 농심은 해외 66%인데도 5%인 것은 중국 시장 때문이고, 오뚜기는 해외 15%인 것이 직접 원인이다.

### 핵심 교훈 — 내수 식품의 천장

이 비교가 말해주는 것은 하나다. **한국 내수 식품 시장에서 OPM 5~7%는 구조적 천장**이다. 원재료 가격은 글로벌 시장에서 결정되고, 판매 가격은 유통(대형마트·편의점)이 결정한다. 제조사가 가격을 올리면 소비자가 PB 제품이나 경쟁사로 넘어간다.

이 천장을 깬 유일한 방법이 **해외 프리미엄**이다. 삼양이 증명했다. 같은 원가로 만든 제품을 해외에서 2~4배 가격에 판다. 원가율이 55%로 떨어지고 OPM이 22%가 된다.
...
단순 시뮬레이션을 해보자. 오뚜기의 해외 매출이 현재 15%(약 1,344억)에서 30%(약 2,689억)로 2배가 된다고 가정한다. 해외 매출의 원가율이 삼양 수준인 60%라면(국내 84% 대비 24%p 낮다), 해외 확대분 1,345억에서 약 322억의 추가 매출총이익이 발생한다. 현재 영업이익 193억에 더하면 약 515억, **OPM이 5.7%까지 개선**된다.
...
1. **OPM 7% 회복** — 2023년 7.4%가 최근 정점. 원가율 하락 + 판관비 통제가 동시에 이뤄져야. 원재료 가격 사이클에 의존적.
...
5. **배당 재개 여부** — 2025년 배당 미지급. 순이익 72억으로 배당 여력 부족. 2026년 실적 회복 시 배당 재개가 "주주 신뢰" 시그널.

---

## 관통선 닫기: 내수 식품의 OPM 천장

오뚜기는 좋은 회사다. dCR-A 우량, 부채비율 65%, 현금 4,127억. 매일 한국인의 식탁에 오르는 제품을 만든다. 부도 위험은 제로에 가깝다.

하지만 OPM 4.8%는 "안전"이지 "성장"이 아니다. 매출이 9년간 1.7배 늘었지만 영업이익은 오히려 줄었다. 원가율 84%가 천장이고, 이 천장은 내수 시장의 가격 구조가 만든 것이다.

[삼양식품](/blog/samyang-foods)이 증명한 탈출구는 **해외**다. 같은 라면을 해외에서 팔면 원가율이 55%로 떨어지고 OPM이 22%가 된다. [농심](/blog/nongshim)은 해외 66%인데도 5%인 것을 보면, "어디서 파느냐"가 아니라 **"프리미엄을 받을 수 있는 제품이 있느냐"**가 진짜 질문이다.

라면 빅3를 나란히 놓으면 한국 식품 산업의 구조가 보인다. 삼양식품은 "불닭 하나로 해외를 뚫고 OPM 22%를 만든 회사"다. 농심은 "1위지만 중국에서 마진을 깎여 5%에 갇힌 회사"다. 오뚜기는 "다품종으로 국내를 지키지만 해외로 나가지 못해 5%에 갇힌 회사"다.
...
2026년에 봐야 할 한 줄: **진라면의 해외 매출 성장률.** 이것이 오뚜기의 OPM 천장을 깰 수 있는 유일한 열쇠다. 불닭이 증명한 길은 열려있다. 진라면이 그 길을 걸을 수 있는가.
...
|:---|:---|:---|:---|
| 2025 매출 8,962억 | `c.select("IS",["매출액"])` 분기 합산 | ✅ 실측 | |
| 2017 매출 5,165억 | IS 분기 합산 | ✅ 실측 | |
| 2025 OPM 4.8% | 193/8962 × 100 | ✅ 계산 | |
| 2023 OPM 7.4% | IS 분기 합산 | ✅ 계산 | |
...
| 부채비율 65% | `c.analysis("financial","안정성")` leverageTrend | ✅ 실측 | |
| dCR-A | `c.credit("등급")` grade | ✅ 실측 | |
| OCF 428억 (2025) | `c.select("CF",...)` 분기 합산 | ✅ 실측 | |
| CAPEX 543억 (2025) | CF 분기 합산 | ✅ 실측 | |
| 대형마트 40.4% | `c.analysis("financial","수익구조")` segmentComposition | ✅ 실측 | |
| 삼양 OPM 22% | 삼양식품 블로그 #02 | ✅ 교차 | |
| 삼양 해외 77% | 삼양식품 블로그 #02 | ✅ 교차 | |
| 삼양 원가율 55% | 삼양식품 블로그 #02 | ✅ 교차 | |
| 농심 OPM 5.2% | 농심 블로그 #16 | ✅ 교차 | |
| 농심 해외 66% | 농심 블로그 #16 | ✅ 교차 | |
| 농심 원가율 76% | 농심 블로그 #16 | ✅ 교차 | |
| DOL -5.27 | `c.analysis("financial","비용구조")` operatingLeverage | ✅ 실측 | |
...
- [오뚜기 사업보고서 (2025년)](https://dart.fss.or.kr/dsaf001/main.do?rcpNo=20260401800165) — DART 원문
- [오뚜기 분기보고서 (2025년 3분기)](https://dart.fss.or.kr/dsaf001/main.do?rcpNo=20251114001410) — 연결 재무제표
- [오뚜기 감사보고서 (2025년)](https://dart.fss.or.kr/dsaf001/main.do?rcpNo=20260318800120) — 외부감사인 의견
- [오뚜기 IR](https://www.ottogi.co.kr/kr/ir) — 실적 발표 자료
- [오뚜기 전자공시 전체](https://dart.fss.or.kr/dsaf001/main.do?corpCode=00106488) — DART 공시 목록
...
|---|---:|---:|---:|---:|---:|
| 지분법자본변동 | — | 0.0 | 0.0 | -4 | 4 |
| 기초자본 | 20,539 | 19,134 | 17,970 | -2,208 | 405 |
| 현금흐름위험회피 | 0.0 | 0.0 | 0.0 | 4 | 3 |
| 연결범위변동 | — | — | 0.0 | -1,161 | — |
| 배당 | 18 | 0.0 | 307 | -266 | -2 |
| 기말자본 | 20,743 | 200 | 19,345 | -3,369 | 15,385 |
| FVOCI평가 | 0.0 | 0.0 | 1 | -6 | -4 |
| 해외사업환산 | 0.0 | 0.0 | 0.0 | 34 | 87 |
| 연결범위내거래 | — | — | 0.0 | — | -98 |
| 합병 | — | — | — | — | — |
| 당기순이익 | 0.0 | 1,367 | 0.0 | 40 | 6 |
| 기타 | — | — | — | — | — |
| 기타(연결대상범위의 변동 등) | — | 0.0 | — | — | — |
| 확정급여재측정 | 0.0 | -5 | 0.0 | 182 | 13 |
| 재평가잉여금 | — | — | — | — | — |
