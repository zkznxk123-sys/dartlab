...
이 글에서 반복된 패턴이 있다. [에스퓨얼셀](/blog/288620-sfuelcell)은 "인증 없는 적자"로 소멸 경로에 있고, [뉴스케일파워](/blog/SMR-nuscale-power)는 "인증 있는 적자"로 기다림의 경로에 있다. SK바이오사이언스는 그 중간이다 — 코로나라는 "인증"은 만료됐고, CDMO라는 새 "인증"은 아직 완성되지 않았다. 자본 2.04조가 이 전환기를 버텨줄 수 있는 시간은 약 3~4년이다.
