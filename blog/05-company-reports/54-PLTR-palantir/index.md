...
### 왜 주식으로 주는가 — 실리콘밸리의 문법

실리콘밸리 소프트웨어 기업은 전통적으로 직원 보상의 상당 부분을 주식(RSU, Stock Option)으로 지급한다. 이유는 세 가지다.

첫째, **현금 보존**. 성장 초기에 현금이 부족한 스타트업이 우수 인력을 유치하려면 주식을 줄 수밖에 없다. 팔란티어는 2003년 설립 후 17년간(2020년 상장 전까지) 비상장 기업이었다. 그 기간 동안 현금 대신 주식으로 인력을 확보했다.

둘째, **인센티브 정렬**. 직원이 주식을 가지면 회사 가치가 올라갈수록 본인 자산도 늘어난다. 특히 AI·소프트웨어 엔지니어 시장에서 구글·메타와 경쟁하려면 매력적인 주식 패키지가 필수다.

셋째, **세금 효율**. 미국 세법상 주식보상비용은 회사 입장에서 비용으로 인정돼 법인세를 줄여준다. 주식을 발행하면서 동시에 세금도 아끼는 구조다.
...
팔란티어의 정부 매출은 일반 B2B와 다르다. CIA가 팔란티어의 Gotham 플랫폼을 쓰다가 다른 소프트웨어로 바꾸는 것은 사실상 불가능하다. 기밀 데이터가 팔란티어 시스템에 통합되어 있고, 분석관들이 이 도구에 숙련되어 있기 때문이다. **전환 비용(switching cost)이 극단적으로 높다.** 이것이 매출총이익률 82%를 유지할 수 있는 근본 이유다 — 고객이 떠날 수 없으니 가격 인하 압박이 없다.

미 국방부의 Maven 프로젝트, 미 육군의 TITAN 시스템 등 대형 정부 계약은 5~10년 장기 계약이다. 한 번 계약하면 연장이 거의 자동이다. 이 구조는 매출의 안정성을 높이지만, 동시에 "정부 예산에 의존한다"는 리스크도 있다. 미국 국방 예산이 삭감되면 팔란티어의 정부 매출도 영향을 받는다.

[한화에어로스페이스](/blog/hanwha-aerospace)의 방산 수주잔고 37조원처럼, 팔란티어의 정부 계약도 수년치 매출이 미리 확보된 구조다. 차이는 한화에어로가 하드웨어(자주포·로켓)를 납품하고 팔란티어는 소프트웨어를 제공한다는 것이다. 소프트웨어는 납품 후에도 유지보수·업그레이드 매출이 반복적으로 들어온다 — 이것이 "구독형 매출"의 본질이다.
...
**2021년 자기자본 -$1.75B.** 부채가 자산보다 $1.75B 많았다. [쿠팡](/blog/coupang)이 2022년 자기자본 -$3.5B로 자본잠식이었던 것과 같은 패턴이다. 소프트웨어 기업이 상장 전 수년간 누적한 적자(결손금)가 자본을 마이너스로 만든 것이다.
...
**주식보상비용의 이중 효과를 정리하면:**
1. **손익계산서**: 비용으로 잡혀서 순이익을 깎는다 (부정적)
2. **현금흐름표**: 현금이 안 나가서 잉여현금흐름을 키운다 (긍정적)
3. **재무상태표**: 자본잉여금으로 쌓여서 자기자본을 키운다 (긍정적)
4. **주주 입장**: 지분이 희석된다 (부정적)

같은 항목이 4개 재무제표에서 각각 다른 방향으로 작용한다. 이것이 팔란티어의 재무제표가 "아름다우면서도 의심스러운" 이유다.

[쿠팡](/blog/coupang)도 비슷한 패턴을 겪었다. 쿠팡은 2022년 자기자본 -$3.5B에서 2023년 +$4.1B로 $7.6B 반전을 경험했다. 쿠팡의 경우 이연법인세자산(DTA) 인식이 핵심이었고, 팔란티어는 주식보상비용의 자본 유입이 핵심이다. 두 경우 모두 "실제로 현금이 $7~9B 들어온 것이 아니라, 회계적 인식이 바뀐 것"이라는 공통점이 있다. **숫자가 바뀐 게 아니라, 숫자를 보는 방식이 바뀌었다.**

다만 결정적 차이가 있다. 쿠팡의 DTA는 "미래에 세금을 덜 낼 수 있는 권리"라서 실제 현금 유입이 없다. 팔란티어의 주식보상비용에 의한 자본 증가는 **실제로 직원에게 주식을 발행한 결과**다 — 회사 입장에서 "자본을 받았다"고 볼 수 있지만, 기존 주주 입장에서는 "내 지분이 희석됐다"는 뜻이다.
...
### 매출 성장률과 영업이익률의 상관관계 — 소프트웨어 레버리지

팔란티어의 사례는 소프트웨어 기업의 **고정비 레버리지**를 극단적으로 보여준다. 매출이 $1.54B에서 $4.48B로 2.9배 늘었을 때, 영업비용(매출원가+판관비)은 $1.95B에서 $3.06B로 1.6배만 늘었다. **매출 증분 $2.93B 중 $1.83B(62%)가 영업이익으로 떨어졌다.** 한계이익률 62%.

이것이 소프트웨어 사업의 본질이다. 코드를 한 번 만들면 고객이 100명이든 10,000명이든 추가 원가가 거의 없다. [네이버](/blog/naver)의 검색 광고(별도 영업이익률 75.7%)와 같은 원리다. 팔란티어의 매출이 계속 성장하면 영업이익률은 40%, 50%까지 올라갈 수 있다 — 주식보상비용이 매출 대비 비율로 줄어든다는 전제하에.

반대로 매출이 정체되면 판관비가 고정비로 작용하면서 영업이익률이 급락한다. [오뚜기](/blog/ottogi)가 매출 1.7배 늘었는데 영업이익은 줄어든 "역레버리지"처럼, 소프트웨어도 매출 성장이 멈추면 고정비가 마진을 삼킨다. **팔란티어의 영업이익률 31.6%는 매출 성장이 지속된다는 전제에서만 유지된다.**
...
### 알렉스 카프와 피터 틸 — 22년의 고집

팔란티어의 CEO 알렉스 카프는 독특한 인물이다. 스탠퍼드 법대 졸업, 독일 프랑크푸르트에서 박사 학위(신칸트주의 철학). 드레드록 머리, 태극권 수련자. 실리콘밸리 CEO의 전형과 거리가 멀다. 그가 22년간 팔란티어를 이끌면서 한 가지를 고집했다 — **"아무도 안 만드는 걸 만들어라."**

CIA를 위한 스파이 소프트웨어, 미 육군을 위한 전장 분석 도구, 제약사를 위한 임상 데이터 플랫폼 — 팔란티어가 만든 것들은 시장에 경쟁자가 거의 없는 제품이었다. 이것이 매출총이익률 82%를 가능하게 한 근본 원인이다. 대체재가 없으면 가격 결정력이 생기고, 가격 결정력이 있으면 마진이 높다.

피터 틸(이사회 의장)은 PayPal 마피아의 수장이자 《제로 투 원》의 저자다. 그의 철학 — "경쟁하지 마라, 독점하라" — 이 팔란티어의 DNA에 새겨져 있다. 틸이 2003년 팔란티어를 공동 창업한 계기는 PayPal에서의 경험이었다. PayPal에서 사기 거래를 탐지하던 패턴 인식 알고리즘을 "정보기관에 팔면 어떨까"라는 아이디어가 출발점이었다. 시장 규모 따위는 계산하지 않았다. 고객이 CIA 한 곳이면 충분했다.

### beta -0.167 — 시장과 무관한 주가

dartlab quant 분석에서 팔란티어의 beta는 **-0.167**이다. 일반적으로 기술주는 beta가 1.0 이상(시장보다 변동성 큼)인데, 팔란티어는 마이너스다. S&P 500이 오를 때 팔란티어가 내리고, 내릴 때 오르는 경향이 있다는 뜻이다. 하지만 R²(설명력)가 0.02로 극히 낮아서 "시장과 상관관계가 거의 없다"는 해석이 정확하다.

팔란티어의 주가는 시장이 아니라 **자체 내러티브(AI, 정부 계약, AIP 성장 등)**로 움직인다. 이것은 투자자 입장에서 양날의 검이다 — 시장 하락에 방어되지만, 내러티브가 꺾이면 시장과 무관하게 독자적으로 급락한다.

### 과거 패턴 — "적자→흑자"는 처음이 아니다

소프트웨어 기업의 "적자→흑자" 전환은 산업 패턴이다. 아마존은 1994~2001년 7년 적자 후 흑자 전환했다. 세일즈포스는 2004~2016년 간헐적 적자 후 안정적 흑자에 도달했다. 팔란티어는 2003~2022년 **19년 적자** 후 2023년에 흑자 전환했다 — 실리콘밸리에서도 긴 편이다.

차이는 팔란티어가 적자 기간에도 **잉여현금흐름이 플러스였다**는 것이다. 주식보상비용이라는 비현금 비용이 적자를 만들었을 뿐, 현금 기준으로는 사실상 흑자였다. 아마존이 적자 기간에 진짜 현금을 태운 것과 다르다.

### PSR 55배 — 밸류에이션의 의미

팔란티어의 시가총액은 $250B 이상이다. 2025년 매출 $4.48B로 나누면 PSR(주가매출비율) 약 55배. 일반적인 소프트웨어 기업의 PSR이 10~20배인 것과 비교하면 3~5배 비싸다.

시장이 PSR 55배를 부여하는 근거는 "AI 시대에 팔란티어가 차지할 시장 규모"에 대한 기대다. 현재 매출 $4.48B가 5년 뒤 $15B, 10년 뒤 $30B가 되면 PSR 55배는 사후적으로 정당화된다. 하지만 그렇게 되지 않으면 주가가 현재 수준을 유지할 수 없다.

비교: [엔비디아](/blog/nvidia)는 매출 $131B에 시총 약 $3T로 PSR 약 23배. 팔란티어보다 "싸다". 엔비디아는 실제로 $131B를 팔고 있고 팔란티어는 $4.48B를 팔고 있다. **팔란티어의 PSR 55배는 "지금의 숫자"가 아니라 "미래의 이야기"에 대한 가격이다.** 이 이야기가 현실이 되면 보상이 크고, 안 되면 위험도 크다.
