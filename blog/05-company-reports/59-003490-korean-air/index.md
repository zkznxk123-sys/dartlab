...
한 업종 내에서 대형사 하나가 합병으로 지위를 굳히면, 남은 플레이어들이 **틈새 세분시장**으로 확장하는 패턴은 다른 업종에서도 반복된다. 시장 지배력의 집중은 반드시 주변부에 새로운 기회를 만든다. 조선 업종에서 [한화오션 (042660)](/blog/hanwha-ocean)이 대우조선해양을 인수한 뒤 중견 조선사 [대한조선 (439260)](/blog/daehan-shipbuilding)이 수에즈막스 올인으로 영업이익률 24%를 찍은 패턴과 구조가 같다.
