...
이는 [실리콘투 (#72)](/blog/silicon2)의 정반대 구조. 실리콘투는 재고 +1,542억이 순이익을 흡수해 OCF가 붕괴했고, 씨에스윈드는 재고 -1,555억이 순이익 감소를 상쇄해 OCF가 폭증했다. **같은 변수가 방향을 바꾸면 현금흐름이 10배 차이로 벌어진다**.
...
| 지표 (2025) | **씨에스윈드** | **LG엔솔** [#69](/blog/lg-energy-solution) | **삼성SDI** [#68](/blog/samsung-sdi) | **두산퓨얼셀** [#70](/blog/doosan-fuel-cell) |
| :--- | ---: | ---: | ---: | ---: |
...
이 궤적은 **"풍력 1위 지위 확보 → 인수 → 재무 충격 → 수익성 회복"**의 5년 압축이다. 비슷한 패턴을 [현대로템 (#42)](/blog/hyundai-rotem)에서 봤다 — 저가 수주 회복 + 원가 안정화 + 단계적 수익성 회복.
...
이 글이 포착한 건 **"글로벌 풍력 타워 1위가 대형 M&A 이후 재무 충격을 가장 깊게 받는 해"**다. [LG에너지솔루션 (#69)](/blog/lg-energy-solution)·[삼성SDI (#68)](/blog/samsung-sdi)의 배터리 CAPEX 사이클, [두산퓨얼셀 (#70)](/blog/doosan-fuel-cell)의 수소발전 원가 역전과 나란히 놓으면, **에너지 전환 업종 전반이 "수주는 있는데 이익이 아직"인 구간**에 있다는 공통점이 보인다. 씨에스윈드는 이 구간을 **현금흐름 5,277억으로 방어하면서 통과**하는 중.
...
| **LG엔솔·삼성SDI·두산퓨얼셀 비교 수치** | 블로그 [#69](/blog/lg-energy-solution)·[#68](/blog/samsung-sdi)·[#70](/blog/doosan-fuel-cell) 검증표 | 🔗 블로그 내부 인용 |
...
|---|---:|---:|---:|---:|---:|
| 회계정책변경 | — | 0.0 | — | — | — |
| 지분법자본변동 | 0.8 | 0.0 | -6 | -2 | 6 |
| 기초자본 | 12,003 | 9,439 | 481 | 9,438 | 4,131 |
| 유상증자 | — | 0.0 | -2 | 1 | 4,607 |
| 현금흐름위험회피 | 5 | 0.0 | -14 | — | — |
| 연결범위변동 | — | 0.0 | 2 | -0.7 | -631 |
| 전환사채 | — | 0.7 | — | -2 | — |
| 배당 | 414 | 207 | 207 | 253 | 173 |
| 기말자본 | 486 | 6,130 | 658 | 9,247 | 211 |
| 자본변동합계 | -534 | — | 168 | -15 | 222 |
| 전기오류수정 | — | — | — | -12 | — |
| FVOCI평가 | 0.0 | 2 | -2 | — | — |
| 해외사업환산 | 0.0 | 0.0 | 127 | 283 | 429 |
| 연결범위내거래 | — | 0.0 | — | 117 | — |
| 비지배지분변동 | -55 | 0.0 | 7 | — | — |
