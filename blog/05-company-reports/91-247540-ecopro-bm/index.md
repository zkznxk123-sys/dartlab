...
date: 2026-05-07
description: "2020 매출 8,547 억이던 양극재 회사가 3 년 만에 6 조 9 천억으로 폭발했고, 그 다음 1 년 만에 2 조 7 천억으로 추락한 같은 해에 CAPEX 1 조를 박았다. 차입 1.77 조, Altman Z 0.88, 이자보상 1.0 배."
...
youtubeId: ""
ai:
  verdict: "2020 매출 8,547 억이던 양극재 회사가 3 년 만에 6 조 9 천억 (+708%) 으로 폭발했고, 그 다음 1 년 만에 2 조 7 천억 (-60%) 으로 추락한 같은 해에 CAPEX 1 조 (매출의 37%) 를 박았다. 차입 1.77 조와 부실 4 신호 (Altman Z 0.88) 가 동시에 점등한 시점에 새 캐파를 깔고 있었다. 삼성SDI 단일 고객 64% 양극재 1 위가 2025 흑자전환 (+1,428 억) 한 동력은 ESS +103% 와 인도네시아 지분법이익 418 억 일회성."
  direction: 회복중
  confidence: 보통
  archetype: 자본집약사이클러
  strengths:
...
> **dartlab AI 종합의견**
>
> 2020 매출 8,547 억이던 양극재 회사가 3 년 만에 6 조 9 천억 (+708%) 으로 폭발했고, 그 다음 1 년 만에 2 조 7 천억 (-60%) 으로 추락한 같은 해에 CAPEX 1 조 (매출의 37%) 를 박았다. 차입 1.77 조와 부실 4 신호가 동시에 점등한 시점에 새 캐파를 깔고 있었다. 삼성SDI 단일 고객 64% 양극재 1 위가 2025 년 흑자전환한 동력은 ESS +103% 와 인도네시아 지분법이익 418 억 일회성.
...
차입금이 1.77 조까지 올라온 자리는 2022 년 4 분기의 691 억에서 2.60 배 뛴 결과다. CAPEX 1 조의 절반은 운전자본을 조이지 않고 외부 차입으로 메워졌다. 매출이 빠지는 해에 차입이 두 배 넘게 올라간 회사의 이자보상배율은 1.0 배까지 내려왔다. 영업이익으로 이자만 겨우 갚는 자리.
...
- 운전자본 압박: 1.13 조의 재고는 1.13 조의 현금이 묶여 있다는 뜻이기도 하다. 자산총계의 23.5% 가 출하되지 못한 메탈로 잠겨 있는 회사는, 같은 분기 대규모 CAPEX 를 박을 때 자기 현금이 아니라 차입으로 박아야 한다 — 1 막에서 본 차입 1.77 조의 출발점이다.
...
2023 년의 그림은 그래서 단순히 마진 추락의 한 해가 아니다. 매출은 사상 최대 (+29%) 를, 영업이익은 사상 최악에 가까운 추락 (-59%) 을, 재고는 자산총계의 23.5% PEAK 를, 모회사는 대표 법정구속을 — 같은 12 개월 안에 동시에 통과한 해였다. 1 막에서 본 부실 4 신호 + 차입 1.77 조 + CAPEX 1 조의 모든 재료가 이 분기에 깔렸다.
...
**2023Q4 매출 1 조 1,800 억 + 영업손실 -1,147 억 + 재고평가손실 1,245 억.** 합산 -2,364 억은 매출의 -20.0%. 이 한 분기가 2023 회계연도 영업이익 (1,549 억) 을 어디서 까먹었는지 단독으로 설명한다.
...
## 6 막 — 부실 4 신호 + 차입 1.77 조 + CAPEX 1 조, 한 BS 안에서 동시에 점등
...
- 차입금 1.77 조 + 부실 4 신호는 그 모순의 회계 기록이다.
...
2 년 시간이 같은 BS 위에 동시에 있다 — 슈퍼사이클의 잔고 (재고 PEAK 1.13 조 / 차입 1.77 조 / CAPEX 1 조) 와 회복 사이클의 시작 (ESS +103% / 인도네시아 418 억 / OPM 5.66%). 사이클 한 바퀴를 한 회사 BS 가 통째로 흡수했다.
...
c.show("IS")   # 32 항목, 36 분기 (2017Q1~2025Q4)
c.show("BS")   # 자산·부채·자본
c.show("CF")   # CAPEX 시계열
```
...
`c.sections` 는 분기별 사업보고서·분기보고서 본문이 chapter 단위로 stack 된 DataFrame 이다. 2 막의 2016 분할 인용, 3 막의 단가 효과 메커니즘, 7 막의 글로벌 거점 (헝가리·미국·캐나다) 은 모두 위 한 줄로 재현된다.
