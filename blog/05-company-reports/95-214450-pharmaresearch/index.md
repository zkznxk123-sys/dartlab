...
이 정직한 선 긋기가 오히려 글의 힘을 키운다. 왜냐하면 파마리서치의 이야기는 "밑바닥에서 기적처럼 치솟았다"가 아니기 때문이다. 정확한 이야기는 "제품 회사로 본격 가동한 뒤 6년 동안 매출을 5배 가까이 키우면서도 30~40%대 영업이익률을 지켰다"다. 이 버전이 덜 극적이지만 더 강하다. 검증 가능한 숫자만 남기기 때문이다.
