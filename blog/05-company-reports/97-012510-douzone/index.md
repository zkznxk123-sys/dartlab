...
상장폐지 이후 더존을 보는 가장 정직한 방법은 "뉴스의 크기"가 아니라 "업무 배관의 마찰"을 보는 것이다. 가격표가 바뀌었는데 고객이 조용한가, 구독 전환이 빨라졌는데 세무사 생태계가 흔들리지 않는가, AI 기능이 붙었는데 실제 결산 시간이 줄었는가. 이 작은 운영 질문들이 더존의 진짜 해자를 보여준다.
