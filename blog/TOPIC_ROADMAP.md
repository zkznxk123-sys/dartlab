...
76 편 + 신용분석 보고서, 6 카테고리. 2026-04-23 갱신.
...
회사 종합편:
- 롯데케미칼 (011170) — 중국 화학 사이클 다운 회복 추적, 효성화학(#56) NCC 비교 대조편
- SK온 단독 (SK이노베이션 #미발간 배터리 자회사) — 적자 지속 분리 편성
...
**이차전지 클러스터** (신규)
- 🏛 Pillar: 에코프로 (#26)
- Existing: **삼성SDI (#68, EV 캐즘 사이클 정점-적자 3.3조 반전)**, **LG에너지솔루션 (#69, 매출 -30%인데 OPM +3.4%p V자 · 순이익 800억 · 삼성SDI 18.67%p 갭 대조편)**
- Supporting 후보: SK온, 에코프로BM, 포스코퓨처엠
