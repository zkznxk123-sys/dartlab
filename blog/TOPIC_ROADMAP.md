...
- 오리온 해외 비교편 — 라면 빅3(#02·#16·#49) 대비 제과 수출 비중 구조
...
**식품/소비재 클러스터**
- 🏛 Pillar: 삼양식품 (#02)
- Existing: 에이피알 (#10, 같은 고정비 레버리지), 달바글로벌 (#12, K-뷰티 자체 브랜드), **농심 (#16, 1위의 저주 vs 삼양 비교)**, **오뚜기 (#49, 라면 빅3 완성 — 내수 OPM 천장 5%)**, **실리콘투 (#72, K-뷰티 유통 플랫폼 — 달바 대조편)**
