---
title: Company.ask capability view
skillId: capability:Company.ask
category: capability
---

# Company.ask capability view

공개 capability `Company.ask`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.ask`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
...
- LLM에게 이 기업에 대해 질문.
- "영업이익률 분석해줘" → c.ask("영업이익률 추세는?") "AI한테 질문하고 싶어" → c.ask("질문") "스트리밍으로 답변받기" → c.ask("질문", stream=True)
