---
title: Company.audit capability view
skillId: capability:Company.audit
category: capability
---

# Company.audit capability view

공개 capability `Company.audit`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.audit`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
...
- 감사 리스크 종합 분석.
- "감사의견 확인" → c.audit() "감사인 바뀌었어?" → c.audit()["auditorChanges"] "계속기업 의문은?" → c.audit()["goingConcern"]
