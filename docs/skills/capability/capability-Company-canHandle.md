---
title: Company.canHandle capability view
skillId: capability:Company.canHandle
category: capability
---

# Company.canHandle capability view

공개 capability `Company.canHandle`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.canHandle`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
