---
title: Company.codeName capability view
skillId: capability:Company.codeName
category: capability
---

# Company.codeName capability view

공개 capability `Company.codeName`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.codeName`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
