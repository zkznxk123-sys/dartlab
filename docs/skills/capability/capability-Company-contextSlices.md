---
title: Company.contextSlices capability view
skillId: capability:Company.contextSlices
category: capability
---

# Company.contextSlices capability view

공개 capability `Company.contextSlices`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.contextSlices`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
...
- "LLM에 들어가는 컨텍스트" → c.contextSlices "AI가 보는 데이터" → c.contextSlices
