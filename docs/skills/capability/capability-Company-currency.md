---
title: Company.currency capability view
skillId: capability:Company.currency
category: capability
---

# Company.currency capability view

공개 capability `Company.currency`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.currency`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
