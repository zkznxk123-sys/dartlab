---
title: Company.facts capability view
skillId: capability:Company.facts
category: capability
---

# Company.facts capability view

공개 capability `Company.facts`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.facts`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
