---
title: Company.fiscalYearEnd capability view
skillId: capability:Company.fiscalYearEnd
category: capability
---

# Company.fiscalYearEnd capability view

공개 capability `Company.fiscalYearEnd`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.fiscalYearEnd`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
