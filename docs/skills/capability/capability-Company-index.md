---
title: Company.index capability view
skillId: capability:Company.index
category: capability
---

# Company.index capability view

공개 capability `Company.index`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.index`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
...
- "전체 목차 보여줘" → c.index "어떤 데이터가 있는지 구조적으로" → c.index
