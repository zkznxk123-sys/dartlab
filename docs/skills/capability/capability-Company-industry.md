---
title: Company.industry capability view
skillId: capability:Company.industry
category: capability
---

# Company.industry capability view

공개 capability `Company.industry`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.industry`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
