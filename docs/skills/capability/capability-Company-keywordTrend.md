---
title: Company.keywordTrend capability view
skillId: capability:Company.keywordTrend
category: capability
---

# Company.keywordTrend capability view

공개 capability `Company.keywordTrend`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.keywordTrend`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
...
- "AI 언급 추이" → c.keywordTrend("AI") "ESG 관련 변화" → c.keywordTrend("ESG") "전체 키워드 트렌드" → c.keywordTrend()
