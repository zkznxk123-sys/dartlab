---
title: Company.listing capability view
skillId: capability:Company.listing
category: capability
---

# Company.listing capability view

공개 capability `Company.listing`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.listing`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
