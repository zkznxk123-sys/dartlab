---
title: Company.liveFilings capability view
skillId: capability:Company.liveFilings
category: capability
---

# Company.liveFilings capability view

공개 capability `Company.liveFilings`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.liveFilings`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
...
- "최근 공시 확인해줘" → c.liveFilings() "이번 주 공시 있어?" → c.liveFilings(days=7) "배당 관련 공시" → c.liveFilings(keyword="배당")
