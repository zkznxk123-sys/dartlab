---
title: Company.narrativeDiff capability view
skillId: capability:Company.narrativeDiff
category: capability
---

# Company.narrativeDiff capability view

공개 capability `Company.narrativeDiff`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.narrativeDiff`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
...
- "가치 기여도" → c.narrativeDiff() "낮은WACC 기여 몇%" → 결과 필터 claim='낮은WACC'
