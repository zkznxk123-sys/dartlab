---
title: Company.priority capability view
skillId: capability:Company.priority
category: capability
---

# Company.priority capability view

공개 capability `Company.priority`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.priority`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
