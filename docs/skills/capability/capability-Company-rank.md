---
title: Company.rank capability view
skillId: capability:Company.rank
category: capability
---

# Company.rank capability view

공개 capability `Company.rank`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.rank`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
...
- "이 회사 순위는?" → c.rank "시장에서 몇 등이야?" → c.rank.revenueRank "대형주야?" → c.rank.sizeClass
