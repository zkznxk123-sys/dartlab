---
title: Company.rawDocs capability view
skillId: capability:Company.rawDocs
category: capability
---

# Company.rawDocs capability view

공개 capability `Company.rawDocs`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.rawDocs`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
...
- "원본 공시 데이터 보여줘" → c.rawDocs "가공 전 데이터 확인" → c.rawDocs
