---
title: Company.rawFinance capability view
skillId: capability:Company.rawFinance
category: capability
---

# Company.rawFinance capability view

공개 capability `Company.rawFinance`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.rawFinance`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
...
- "원본 재무 데이터 보여줘" → c.rawFinance "XBRL 원본 확인" → c.rawFinance
