---
title: Company.rawReport capability view
skillId: capability:Company.rawReport
category: capability
---

# Company.rawReport capability view

공개 capability `Company.rawReport`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.rawReport`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
...
- "원본 보고서 데이터 보여줘" → c.rawReport "정기보고서 원본 확인" → c.rawReport
