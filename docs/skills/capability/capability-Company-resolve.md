---
title: Company.resolve capability view
skillId: capability:Company.resolve
category: capability
---

# Company.resolve capability view

공개 capability `Company.resolve`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.resolve`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
