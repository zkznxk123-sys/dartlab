---
title: Company.retrievalBlocks capability view
skillId: capability:Company.retrievalBlocks
category: capability
---

# Company.retrievalBlocks capability view

공개 capability `Company.retrievalBlocks`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.retrievalBlocks`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
...
- "원문 검색용 블록" → c.retrievalBlocks "RAG용 데이터" → c.retrievalBlocks
