---
title: Company.search capability view
skillId: capability:Company.search
category: capability
---

# Company.search capability view

공개 capability `Company.search`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.search`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
