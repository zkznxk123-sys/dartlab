---
title: Company.sections capability view
skillId: capability:Company.sections
category: capability
---

# Company.sections capability view

공개 capability `Company.sections`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.sections`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
...
- "이 회사 전체 데이터 지도" → c.sections "어떤 topic이 있어?" → c.topics (경량)
