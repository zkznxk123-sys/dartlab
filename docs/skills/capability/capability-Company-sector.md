---
title: Company.sector capability view
skillId: capability:Company.sector
category: capability
---

# Company.sector capability view

공개 capability `Company.sector`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.sector`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
...
- "이 회사 어떤 섹터야?" → c.sector "업종 분류" → c.sector
