---
title: Company.sectorParams capability view
skillId: capability:Company.sectorParams
category: capability
---

# Company.sectorParams capability view

공개 capability `Company.sectorParams`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.sectorParams`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
...
- "이 섹터 할인율은?" → c.sectorParams.discountRate "PER 멀티플" → c.sectorParams.perMultiple
