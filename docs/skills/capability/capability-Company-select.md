---
title: Company.select capability view
skillId: capability:Company.select
category: capability
---

# Company.select capability view

공개 capability `Company.select`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.select`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
