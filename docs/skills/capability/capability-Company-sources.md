---
title: Company.sources capability view
skillId: capability:Company.sources
category: capability
---

# Company.sources capability view

공개 capability `Company.sources`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.sources`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
...
- "데이터 뭐가 있어?" → c.sources "docs/finance/report 상태" → c.sources
