---
title: Company.status capability view
skillId: capability:Company.status
category: capability
---

# Company.status capability view

공개 capability `Company.status`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.status`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
