---
title: Company.storyTree capability view
skillId: capability:Company.storyTree
category: capability
---

# Company.storyTree capability view

공개 capability `Company.storyTree`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.storyTree`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
...
- "3 시나리오 가치" → c.storyTree() "서사 민감도" → c.storyTree()['summary']['spreadPct']
