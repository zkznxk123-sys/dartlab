---
title: Company.topicSummaries capability view
skillId: capability:Company.topicSummaries
category: capability
---

# Company.topicSummaries capability view

공개 capability `Company.topicSummaries`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.topicSummaries`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
