---
title: Company.topics capability view
skillId: capability:Company.topics
category: capability
---

# Company.topics capability view

공개 capability `Company.topics`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.topics`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
...
- "어떤 데이터가 있어?" → c.topics "topic 목록" → c.topics
