---
title: Company.update capability view
skillId: capability:Company.update
category: capability
---

# Company.update capability view

공개 capability `Company.update`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.update`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
...
- 누락된 최신 공시를 증분 수집.
- "최신 공시 반영해줘" → c.update() "데이터 업데이트" → c.update()로 증분 수집
