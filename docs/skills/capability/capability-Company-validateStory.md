---
title: Company.validateStory capability view
skillId: capability:Company.validateStory
category: capability
---

# Company.validateStory capability view

공개 capability `Company.validateStory`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.validateStory`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
