---
title: Company.valuationImpact capability view
skillId: capability:Company.valuationImpact
category: capability
---

# Company.valuationImpact capability view

공개 capability `Company.valuationImpact`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:Company.valuationImpact`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
...
- "WACC 조정 어떻게" → c.valuationImpact()['waccAdj'] "override 근거" → c.valuationImpact()['narrative']
