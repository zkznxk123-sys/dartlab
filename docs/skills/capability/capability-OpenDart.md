---
title: OpenDart capability view
skillId: capability:OpenDart
category: capability
---

# OpenDart capability view

공개 capability `OpenDart`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:OpenDart`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
