---
title: OpenEdgar capability view
skillId: capability:OpenEdgar
category: capability
---

# OpenEdgar capability view

공개 capability `OpenEdgar`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:OpenEdgar`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
