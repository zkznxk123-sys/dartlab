---
title: SelectResult capability view
skillId: capability:SelectResult
category: capability
---

# SelectResult capability view

공개 capability `SelectResult`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:SelectResult`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
