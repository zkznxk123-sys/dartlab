---
title: aiContract.capabilities.valid_key capability view
skillId: capability:aiContract.capabilities.valid_key
category: capability
---

# aiContract.capabilities.valid_key capability view

공개 capability `aiContract.capabilities.valid_key`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:aiContract.capabilities.valid_key`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
