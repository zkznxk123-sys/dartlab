---
title: aiContract.cashflow.primary capability view
skillId: capability:aiContract.cashflow.primary
category: capability
---

# aiContract.cashflow.primary capability view

공개 capability `aiContract.cashflow.primary`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:aiContract.cashflow.primary`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
