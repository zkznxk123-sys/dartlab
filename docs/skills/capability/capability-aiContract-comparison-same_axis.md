---
title: aiContract.comparison.same_axis capability view
skillId: capability:aiContract.comparison.same_axis
category: capability
---

# aiContract.comparison.same_axis capability view

공개 capability `aiContract.comparison.same_axis`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:aiContract.comparison.same_axis`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
