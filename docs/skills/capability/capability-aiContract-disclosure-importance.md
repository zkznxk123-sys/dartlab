---
title: aiContract.disclosure.importance capability view
skillId: capability:aiContract.disclosure.importance
category: capability
---

# aiContract.disclosure.importance capability view

공개 capability `aiContract.disclosure.importance`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:aiContract.disclosure.importance`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
