---
title: codeToName capability view
skillId: capability:codeToName
category: capability
---

# codeToName capability view

공개 capability `codeToName`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:codeToName`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
