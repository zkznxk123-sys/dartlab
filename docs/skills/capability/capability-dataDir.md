---
title: dataDir capability view
skillId: capability:dataDir
category: capability
---

# dataDir capability view

공개 capability `dataDir`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:dataDir`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
