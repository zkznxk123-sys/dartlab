---
title: downloadAll capability view
skillId: capability:downloadAll
category: capability
---

# downloadAll capability view

공개 capability `downloadAll`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:downloadAll`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
...
- "데이터 어떻게 받아?" -> downloadAll("finance") 안내. API 키 불필요 "scan 쓰려면?" -> downloadAll("finance") + downloadAll("report") 필요 finance 먼저 (600MB), report 다음 (320MB), docs는 대용량 주의 (8GB)
