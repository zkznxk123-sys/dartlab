---
title: gather.flow capability view
skillId: capability:gather.flow
category: capability
---

# gather.flow capability view

공개 capability `gather.flow`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:gather.flow`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
