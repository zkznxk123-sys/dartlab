---
title: gather.insider capability view
skillId: capability:gather.insider
category: capability
---

# gather.insider capability view

공개 capability `gather.insider`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:gather.insider`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
