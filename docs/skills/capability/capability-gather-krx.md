---
title: gather.krx capability view
skillId: capability:gather.krx
category: capability
---

# gather.krx capability view

공개 capability `gather.krx`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:gather.krx`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
