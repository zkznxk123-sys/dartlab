---
title: gather.krxIndex capability view
skillId: capability:gather.krxIndex
category: capability
---

# gather.krxIndex capability view

공개 capability `gather.krxIndex`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:gather.krxIndex`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
