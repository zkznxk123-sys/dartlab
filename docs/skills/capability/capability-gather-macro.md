---
title: gather.macro capability view
skillId: capability:gather.macro
category: capability
---

# gather.macro capability view

공개 capability `gather.macro`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:gather.macro`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
