---
title: gather.news capability view
skillId: capability:gather.news
category: capability
---

# gather.news capability view

공개 capability `gather.news`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:gather.news`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
