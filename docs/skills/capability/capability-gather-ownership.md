---
title: gather.ownership capability view
skillId: capability:gather.ownership
category: capability
---

# gather.ownership capability view

공개 capability `gather.ownership`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:gather.ownership`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
