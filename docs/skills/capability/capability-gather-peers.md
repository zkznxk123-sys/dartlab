---
title: gather.peers capability view
skillId: capability:gather.peers
category: capability
---

# gather.peers capability view

공개 capability `gather.peers`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:gather.peers`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
