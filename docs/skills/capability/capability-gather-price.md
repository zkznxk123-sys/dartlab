---
title: gather.price capability view
skillId: capability:gather.price
category: capability
---

# gather.price capability view

공개 capability `gather.price`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:gather.price`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
