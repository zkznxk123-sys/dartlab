---
title: gather.sector capability view
skillId: capability:gather.sector
category: capability
---

# gather.sector capability view

공개 capability `gather.sector`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:gather.sector`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
