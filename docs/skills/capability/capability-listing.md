---
title: listing capability view
skillId: capability:listing
category: capability
---

# listing capability view

공개 capability `listing`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:listing`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
