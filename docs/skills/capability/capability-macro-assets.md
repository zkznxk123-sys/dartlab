---
title: macro.assets capability view
skillId: capability:macro.assets
category: capability
---

# macro.assets capability view

공개 capability `macro.assets`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:macro.assets`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
