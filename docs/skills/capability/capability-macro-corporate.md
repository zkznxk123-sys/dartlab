---
title: macro.corporate capability view
skillId: capability:macro.corporate
category: capability
---

# macro.corporate capability view

공개 capability `macro.corporate`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:macro.corporate`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
