---
title: macro.crisis capability view
skillId: capability:macro.crisis
category: capability
---

# macro.crisis capability view

공개 capability `macro.crisis`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:macro.crisis`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
