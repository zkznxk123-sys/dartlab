---
title: macro.cycle capability view
skillId: capability:macro.cycle
category: capability
---

# macro.cycle capability view

공개 capability `macro.cycle`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:macro.cycle`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
