---
title: macro.forecast capability view
skillId: capability:macro.forecast
category: capability
---

# macro.forecast capability view

공개 capability `macro.forecast`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:macro.forecast`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
