---
title: macro.inventory capability view
skillId: capability:macro.inventory
category: capability
---

# macro.inventory capability view

공개 capability `macro.inventory`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:macro.inventory`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
