---
title: macro.liquidity capability view
skillId: capability:macro.liquidity
category: capability
---

# macro.liquidity capability view

공개 capability `macro.liquidity`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:macro.liquidity`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
