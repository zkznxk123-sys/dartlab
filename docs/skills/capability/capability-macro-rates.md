---
title: macro.rates capability view
skillId: capability:macro.rates
category: capability
---

# macro.rates capability view

공개 capability `macro.rates`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:macro.rates`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
