---
title: macro.scenario capability view
skillId: capability:macro.scenario
category: capability
---

# macro.scenario capability view

공개 capability `macro.scenario`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:macro.scenario`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
