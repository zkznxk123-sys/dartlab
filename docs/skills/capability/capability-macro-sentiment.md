---
title: macro.sentiment capability view
skillId: capability:macro.sentiment
category: capability
---

# macro.sentiment capability view

공개 capability `macro.sentiment`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:macro.sentiment`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
