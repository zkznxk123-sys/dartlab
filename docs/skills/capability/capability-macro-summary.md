---
title: macro.summary capability view
skillId: capability:macro.summary
category: capability
---

# macro.summary capability view

공개 capability `macro.summary`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:macro.summary`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
