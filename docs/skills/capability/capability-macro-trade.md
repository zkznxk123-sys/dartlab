---
title: macro.trade capability view
skillId: capability:macro.trade
category: capability
---

# macro.trade capability view

공개 capability `macro.trade`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:macro.trade`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
