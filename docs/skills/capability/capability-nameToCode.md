---
title: nameToCode capability view
skillId: capability:nameToCode
category: capability
---

# nameToCode capability view

공개 capability `nameToCode`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:nameToCode`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
