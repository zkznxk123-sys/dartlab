---
title: pastInsight capability view
skillId: capability:pastInsight
category: capability
---

# pastInsight capability view

공개 capability `pastInsight`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:pastInsight`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
