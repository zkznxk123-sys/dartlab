---
title: scan.account capability view
skillId: capability:scan.account
category: capability
---

# scan.account capability view

공개 capability `scan.account`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:scan.account`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
