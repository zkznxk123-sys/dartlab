---
title: scan.audit capability view
skillId: capability:scan.audit
category: capability
---

# scan.audit capability view

공개 capability `scan.audit`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:scan.audit`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
