---
title: scan.capital capability view
skillId: capability:scan.capital
category: capability
---

# scan.capital capability view

공개 capability `scan.capital`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:scan.capital`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
