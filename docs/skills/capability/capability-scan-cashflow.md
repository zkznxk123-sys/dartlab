---
title: scan.cashflow capability view
skillId: capability:scan.cashflow
category: capability
---

# scan.cashflow capability view

공개 capability `scan.cashflow`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:scan.cashflow`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
