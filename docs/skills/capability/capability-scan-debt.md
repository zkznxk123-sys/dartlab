---
title: scan.debt capability view
skillId: capability:scan.debt
category: capability
---

# scan.debt capability view

공개 capability `scan.debt`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:scan.debt`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
