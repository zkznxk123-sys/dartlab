---
title: scan.disclosureRisk capability view
skillId: capability:scan.disclosureRisk
category: capability
---

# scan.disclosureRisk capability view

공개 capability `scan.disclosureRisk`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:scan.disclosureRisk`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
