---
title: scan.dividendTrend capability view
skillId: capability:scan.dividendTrend
category: capability
---

# scan.dividendTrend capability view

공개 capability `scan.dividendTrend`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:scan.dividendTrend`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
