---
title: scan.efficiency capability view
skillId: capability:scan.efficiency
category: capability
---

# scan.efficiency capability view

공개 capability `scan.efficiency`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:scan.efficiency`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
