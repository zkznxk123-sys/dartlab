---
title: scan.governance capability view
skillId: capability:scan.governance
category: capability
---

# scan.governance capability view

공개 capability `scan.governance`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:scan.governance`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
