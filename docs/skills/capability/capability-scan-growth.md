---
title: scan.growth capability view
skillId: capability:scan.growth
category: capability
---

# scan.growth capability view

공개 capability `scan.growth`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:scan.growth`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
