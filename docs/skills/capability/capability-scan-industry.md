---
title: scan.industry capability view
skillId: capability:scan.industry
category: capability
---

# scan.industry capability view

공개 capability `scan.industry`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:scan.industry`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
