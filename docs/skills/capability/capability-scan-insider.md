---
title: scan.insider capability view
skillId: capability:scan.insider
category: capability
---

# scan.insider capability view

공개 capability `scan.insider`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:scan.insider`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
