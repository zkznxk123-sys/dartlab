---
title: scan.liquidity capability view
skillId: capability:scan.liquidity
category: capability
---

# scan.liquidity capability view

공개 capability `scan.liquidity`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:scan.liquidity`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
