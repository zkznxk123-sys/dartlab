---
title: scan.macroBeta capability view
skillId: capability:scan.macroBeta
category: capability
---

# scan.macroBeta capability view

공개 capability `scan.macroBeta`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:scan.macroBeta`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
