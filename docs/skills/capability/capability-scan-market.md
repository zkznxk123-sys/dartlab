---
title: scan.market capability view
skillId: capability:scan.market
category: capability
---

# scan.market capability view

공개 capability `scan.market`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:scan.market`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
...
- 시장/업종/스크리닝 질문 scan primary evidence 계약
