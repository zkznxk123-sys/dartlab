---
title: scan.network capability view
skillId: capability:scan.network
category: capability
---

# scan.network capability view

공개 capability `scan.network`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:scan.network`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
