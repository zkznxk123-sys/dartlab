---
title: scan.profitability capability view
skillId: capability:scan.profitability
category: capability
---

# scan.profitability capability view

공개 capability `scan.profitability`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:scan.profitability`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
