---
title: scan.ratio capability view
skillId: capability:scan.ratio
category: capability
---

# scan.ratio capability view

공개 capability `scan.ratio`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:scan.ratio`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
