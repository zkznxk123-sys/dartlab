---
title: scan.screen capability view
skillId: capability:scan.screen
category: capability
---

# scan.screen capability view

공개 capability `scan.screen`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:scan.screen`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
