---
title: scan.valuation capability view
skillId: capability:scan.valuation
category: capability
---

# scan.valuation capability view

공개 capability `scan.valuation`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:scan.valuation`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
