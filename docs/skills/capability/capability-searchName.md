---
title: searchName capability view
skillId: capability:searchName
category: capability
---

# searchName capability view

공개 capability `searchName`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:searchName`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
