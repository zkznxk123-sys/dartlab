---
title: sectorInsights capability view
skillId: capability:sectorInsights
category: capability
---

# sectorInsights capability view

공개 capability `sectorInsights`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:sectorInsights`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
