---
title: topdown capability view
skillId: capability:topdown
category: capability
---

# topdown capability view

공개 capability `topdown`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:topdown`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
