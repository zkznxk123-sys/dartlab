---
title: verbose capability view
skillId: capability:verbose
category: capability
---

# verbose capability view

공개 capability `verbose`를 찾고 실행에 연결하기 위한 generated skill view.

## Metadata

- id: `capability:verbose`
- category: `capability`
- kind: `generated`
- status: `observed`
- Pyodide: `unknown`
