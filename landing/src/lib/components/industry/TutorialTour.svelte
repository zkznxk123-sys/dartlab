	...
	const STEPS: Step[] = [
		...
		},
		{
			...
			body: [
				...
				'**심층 탭**: 아코디언으로 지배구조, 인력, 현금흐름 패턴, 감사 리스크, 이익의 질, 유동성, 주주환원, 신용등급, 업종 내 위치 — scan 13축 데이터를 전부 여기서 볼 수 있습니다.',
				'각 아코디언을 펼치면 상세 지표가 나옵니다.'
			],
			why: 'scan 13축 + credit 7축 + macro 11축 데이터가 이 하나의 탭에 모두 연결됩니다.'
		},
		{
			title: '12 / 13  ·  블로그 + 공유',
			body: [
