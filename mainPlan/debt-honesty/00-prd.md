...
| W-PH8 | ui-packages 계약↔런타임 drift | 18 mandatory ports 중 **7개가 throw-stub/no-op**(39% 미실) + RuntimeDataEnvelope anti-stale 정직성 계약 0 adapter 사용 + 38/158 타입 외부소비 0 + createFakeRuntime 601 LOC dead + v2-tokens.css 유령(0 소비) | 정직성 계약 채택 or 제거 |
...
**총 28(1차) + 38(2차 §2.8) = 66 census finding → 4 phase. P0(9)·P1(8)·P2(10)·P3(7+옵션). MUST=P0+P1(가드 정직화+importlib AST 봉합, 독립 완결). SHOULD=P2(유령 제거 + 빌드-후-미배선 ~6-8K LOC). 위임=P3(god 분해 트랙).**
