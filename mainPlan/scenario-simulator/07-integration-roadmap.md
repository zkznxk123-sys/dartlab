...
> **★브리지 문서:** 컴포넌트 1~3(지수/레일/백테스팅)은 `../_done/terminal-chart-suite/`(01/02/03)로 분리됐다. 07은 그 suite와 시뮬 코어를 잇는 **유일한 cross-category 시퀀싱·공유 DNA·미래마커 이관** 문서다. 단방향: suite ⟶ 시뮬(역참조 0).
