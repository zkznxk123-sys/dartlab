...
```bash
uv run python -X utf8 scripts/audit/aiAudit.py               # 10개 전체
uv run python -X utf8 scripts/audit/aiAudit.py --quick       # 3개 (1,5,9)
...
**audit 후 사람이 직접 응답 읽고 판단.** 자동 메트릭만으로 품질 주장 금지.
