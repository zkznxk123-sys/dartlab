...
**현재**: 핵심 데이터 워크플로우 (DART/EDGAR/KRX 가격/KRX 지수/metadata/감사) · concurrency group 직렬화 · SEC 벌크 primary · 429 Retry-After 대응.
...
11:20       20:20     buildKrxIndexData.yml  KRX OpenAPI idx 시장군별 지수 T-1 incremental → HF (krx/indices)
...
| krxIndices | krx/indices | KRX/KOSPI/KOSDAQ 시장군별 지수 OHLCV+거래대금+시가총액 (raw long) | buildKrxIndexData (cron KST 20:20 평일 T-1 incremental) |
