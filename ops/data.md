...
11:00       20:00     buildKrxData.yml       KRX OpenAPI 일별 전종목 T-0 incremental → HF (krx/prices)
11:20       20:20     buildKrxIndexData.yml  KRX OpenAPI idx 시장군별 지수 T-0 incremental → HF (krx/indices)
...
| krxPrices | krx/prices | KRX 일별 전종목 OHLCV+시총+발행주식수 (raw long) | buildKrxData (cron KST 20:00 평일 T-0 incremental) |
| krxIndices | krx/indices | KRX/KOSPI/KOSDAQ 시장군별 지수 OHLCV+거래대금+시가총액 (raw long) | buildKrxIndexData (cron KST 20:20 평일 T-0 incremental) |
