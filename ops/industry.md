...
| 파일 | 내용 | 크기 |
|------|------|------|
| `ecosystem.json` | 2,664 노드 + 18,418 엣지 + 34 산업 메타 | ~4MB |
| `atlas.json` | 34개 산업 + 산업간 공급 플로우 Top 50 | ~50KB |
| `industries/{id}.json` | 산업별 공정 노드 + 내부 엣지 | 34파일 |
| `companies/{code}.json` | 회사별 egograph + enriched 데이터 | 2,664파일 |
