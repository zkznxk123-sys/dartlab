...
| 소비 | gather/listing(KRX), providers/dart/edgar(filings, topicSummaries) |
...
미지원 kind는 `ValueError("unknown kind: ... — supported: companies, filings, topics")`.
...
| `src/dartlab/gather/listing.py` | KRX/KIND 매퍼 (companies 데이터 소스) |
