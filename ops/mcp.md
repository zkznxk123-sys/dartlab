...
## 4. 도구 체계 — 기본 표면은 skills 기반 workbench다

AI/MCP가 공유하는 사용법·분석절차 SSOT는 `ops/skills.md`와 `src/dartlab/skills`다.
...
| 품질 규칙 | `src/dartlab/ai/verify.py` 의 ref 기반 verify/release | 새 품질 규칙 추가 금지 |
...
- [ops/skills.md](skills.md) — AI/MCP 공용 skill resolver 원칙.
