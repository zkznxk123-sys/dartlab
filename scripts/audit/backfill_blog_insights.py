...
dry-run (기본)
    uv run python scripts/audit/backfill_blog_insights.py --blog-root blog/ --dry-run

실행
    uv run python scripts/audit/backfill_blog_insights.py --blog-root blog/ --confirm
"""
