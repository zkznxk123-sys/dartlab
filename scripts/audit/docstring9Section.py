...
사용법::
    ...
    uv run python -X utf8 scripts/audit/docstring9Section.py src/dartlab/gather
    uv run python -X utf8 scripts/audit/docstring9Section.py src/dartlab/gather --strict
    uv run python -X utf8 scripts/audit/docstring9Section.py src/dartlab/gather --update-baseline --baseline scripts/audit/_baselines/gatherDocstring9Section.json
"""
