...
사용법:
    uv run python -X utf8 scripts/audit/folderSize.py [target_path]
    uv run python -X utf8 scripts/audit/folderSize.py --strict
    uv run python -X utf8 scripts/audit/folderSize.py --update-baseline
