...
실행:
    python -X utf8 scripts/audit/namingConsistency.py            # 전수 검사 (경고 모드)
    python -X utf8 scripts/audit/namingConsistency.py --strict   # 위반 시 exit 2
    python -X utf8 scripts/audit/namingConsistency.py --all      # 전수 (기본도 동일)
