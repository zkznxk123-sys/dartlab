...
실행:
    uv run python -X utf8 scripts/audit/snakeCaseInventory.py
    uv run python -X utf8 scripts/audit/snakeCaseInventory.py --top 30
    uv run python -X utf8 scripts/audit/snakeCaseInventory.py --file src/dartlab/...
"""
