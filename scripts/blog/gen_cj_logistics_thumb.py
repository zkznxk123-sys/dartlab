...
BG_FILE = ASSETS / "067-thumbnail-bg.webp"

COMPANY = "CJ대한통운 (000120)"
TITLE_LINES = ["매출 3년 정체,", "영업이익은 23% 증가한다"]
SUBTITLE = "택배 1위 OPM 4% 천장과 마진 개선 4엔진 — 현대글로비스 7%의 절반"
...
def make_thumb() -> None:
    ...
    thumb_asset = ASSETS / "067-thumbnail.webp"
    thumb_landing = THUMBS / "000120-cj-logistics.webp"
