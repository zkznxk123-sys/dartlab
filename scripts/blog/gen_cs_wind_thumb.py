...
BG_FILE = ASSETS / "73-thumbnail-bg.webp"

COMPANY = "씨에스윈드 (112610)"
TITLE_LINES = ["매출 -4.6%·영업 +25%·", "현금 10배·순이익 -72%"]
SUBTITLE = "풍력 타워 글로벌 1위 · 4방향 반전 · 영업외 -2,665억이 이익 83% 흡수한 해"
...
def make_thumb() -> None:
    ...
    thumb_asset = ASSETS / "73-thumbnail.webp"
    thumb_landing = THUMBS / "112610-cs-wind.webp"
