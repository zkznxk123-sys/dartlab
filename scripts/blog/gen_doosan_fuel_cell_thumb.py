...
BG_FILE = ASSETS / "70-thumbnail-bg.webp"

COMPANY = "두산퓨얼셀 (336260)"
TITLE_LINES = ["매출 +10% 늘었는데", "영업적자 62배 확대"]
SUBTITLE = "매출원가율 113.7% · 매출총이익률 +8.78% → -13.70% 음수 역전 · 팔수록 적자인 해"
...
def make_thumb() -> None:
    ...
    thumb_asset = ASSETS / "70-thumbnail.webp"
    thumb_landing = THUMBS / "336260-doosan-fuel-cell.webp"
