...
BG_FILE = ASSETS / "75-thumbnail-bg.webp"
COMPANY = "한미사이언스 (008930)"
TITLE_LINES = ["5년 경영권 다큐 이후", "OPM 10.22% 기록"]
SUBTITLE = "한미약품(#57) 41% 지주회사 · 지분법 0→818억 V자 · 순이익 +108% 반등"
...
def make_thumb() -> None:
    ...
    thumb_asset = ASSETS / "75-thumbnail.webp"
    thumb_landing = THUMBS / "008930-hanmi-science.webp"
    rgb = bg.convert("RGB")
