"""LG에너지솔루션 #69 썸네일 생성 (MNST 풀블리드 스펙)."""
...
BG_FILE = ASSETS / "69-thumbnail-bg.webp"

COMPANY = "LG에너지솔루션 (373220)"
TITLE_LINES = ["매출 30% 줄었는데", "순이익은 800억"]
SUBTITLE = "영업이익률 2.25% → 5.69% V자 반등 · 금융비용·법인세가 1.27조를 먹어치운 해"
...
def make_thumb() -> None:
    ...
    thumb_asset = ASSETS / "69-thumbnail.webp"
    thumb_landing = THUMBS / "373220-lg-energy-solution.webp"
