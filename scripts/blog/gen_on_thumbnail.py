"""ON Semiconductor (#87) 썸네일 합성.

배경: blog/05-company-reports/87-ON-onsemi-sic-cycle-bill/assets/87-thumbnail-bg.webp
출력: landing/static/thumbnails/ON-onsemi-sic-cycle-bill.webp
"""
...
SRC_BG = ROOT / "blog/05-company-reports/87-ON-onsemi-sic-cycle-bill/assets/87-thumbnail-bg.webp"
THUMBS = ROOT / "landing/static/thumbnails"
MASCOT = ROOT / "landing/static/avatar-chart.png"
FONT_BOLD = "C:/Windows/Fonts/malgunbd.ttf"
FONT_REG = "C:/Windows/Fonts/malgun.ttf"

SLUG = "ON-onsemi-sic-cycle-bill"
COMPANY = "ON Semiconductor (NASDAQ: ON)"
TITLE = ["PEAK 19% 박았더니", "1년 만에 회색지대"]
SUB = "OPM 30.76% → 1.40% | 자사주 매입 2배 가속"
