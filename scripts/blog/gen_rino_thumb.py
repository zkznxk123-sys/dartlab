...
BG_FILE = ASSETS / "064-thumbnail-bg.webp"

COMPANY = "리노공업 (058470)"
TITLE_LINES = ["5mm 금속 핀 하나로", "영업이익률 48% 10년 지킴"]
SUBTITLE = "한미는 사이클 탔고, 리노는 사이클 벗어났다 — 포고핀 48년"
...
def make_thumb() -> None:
    ...
    d.text((50, 40), COMPANY, fill=(34, 197, 94, 255), font=f_company)
    ...
    thumb_asset = ASSETS / "064-thumbnail.webp"
    thumb_landing = THUMBS / "058470-rino-industrial.webp"
