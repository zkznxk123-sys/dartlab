...
BG_FILE = ASSETS / "068-thumbnail-bg.webp"

COMPANY = "삼성SDI (006400)"
TITLE_LINES = ["2년 만에 이익이", "3.3조 사라졌다"]
SUBTITLE = "EV 캐즘과 CAPEX 6.27조 피크의 타이밍 미스 — LG엔솔 +5.69%, 삼성SDI -12.98%"
...
def make_thumb() -> None:
    ...
    thumb_asset = ASSETS / "068-thumbnail.webp"
    thumb_landing = THUMBS / "006400-samsung-sdi.webp"
