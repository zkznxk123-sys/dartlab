...
BG_FILE = ASSETS / "72-thumbnail-bg.webp"

COMPANY = "실리콘투 (257720)"
TITLE_LINES = ["매출 3년 17배, 영업이익", "2,054억인데 현금 11억"]
SUBTITLE = "K-뷰티 유통 플랫폼 · 영업이익률 18.40% · 재고 3,001억 · 성장형 왜곡 첫 경보"
...
def make_thumb() -> None:
    ...
    thumb_asset = ASSETS / "72-thumbnail.webp"
    thumb_landing = THUMBS / "257720-silicon2.webp"
