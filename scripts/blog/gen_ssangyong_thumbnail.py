...
배경: blog/05-company-reports/88-003410-ssangyong-lbo-exit/assets/88-thumbnail-bg.webp
출력: landing/static/thumbnails/003410-ssangyong-lbo-exit.webp
"""
...
SRC_BG = ROOT / "blog/05-company-reports/88-003410-ssangyong-lbo-exit/assets/88-thumbnail-bg.webp"
THUMBS = ROOT / "landing/static/thumbnails"
MASCOT = ROOT / "landing/static/avatar-chart.png"
FONT_BOLD = "C:/Windows/Fonts/malgunbd.ttf"
FONT_REG = "C:/Windows/Fonts/malgun.ttf"

SLUG = "003410-ssangyong-lbo-exit"
COMPANY = "쌍용씨앤이 (003410)"
TITLE = ["9 년 들고 있던 시멘트 1 위는", "왜 모회사를 거꾸로 삼켰나"]
SUB = "한앤컴퍼니 1.44조 LBO | Altman Z 0.64 | 부채비율 641→102%"
