...
POSTS = [
    (
        "009450-kyungdong-navien",
        "경동나비엔 (009450)",
        ["민둥산의 연탄회사가", "미국 온수기를 먹다"],
        "매총이익률 42% | 북미 탱크리스 1위",
    ),
    (
        "439260-daehan-shipbuilding",
        "대한조선 (439260)",
    ...
    ("004370-nongshim", "농심 (004370)", ["라면 1위인데 왜", "마진은 삼양의 1/4?"], "1위의 저주 | OPM 5% vs 22%"),
    (
    ...
    ("011070-lg-innotek", "LG이노텍 (011070)", ["애플 독점인데", "왜 마진이 3%인가"], "매출 80% 애플 | OPM 3%"),
    (
    ...
    ("017670-skt", "SK텔레콤 (017670)", ["해킹 한 번이", "8년 공식을 깼다"], "2,500만명 유출 | OPM 10→6.3%"),
    ("006360-gs-engineering", "GS건설 (006360)", ["5,524억을 한 분기에", "몰아낸 빅배스"], "검단 붕괴 | 1년 만에 흑전"),
    (
        "011760-hyundai-corp",
        "현대코퍼레이션 (011760)",
        ["종합상사가 아니라", "자원 + 지주다"],
