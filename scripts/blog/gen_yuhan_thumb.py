...
BG_FILE = ASSETS / "71-thumbnail-bg.webp"

COMPANY = "유한양행 (000100)"
TITLE_LINES = ["영업이익 1,044억인데", "순이익은 1,853억"]
SUBTITLE = "영업외 +1,183억 · 유한킴벌리 지분법 + 렉라자 얀센 마일스톤이 본업을 보완한 해"
...
def make_thumb() -> None:
    ...
    thumb_asset = ASSETS / "71-thumbnail.webp"
    thumb_landing = THUMBS / "000100-yuhan.webp"
