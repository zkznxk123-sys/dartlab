...
#
# 사용법:
#     bash scripts/dev/ciFastLocal.sh             # 전체 (fresh venv + test-fast)
#     bash scripts/dev/ciFastLocal.sh --import    # mcp.server 등 import smoke 만
#     bash scripts/dev/ciFastLocal.sh --no-reset  # venv 재사용 (빠른 재시도)
#
