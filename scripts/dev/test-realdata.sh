...
#
# 사용법:
#   bash scripts/dev/test-realdata.sh                          # realData 전체 (파일별 독립)
#   bash scripts/dev/test-realdata.sh tests/realData/test_companyFacade.py  # 단일 파일
#   bash scripts/dev/test-realdata.sh --single -m freshInstall # 단일 세션 모드 (fresh 마커만)
#
# 메모리 규칙:
