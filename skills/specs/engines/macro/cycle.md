...
status: observed
category: engines
purpose: "macro engine application skill for 사이클: 경제 사이클 4국면 식별 + 전환 시퀀스 감지."
whenToUse:
  - "macro"
  - "cycle"
  - "사이클"
...
Reads market-level data for 제1막: 경제는 어디에 있나 and computes signals, regimes, and limitations. Company-level financial interpretation belongs to analysis.
