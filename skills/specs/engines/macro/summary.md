...
status: observed
category: engines
purpose: "macro engine application skill for 종합: 6막 전체 종합 — 점수 + 자산배분 + 40개 투자전략."
whenToUse:
  - "macro"
  - "summary"
  - "종합"
...
Reads market-level data for 종합: 종합 and computes signals, regimes, and limitations. Company-level financial interpretation belongs to analysis.
