...
status: observed
category: engines
purpose: "quant engine application skill for 지표: 45개 기술적 지표 DataFrame (SMA, EMA, MACD, RSI, BB 등)."
whenToUse:
  - "quant"
  - "indicators"
  - "지표"
...
Runs a 기술적 quantitative calculation. Confirm period, benchmark, target requirements, and for strategy/backtest axes separate rule and cost assumptions.
