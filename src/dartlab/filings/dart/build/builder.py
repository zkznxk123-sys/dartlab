...
from dartlab.filings.core.canonical import resolveBatch
from dartlab.filings.core.schema import SECTIONS_SCHEMA as SCHEMA_V5
from dartlab.filings.dart.build.refScan import scanRefBaseline
from dartlab.filings.dart.build.walker import (
    detectSchemaEra,
    walkSections,
)
...
def _readZip(zp: Path) -> tuple[str | None, list[str]]:
    ...
    """
    from dartlab.filings.dart.build.refScan.zipScanWorker import _decodeXmlBytes
...
def buildSections(
    ...
    *,
    ...
    from dartlab.filings.dart.build.refScan.refMatcher import (
...
def _main() -> None:
    """CLI entry — ``python -m dartlab.filings.dart.build.builder --codes 005930,005380``."""
    import argparse
