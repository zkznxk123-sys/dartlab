...
from dartlab.core.dartBuild import parseSectionsByTitle, splitLargeContent
from dartlab.core.dartClient import DartClient
from dartlab.core.dartConstants import MAX_CELL_BYTES
...
def _rcpRowsToTable(
    ...
    # 옮겨 사용자 화면 cold first build 영구 가속. build(parse) 위임은 core.dartBuild DIP.
    from dartlab.core.dartBuild import xmlChunkToMixed
