...
CAPABILITIES: dict[str, dict] = {
    ...
    "Company.analysis": {"kind": "property", "summary": "재무제표 완전 분석 — dual access (api-contract)."},
    "Company.ask": {
    ...
    "Company.credit": {"kind": "property", "summary": "독립 신용평가 — dual access."},
    "Company.currency": {
        "kind": "property",
    ...
    "Company.fiscalYearEnd": {"kind": "property", "summary": "회계연도 종료 월-일 (한국 종목은 12-31 표준)."},
    "Company.gather": {
    ...
    "Company.industry": {"kind": "method", "summary": "이 회사의 밸류체인 산업 내 위치를 분석한다."},
    ...
    "Company.quant": {"kind": "method", "summary": "주가 기술적 분석 — self-discovery 패턴."},
    "Company.rank": {
    ...
    "Company.review": {"kind": "property", "summary": "재무제표 구조화 보고서 — dual access."},
    ...
    "Company.select": {"kind": "property", "summary": "show() 결과에서 행/열 필터 — dual access."},
    "Company.show": {
        "kind": "property",
    ...
    "analysis": {"kind": "module", "summary": "Analysis 엔진 — L2 분석 모듈 통합."},
    "ask": {
    ...
    "gather.flow": {"capabilities": "외국인/기관 매매 동향 (KR 전용)", "kind": "gather_axis", "summary": "수급"},
    "gather.insider": {
    ...
    "gather.news": {"capabilities": "Google News RSS — 최근 30일", "kind": "gather_axis", "summary": "뉴스"},
    "gather.ownership": {"capabilities": "기관/외국인 보유 현황", "kind": "gather_axis", "summary": "지분"},
    "gather.peers": {
    ...
    "industry": {"kind": "function", "summary": "산업 매퍼엔진 진입점."},
    "listing": {"kind": "function", "summary": "목록 조회 단일 진입점."},
    "macro": {"kind": "function", "summary": "시��� 레��� 매크로 분석 — 6막 인과 서사."},
    "macro.assets": {"capabilities": "5대 자산 심층 해석 + Cu/Au + BEI 4분면", "kind": "macro_axis", "summary": "자산"},
    "macro.corporate": {
    ...
    "quant": {"kind": "function", "summary": "종목 레벨 정량분석 엔진 — 30축 7그룹."},
    "scan": {"kind": "function", "summary": "시장 전체 횡단분석 통합 엔트리포인트."},
    "scan.account": {
    ...
    "scan.debt": {"capabilities": "사채만기, 부채비율, ICR, 위험등급", "kind": "scan_axis", "summary": "부채구조"},
    "scan.disclosureRisk": {
    ...
    "scan.liquidity": {"capabilities": "유동비율 + 당좌비율 — 단기 지급능력", "kind": "scan_axis", "summary": "유동성"},
    "scan.macroBeta": {
    ...
    "topdown": {"kind": "function", "summary": "`dartlab.topdown(...)` 를 callable로 노출."},
