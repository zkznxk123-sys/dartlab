...
TOOLS: list[dict] = [
    ...
    {"name": 'companyAnalysis', "description": '14축 재무 심층 분석. 축: 수익구조, 안정성, 성장성, 현금흐름, 자금조달, 자산구조, 수익성, 효율성, 이익품질, 비용구조, 자본배분, 투자효율, 재무정합성, 종합평가', "params": {'stockCode': '_STOCK', 'axis': {'type': 'string', 'description': '그룹명 또는 축명'}, 'sub': {'type': 'string', 'description': '그룹 내 하위 축'}}, "required": ['stockCode']},
    ...
    {"name": 'companyReview', "description": '정리된 종합 보고서. 섹션: 수익구조, 안정성, 성장성, 현금흐름, 자금조달, 자산구조, 수익성, 효율성, 이익품질, 비용구조, 자본배분, 투자효율, 재무정합성, 종합평가, 가치평가, 지배구조, 공시변화, 비교분석, 매출전망', "params": {'stockCode': '_STOCK', 'section': {'type': 'string', 'description': '특정 섹션만'}}, "required": ['stockCode']},
    {"name": 'companyCredit', "description": '독립 신용등급 분석 (7축). 채무상환, 자본구조, 유동성, 현금흐름, 사업안정성, 재무신뢰성, 공시리스크.', "params": {'stockCode': '_STOCK', 'axis': {'type': 'string', 'description': '축명 (생략 시 종합)'}}, "required": ['stockCode']},
