...
TOOLS: list[dict] = [
    ...
    {"name": 'quantAnalysis', "description": '기술적/정량 분석. 38축.', "params": {'stockCode': '_STOCK', 'metric': {'type': 'string', 'enum': ['indicators', 'signals', 'verdict', 'momentum', 'volatility', 'regime', 'pattern', 'beta', 'factor', 'tailrisk', 'residual', 'liquidity', 'flow', 'volume', 'divergence', 'quality', 'value', 'earnings', 'sentiment', 'toneChange', 'eventSignal', 'riskText', 'governanceQuant', 'ranking', 'pairs', 'screen', 'meanvar', 'riskparity', 'allocation', 'altman', 'piotroski', 'beneish', 'accruals', 'qfactor', 'qmj', 'bab', 'surprise', 'fundmom'], 'description': '분석 축'}}, "required": ['stockCode']},
