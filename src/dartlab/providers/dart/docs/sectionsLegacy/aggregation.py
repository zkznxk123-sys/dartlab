...
from dartlab.providers.dart.docs.sectionsLegacy.expansion import _expandStructuredRows
from dartlab.providers.dart.docs.sectionsLegacy.pathNormalizer import _comparablePathInfo
from dartlab.providers.dart.docs.topicStandard import TOPIC_CANONICAL_CHAPTER

_log = logging.getLogger("dartlab.providers.dart.docs.sectionsLegacy.pipeline")
...
def _sectionsPolarsOnly(stockCode: str, topics: set[str] | None) -> pl.DataFrame | None:
    ...
    (5 종목 × shape/dtypes/values strict equals).
    """
    from dartlab.providers.dart.docs.sectionsLegacy.pipeline import _getPrepared
    from dartlab.providers.dart.docs.sectionsLegacy.runtime import detailTopicForTopic, projectionSuppressedTopics
