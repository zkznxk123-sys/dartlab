...
from dartlab.providers.dart.docs.sectionsLegacy.pipeline import _joinPathSegments, _splitPathSegments
from dartlab.providers.dart.docs.sectionsLegacy.sectionsBase import periodOrderValue, sortPeriods
...
from dartlab.providers.dart.docs.sectionsLegacy.analysisStructure import (  # noqa: E402, F401
    semanticCollisions,
    structureChanges,
    structureEvents,
    structureSummary,
