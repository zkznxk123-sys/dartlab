...
from dartlab.providers.dart.docs.sectionsLegacy.runtime import (
    applyProjections,
...
from dartlab.providers.dart.docs.sectionsLegacy.sectionsAssembler import (  # noqa: E402, F401
...
def _cacheSectionsResult(cacheKey: tuple[str, "frozenset[str] | None"], result: "pl.DataFrame | None") -> None:
    ...
    """
    from dartlab.providers.dart.docs.sectionsLegacy.diskCache import saveDiskCache as _saveDiskCache
...
from dartlab.providers.dart.docs.sectionsLegacy.aggregation import (  # noqa: F401
    _periodRowsForKey,
)
...
def _getPrepared(stockCode: str) -> _PreparedRows:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.diskCache import (
...
from dartlab.providers.dart.docs.sectionsLegacy.expansion import (  # noqa: F401
    _NOTES_TOPICS,
    _expandStructuredRows,
)
from dartlab.providers.dart.docs.sectionsLegacy.freqMeta import (  # noqa: F401
    _freqSortKey,
    _periodFreq,
    _rowFreqMeta,
)
from dartlab.providers.dart.docs.sectionsLegacy.pathNormalizer import (  # noqa: F401
...
from dartlab.providers.dart.docs.sectionsLegacy.periodIter import (  # noqa: F401
    _SECTIONS_REQUIRED_COLS,
    _periodSortKey,
    iterPeriodSubsets,
)
from dartlab.providers.dart.docs.sectionsLegacy.reportRows import (  # noqa: F401
    _REPORT_ROW_SCHEMA,
...
def sections(stockCode: str, topics: set[str] | None = None) -> pl.DataFrame | None:
    ...
    Requires:
        - polars
        - gc (대량 row 처리 후 회수)
        - dartlab.providers.dart.docs.sectionsLegacy.* (chunker/views/runtime/mapper)
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.diskCache import loadDiskCache as _loadDiskCache
...
from dartlab.providers.dart.docs.sectionsLegacy.dedupCleanup import (  # noqa: F401
    _CHAPTER_CATCH_ALL_RE,
    _dropChapterCatchAllDuplicates,
)
from dartlab.providers.dart.docs.sectionsLegacy.mapper import mapSectionTitle  # noqa: F401, E402
