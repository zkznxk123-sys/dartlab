...
from dartlab.providers.dart.docs.sectionsLegacy.mapper import mapSectionTitle, stripSectionPrefix
...
from dartlab.providers.dart.docs.sectionsLegacy.textStructureParse import (  # noqa: E402  re-export
    parseTextStructure,
