...
from dartlab.providers.dart.docs.sectionsLegacy.expansion import _headingPathStringsCached
from dartlab.providers.dart.docs.sectionsLegacy.mapper import mapSectionTitle
from dartlab.providers.dart.docs.sectionsLegacy.segmentKeyer import SegmentKeyer
from dartlab.providers.dart.docs.sectionsLegacy.tableParser import tableHeaderHash
from dartlab.providers.dart.docs.sectionsLegacy.textStructure import (
    _detectHeading,
    _headingKey,
)
from dartlab.providers.dart.docs.sectionsLegacy.v2.rowIdentity import computeRowIdentity
