...
def _hzGroupHeader(hc: list[str]) -> str:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.tableParser import _normalizeHeader
...
def _hzFixSubtable(sub, hc, dr):
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.tableParser import (
        _dataRows,
        _headerCells,
        _isJunk,
    )
...
def _hzCollectMultiYear(sub, pYear: int, p: str, allItems, seenItems, periodItemVal) -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.tableParser import _parseMultiYear
...
def _hzCollectKvMatrix(sub, p: str, allItems, seenItems, periodItemVal) -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.tableParser import _parseKeyValueOrMatrix
