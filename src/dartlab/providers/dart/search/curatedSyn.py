...
_LANDING = {
    ...
    "증자": ["유상증자", "무상증자", "신주발행"],
    "전환사채": ["신주인수권부사채", "교환사채"],
    "유상증자": ["유상증자결정", "신주발행", "주요사항보고서", "결정"],
    "무상증자": ["무상증자결정", "신주배정", "주요사항보고서", "결정"],
    "신주인수권부사채": ["신주인수권부사채권발행결정", "사채발행", "결정"],
    "자기주식": ["자기주식취득결정", "자기주식처분결정", "주요사항보고서"],
    "대표이사": ["대표이사변경"],
    "최대주주": ["최대주주변경", "주요사항보고서"],
    "주주총회": ["주주총회소집", "정기주주총회결과", "의안"],
    "타법인": ["타법인주식취득결정", "타법인주식처분결정", "주요사항보고서"],
    "영업양수도": ["영업양수결정", "영업양도결정", "주요사항보고서"],
    "유형자산": ["유형자산양수결정", "유형자산처분결정", "주요사항보고서"],
