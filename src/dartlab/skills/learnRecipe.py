...
사용법::
    ...
    uv run python -X utf8 src/dartlab/skills/learnRecipe.py "매출 증가 회사" "df = dartlab.scan('growth'); print(df.sort('매출CAGR', descending=True).head(20))"
    uv run python -X utf8 src/dartlab/skills/learnRecipe.py --batch seed.json
    uv run python -X utf8 src/dartlab/skills/learnRecipe.py --list
