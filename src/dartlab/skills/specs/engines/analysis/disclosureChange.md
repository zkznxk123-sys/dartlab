...
status: observed
category: engines
purpose: "analysis engine application skill for the 공시변화 axis: 이 회사의 공시가 뭐가 달라졌는가."
whenToUse:
  - "analysis"
  - "공시변화"
  - "이 회사의 공시가 뭐가 달라졌는가"
...
result = c.analysis("공시변화", "공시변화")
```

## 호출 동작

Reads the Company financial/disclosure/market snapshot required for the 공시변화 axis. The guide reports 4 calculation items. Missing values are represented through flags, assumptions, dataAsOf, nulls, or empty history; they are not zero-filled.
