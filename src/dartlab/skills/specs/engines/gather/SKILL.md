...
| flow | flow | 투자자별 수급 | `g.flow("005930", market="KR")` · `dartlab.gather("flow", "005930")` · `dartlab.gather("flow", "005930", limit=30)` · `dartlab.gather("flow", "005930", start=, end=, sleepSec=1.0)` · `dartlab.gather("flow", "005930", all=True, sleepSec=1.0)` |
