...
12 axis (price/flow/macro/news/sector/insider/ownership/peers/krx/krxIndex/calendar/commodity) 수집에서 다음 4 룰 강행:
...
| — | commodity | 원자재 선물 OHLCV (WTI/Brent/Copper/Gold/Silver, yfinance, key 0) | `dartlab.gather("commodity")` · `dartlab.gather("commodity", "Copper", period="6mo")` |
