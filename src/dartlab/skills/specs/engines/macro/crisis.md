...
status: observed
category: engines
purpose: "macro engine application skill for 위기: Credit-to-GDP gap + GHS + Minsky + 역사적 맥락."
whenToUse:
  - "macro"
  - "crisis"
  - "위기"
...
Reads market-level data for 제4막: 금융 시스템은 괜찮나 and computes signals, regimes, and limitations. Company-level financial interpretation belongs to analysis.
