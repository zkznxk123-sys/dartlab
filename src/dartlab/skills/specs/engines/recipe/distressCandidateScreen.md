---
id: engines.recipe.distressCandidateScreen
...
linkedSkills:
  ...
  - engines.recipe.creditQuantConsensus
toolRefs:
  - EngineCall
  - RunPython
requiredEvidence:
...
2. 각 종목 → `engines.recipe.creditQuantConsensus` 4-source 합의 추가 검증.
3. shocked stress → `engines.recipe.creditMacroStress` 매크로 충격 추가 영향.
