---
id: engines.recipe.dividendStressTest
...
2. dividend cut/suspend 시나리오 ≥ 2 → `engines.recipe.creditMacroStress` 와 결합 — 신용 axis 영향 동시 점검.
3. universe 검증은 `engines.recipe.distressCandidateScreen` 에 dividend payer 한정.
