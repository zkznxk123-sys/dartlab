---
id: engines.recipe.economicScenarioDiagram
...
linkedSkills:
  ...
  - engines.recipe.historicalPositioning
toolRefs:
  - RunPython
  - CompileVisual
requiredEvidence:
...
1. 여러 scenario 비교는 `engines.recipe.tailRiskScenarioScan`.
2. 역사적 사건 비교는 `engines.recipe.historicalPositioning`.
3. 차트형 수치 비교는 `engines.recipe.economicStressMatrixChart`.
