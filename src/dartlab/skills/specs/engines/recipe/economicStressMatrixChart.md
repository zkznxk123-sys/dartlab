---
id: engines.recipe.economicStressMatrixChart
...
linkedSkills:
  ...
  - engines.viz
  - engines.recipe.tailRiskScenarioScan
  - engines.recipe.dollarFundingStress
  - engines.recipe.creditCycleStressMap
toolRefs:
  - RunPython
  - CompileVisual
requiredEvidence:
...
1. 달러/환율 신호가 크면 `engines.recipe.dollarFundingStress`.
2. 신용/스프레드 신호가 크면 `engines.recipe.creditCycleStressMap`.
3. 금리곡선 신호가 크면 `engines.recipe.yieldCurveStress`.
