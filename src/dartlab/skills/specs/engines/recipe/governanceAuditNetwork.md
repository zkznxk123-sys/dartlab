---
id: engines.recipe.governanceAuditNetwork
...
2. 각 종목 → `engines.recipe.cashflowGovernanceDualSignal` 의 회사별 단독 검증.
3. distress 동시 발현 → `engines.recipe.distressCandidateScreen` 결과와 교집합.
