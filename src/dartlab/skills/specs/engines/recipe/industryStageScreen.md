---
id: engines.recipe.industryStageScreen
...
2. 통과 종목 → `engines.recipe.qualityMacroBeta` 와 결합 — 사이클 phase 정합성 추가 검증.
3. backtest → `engines.recipe.macroQuantScenarioBacktest` 로 시나리오 별 IR.
