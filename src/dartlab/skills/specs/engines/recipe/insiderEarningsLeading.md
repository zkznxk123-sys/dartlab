---
id: engines.recipe.insiderEarningsLeading
...
2. clusterFlag = True → `engines.recipe.filingTextSignal` 과 결합 — MD&A tone change 동행 검증.
3. universe 검증은 `engines.recipe.distressCandidateScreen` 의 inverse — cluster + low distress = 강한 매수 신호.
