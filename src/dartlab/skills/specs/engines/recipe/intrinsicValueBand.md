---
id: engines.recipe.intrinsicValueBand
...
3. EVA spread &gt; 0 + CFROI &gt; WACC = 진짜 capital efficiency → `engines.recipe.compounderCandidates` 와 합의.
4. EVA spread &lt; 0 + CFROI &lt; WACC = 자본 파괴 → `engines.recipe.distressFilter` 와 결합 검토.
