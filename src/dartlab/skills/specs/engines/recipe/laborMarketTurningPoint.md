---
id: engines.recipe.laborMarketTurningPoint
...
2. 금리곡선 선행 신호와 비교하려면 `engines.recipe.yieldCurveStress` 로 이동한다.
3. 신용 스트레스가 동반되면 `engines.recipe.creditCycleStressMap` 으로 확장한다.
