---
id: engines.recipe.piotroskiLite
...
linkedSkills:
  ...
  - engines.recipe.grahamDeepValue
...
2. fScore 6-7 점 종목에 대해 `engines.recipe.qualityValueScreen` 의 GP/A 게이트 추가 통과 여부 확인.
3. `engines.recipe.distressFilter` 로 위험 종목 제외.
