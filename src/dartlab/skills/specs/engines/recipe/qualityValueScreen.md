---
id: engines.recipe.qualityValueScreen
...
2. 상위 5~10 종목에 대해 `engines.recipe.valuationCheck` 로 단일 회사 가치평가 (DCF + valuation band) 심층.
3. `engines.recipe.distressFilter` 로 부도 위험 종목 제외.
