---
id: engines.recipe.thesisTracker
...
sourceRefs:
  ...
  - dartlab://skills/engines.recipe.companyDeepAnalysis
...
2. engines.recipe.companyDeepAnalysis — thesis 신규 작성 시 6 막 분석으로 본문 보강
3. engines.recipe.catalystCalendar — thesis 의 catalyst 영역 자동 갱신
4. engines.recipe.dailyMorningNote — 새 데이터 포인트 발견 시 thesis 갱신 trigger
