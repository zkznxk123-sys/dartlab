...
**5.3 unit test**
```powershell
bash tests/test-lock.sh tests/sections/test_panel_builder.py -v
```
...
panel.parquet 완벽 판단 (sectionsRawCompare spurious=0 종목 비율 ≥ 95%) 시:
- zip 저장 단계 폐기
...
- pytest `tests/sections/test_panel_builder.py`: 7 passed
...
복원. tests/sections/test_panel_builder.py 8 passed.
