---
id: recipes.cashflowGovernanceDualSignal
...
2. tripleFlag = True → `recipes.creditQuantConsensus` 와 결합 — Beneish M-score 분식 신호와 교차 검증.
3. universe 적용 → `recipes.governanceAuditNetwork` 로 cross-sectional flag.
