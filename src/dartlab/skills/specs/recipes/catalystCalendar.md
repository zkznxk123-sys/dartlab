...
2. recipes.dailyMorningNote — morning note 의 "오늘 주목" 섹션과 연동
3. recipes.thesisTracker — thesis 의 catalyst 영역 갱신
4. recipes.disclosureEvent — 발생한 이벤트 사후 분석 path
