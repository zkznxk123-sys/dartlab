---
id: recipes.distressCandidateScreen
...
2. 각 종목 → `recipes.creditQuantConsensus` 4-source 합의 추가 검증.
3. shocked stress → `recipes.creditMacroStress` 매크로 충격 추가 영향.
