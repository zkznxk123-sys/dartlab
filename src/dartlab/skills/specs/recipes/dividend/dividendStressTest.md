---
id: recipes.dividend.dividendStressTest
...
2. dividend cut/suspend 시나리오 ≥ 2 → `recipes.credit.creditMacroStress` 와 결합 — 신용 axis 영향 동시 점검.
3. universe 검증은 `recipes.credit.distressCandidateScreen` 에 dividend payer 한정.
