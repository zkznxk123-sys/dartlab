---
id: recipes.economicScenarioDiagram
...
1. 여러 scenario 비교는 `recipes.tailRiskScenarioScan`.
2. 역사적 사건 비교는 `recipes.historicalPositioning`.
3. 차트형 수치 비교는 `recipes.economicStressMatrixChart`.
