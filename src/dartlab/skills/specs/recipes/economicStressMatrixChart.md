---
id: recipes.economicStressMatrixChart
...
linkedSkills:
  ...
  - engines.viz
  - recipes.tailRiskScenarioScan
  - recipes.dollarFundingStress
  - recipes.creditCycleStressMap
toolRefs:
  - RunPython
  - CompileVisual
requiredEvidence:
...
1. 달러/환율 신호가 크면 `recipes.dollarFundingStress`.
2. 신용/스프레드 신호가 크면 `recipes.creditCycleStressMap`.
3. 금리곡선 신호가 크면 `recipes.yieldCurveStress`.
