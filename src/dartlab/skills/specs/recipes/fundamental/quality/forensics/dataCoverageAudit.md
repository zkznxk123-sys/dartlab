---
id: recipes.fundamental.quality.forensics.dataCoverageAudit
...
toolRefs:
  ...
  - RunPython
sourceRefs:
  - dartlab://skills/recipes.fundamental.quality.forensics.dataCoverageAudit
requiredEvidence:
  - skillRef
  - target
  - tableRef
...
2. recipes.fundamental.quality.forensics.accountTraceLedger - metric별 raw 계정 trace 확인.
3. recipes.fundamental.quality.forensics.revenueToCashBridge - coverage 충분 시 매출-현금 bridge 실행.
