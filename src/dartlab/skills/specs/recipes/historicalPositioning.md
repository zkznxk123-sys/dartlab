---
id: recipes.historicalPositioning
...
1. 위기 유사성이 높으면 `recipes.creditCycleStressMap`.
2. scenario 손실 분포가 필요하면 `recipes.tailRiskScenarioScan`.
3. 한국 시장 적용이 핵심이면 `recipes.koreaMacroStressMap`.
