---
id: recipes.incubator.eventRadar.consensusDriftWatch
...
knowledgeRefs:
  - engines.gather
sourceRefs:
  - dartlab://skills/recipes.incubator.eventRadar.consensusDriftWatch
requiredEvidence:
  - skillRef
  - target
  - tableRef
...
1. recipes.incubator.eventRadar.eventInbox - 컨센서스 변화 전후 이벤트 확인.
2. recipes.incubator.eventRadar.falsifierLedger - stale update 반증.
