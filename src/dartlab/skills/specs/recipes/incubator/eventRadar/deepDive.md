---
id: recipes.incubator.eventRadar.deepDive
...
knowledgeRefs:
  ...
  - engines.viz
sourceRefs:
  - dartlab://skills/recipes.incubator.eventRadar.deepDive
requiredEvidence:
  - skillRef
  - target
  - tableRef
...
1. recipes.incubator.eventRadar.sourceCoverageAudit - source coverage.
2. recipes.incubator.eventRadar.eventInbox - event inbox.
3. recipes.incubator.eventRadar.priceFlowReaction - price/flow reaction.
4. recipes.incubator.eventRadar.insiderOwnershipSignal - insider/ownership.
5. recipes.incubator.eventRadar.capitalActionMonitor - capital action.
6. recipes.incubator.eventRadar.consensusDriftWatch - consensus drift.
7. recipes.incubator.eventRadar.falsifierLedger - falsifier.
8. recipes.incubator.eventRadar.engineCandidateMemo - engine candidate.
9. recipes.incubator.eventRadar.visualDecisionPack - visual gate.
