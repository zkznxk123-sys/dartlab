---
id: recipes.incubator.eventRadar.falsifierLedger
...
sourceRefs:
  - dartlab://skills/recipes.incubator.eventRadar.falsifierLedger
requiredEvidence:
  - skillRef
  - target
  - tableRef
...
1. recipes.incubator.eventRadar.engineCandidateMemo - 반복 가능한 신호만 후보로 넘긴다.
2. recipes.incubator.eventRadar.deepDive - 최종 답변에 open falsifier를 포함한다.
