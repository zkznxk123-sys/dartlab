---
id: recipes.incubator.eventRadar.priceFlowReaction
...
knowledgeRefs:
  ...
  - engines.scan
sourceRefs:
  - dartlab://skills/recipes.incubator.eventRadar.priceFlowReaction
requiredEvidence:
  - skillRef
  - target
  - tableRef
...
1. recipes.incubator.eventRadar.eventInbox - 어떤 이벤트가 있었는지 확인.
2. recipes.incubator.eventRadar.falsifierLedger - market-wide move 반증.
