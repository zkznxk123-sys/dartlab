---
id: recipes.incubator.eventRadar.sourceCoverageAudit
...
knowledgeRefs:
  ...
  - engines.scan
sourceRefs:
  - dartlab://skills/recipes.incubator.eventRadar.sourceCoverageAudit
requiredEvidence:
  - skillRef
  - target
  - tableRef
...
1. recipes.incubator.eventRadar.index - 전체 팩 진입.
2. recipes.incubator.eventRadar.deepDive - 전체 ledger로 연결.
