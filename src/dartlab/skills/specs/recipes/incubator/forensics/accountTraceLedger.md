---
id: recipes.incubator.forensics.accountTraceLedger
...
1. recipes.incubator.forensics.dataCoverageAudit - 원표 coverage를 먼저 확인한다.
2. recipes.incubator.forensics.revenueToCashBridge - revenue, receivables, CFO, netIncome이 mapped이면 실행한다.
3. recipes.incubator.forensics.workingCapitalPressureMap - receivables, inventories, payables가 mapped이면 실행한다.
