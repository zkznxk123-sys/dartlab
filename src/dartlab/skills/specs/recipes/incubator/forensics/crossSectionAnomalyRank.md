---
id: recipes.incubator.forensics.crossSectionAnomalyRank
...
toolRefs:
  ...
  - EngineCall
sourceRefs:
  - dartlab://skills/recipes.incubator.forensics.crossSectionAnomalyRank
requiredEvidence:
  - skillRef
  - universe
  - tableRef
...
2. recipes.incubator.forensics.deepDive - 후보별 원표 검증.
3. recipes.incubator.forensics.engineCandidateMemo - 반복 성공 신호만 승격 후보.
