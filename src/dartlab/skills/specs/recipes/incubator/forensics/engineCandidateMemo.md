---
id: recipes.incubator.forensics.engineCandidateMemo
...
1. recipes.incubator.forensics.falsifierLedger - 반증 조건을 먼저 확인한다.
2. operation.skillDevelopmentLoop - selfRun/redTeam/graduate 규칙을 적용한다.
3. recipes.incubator.forensics.deepDive - ask 품질 관찰까지 포함해 재실행한다.
