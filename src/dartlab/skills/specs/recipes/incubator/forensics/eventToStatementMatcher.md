---
id: recipes.incubator.forensics.eventToStatementMatcher
...
toolRefs:
  ...
  - RunPython
sourceRefs:
  - dartlab://skills/recipes.incubator.forensics.eventToStatementMatcher
requiredEvidence:
  - skillRef
  - target
  - tableRef
...
1. recipes.incubator.forensics.noteSignalExtractor - 이벤트와 연결할 text signal을 먼저 만든다.
2. recipes.incubator.forensics.falsifierLedger - 기간·규모·본문 반증을 연다.
3. recipes.incubator.forensics.engineCandidateMemo - 반복 매칭 패턴을 엔진 후보로 남긴다.
