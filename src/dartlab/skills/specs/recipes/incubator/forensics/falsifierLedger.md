---
id: recipes.incubator.forensics.falsifierLedger
...
toolRefs:
  - RunPython
sourceRefs:
  - dartlab://skills/recipes.incubator.forensics.falsifierLedger
requiredEvidence:
  - skillRef
  - target
  - tableRef
...
1. recipes.incubator.forensics.eventToStatementMatcher - claim을 열 이벤트와 원표 신호를 확보한다.
2. recipes.incubator.forensics.engineCandidateMemo - 반증을 통과한 신호만 후보로 남김.
3. recipes.incubator.forensics.deepDive - 최종 ledger에 포함.
