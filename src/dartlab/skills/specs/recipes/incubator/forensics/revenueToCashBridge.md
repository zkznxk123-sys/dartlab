---
id: recipes.incubator.forensics.revenueToCashBridge
...
1. recipes.incubator.forensics.accountTraceLedger - revenue, receivables, CFO trace 확인.
2. recipes.incubator.forensics.workingCapitalPressureMap - 운전자본 압력과 함께 해석한다.
3. recipes.incubator.forensics.falsifierLedger - 반증 조건 확인.
4. recipes.incubator.forensics.engineCandidateMemo - 반복 가능 신호면 엔진 후보 등록.
