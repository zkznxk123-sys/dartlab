---
id: recipes.incubator.forensics.workingCapitalPressureMap
...
1. recipes.incubator.forensics.accountTraceLedger - receivables, inventories, payables trace를 확인한다.
2. recipes.incubator.forensics.noteSignalExtractor - 재고평가·대손 주석 확인.
3. recipes.incubator.forensics.falsifierLedger - backlog, 신제품, 계절성 반증.
