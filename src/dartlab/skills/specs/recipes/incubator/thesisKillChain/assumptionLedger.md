---
id: recipes.incubator.thesisKillChain.assumptionLedger
...
sourceRefs:
  - dartlab://skills/recipes.incubator.thesisKillChain.assumptionLedger
requiredEvidence:
  - skillRef
  - target
  - tableRef
...
1. recipes.incubator.thesisKillChain.fragilityMap - assumption을 깨는 지표 확인.
2. recipes.incubator.thesisKillChain.propagationPath - trigger와 assumption 연결.
