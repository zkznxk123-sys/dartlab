---
id: recipes.incubator.thesisKillChain.evidenceCoverageAudit
...
knowledgeRefs:
  ...
  - engines.scan
sourceRefs:
  - dartlab://skills/recipes.incubator.thesisKillChain.evidenceCoverageAudit
requiredEvidence:
  - skillRef
  - target
  - tableRef
...
1. recipes.incubator.thesisKillChain.fragilityMap - coverage가 있는 원자료만 사용.
2. recipes.incubator.thesisKillChain.visualDecisionPack - coverage chart gate.
