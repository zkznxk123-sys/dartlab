---
id: recipes.incubator.thesisKillChain.falsifierLedger
...
sourceRefs:
  - dartlab://skills/recipes.incubator.thesisKillChain.falsifierLedger
requiredEvidence:
  - skillRef
  - target
  - tableRef
...
1. recipes.incubator.thesisKillChain.scenarioStoryboard - open falsifier를 시나리오 한계로 포함.
2. recipes.incubator.thesisKillChain.deepDive - 최종 답변에 open falsifier 노출.
