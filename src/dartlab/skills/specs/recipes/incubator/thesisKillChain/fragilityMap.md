---
id: recipes.incubator.thesisKillChain.fragilityMap
...
knowledgeRefs:
  ...
  - engines.scan
sourceRefs:
  - dartlab://skills/recipes.incubator.thesisKillChain.fragilityMap
requiredEvidence:
  - skillRef
  - target
  - tableRef
...
1. recipes.incubator.thesisKillChain.triggerCatalog - watch/risk 지표를 trigger로 전환.
2. recipes.incubator.thesisKillChain.tripwireMonitor - 임계값과 모니터링 조건 생성.
