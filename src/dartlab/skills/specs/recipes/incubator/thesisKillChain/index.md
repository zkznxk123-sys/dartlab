---
id: recipes.incubator.thesisKillChain.index
...
knowledgeRefs:
  ...
  - engines.viz
sourceRefs:
  - dartlab://skills/recipes.incubator.thesisKillChain.index
requiredEvidence:
  - skillRef
  - target
  - tableRef
...
1. recipes.incubator.thesisKillChain.thesisIntake - thesis를 입력하고 theme을 파싱.
2. recipes.incubator.thesisKillChain.evidenceCoverageAudit - 원자료 coverage 확인.
3. recipes.incubator.thesisKillChain.assumptionLedger - 가정을 testable row로 분해.
4. recipes.incubator.thesisKillChain.fragilityMap - 원표·시장·기대 취약성 계산.
5. recipes.incubator.thesisKillChain.triggerCatalog - 촉발 조건 정리.
6. recipes.incubator.thesisKillChain.propagationPath - 깨지는 전파 경로 구성.
7. recipes.incubator.thesisKillChain.tripwireMonitor - 임계와 current 상태 확인.
