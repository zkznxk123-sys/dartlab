---
id: recipes.incubator.thesisKillChain.propagationPath
...
sourceRefs:
  - dartlab://skills/recipes.incubator.thesisKillChain.propagationPath
requiredEvidence:
  - skillRef
  - target
  - tableRef
...
1. recipes.incubator.thesisKillChain.tripwireMonitor - 경로별 임계값 확인.
2. recipes.incubator.thesisKillChain.scenarioStoryboard - path를 시나리오로 변환.
