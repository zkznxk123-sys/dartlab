---
id: recipes.incubator.thesisKillChain.scenarioStoryboard
...
sourceRefs:
  - dartlab://skills/recipes.incubator.thesisKillChain.scenarioStoryboard
requiredEvidence:
  - skillRef
  - target
  - tableRef
...
1. recipes.incubator.thesisKillChain.visualDecisionPack - scenario chart 가능 여부 확인.
2. recipes.incubator.thesisKillChain.deepDive - 최종 답변으로 연결.
