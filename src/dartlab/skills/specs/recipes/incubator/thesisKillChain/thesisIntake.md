---
id: recipes.incubator.thesisKillChain.thesisIntake
...
sourceRefs:
  - dartlab://skills/recipes.incubator.thesisKillChain.thesisIntake
requiredEvidence:
  - skillRef
  - target
  - tableRef
...
1. recipes.incubator.thesisKillChain.assumptionLedger - theme을 testable assumption으로 전환.
2. recipes.incubator.thesisKillChain.deepDive - 전체 pre-mortem 실행.
