---
id: recipes.incubator.thesisKillChain.tripwireMonitor
...
sourceRefs:
  - dartlab://skills/recipes.incubator.thesisKillChain.tripwireMonitor
requiredEvidence:
  - skillRef
  - target
  - tableRef
...
1. recipes.incubator.thesisKillChain.falsifierLedger - watch/risk 반증 조건.
2. recipes.incubator.thesisKillChain.scenarioStoryboard - tripwire를 시나리오로 변환.
