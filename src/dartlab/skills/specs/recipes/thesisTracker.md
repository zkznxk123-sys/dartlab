...
linkedSkills:
  - engines.company
  - engines.scan
  - recipes.companyDeepAnalysis
  - recipes.dailyMorningNote
toolRefs:
  - RunPython
  - EngineCall
  - SaveArtifact
...
sourceRefs:
  ...
  - dartlab://skills/recipes.companyDeepAnalysis
...
2. recipes.companyDeepAnalysis — thesis 신규 작성 시 6 막 분석으로 본문 보강
3. recipes.catalystCalendar — thesis 의 catalyst 영역 자동 갱신
4. recipes.dailyMorningNote — 새 데이터 포인트 발견 시 thesis 갱신 trigger
