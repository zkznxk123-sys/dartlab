"""[shim] synth/corporateAggregate → macro/corporateAggregate 도메인 복귀 (0.10 까지 BC).
...
def __getattr__(name: str):
    ...
    try:
        ...
        raise AttributeError(f"module 'dartlab.synth.corporateAggregate' has no attribute {name!r}") from exc
