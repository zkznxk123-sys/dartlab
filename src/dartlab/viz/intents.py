...
VIZ_INTENTS: tuple[VizIntent, ...] = (
    ...
    VizIntent(
        ...
        purpose="composition",
        statement="BS",
        component="balance_structure_trend",
        periodMode="Q",
        compareMode="latest",
    ...
    VizIntent(
        ...
        purpose="bridge",
        statement="CF",
        component="cashflow_signed_matrix",
        periodMode="Q",
        compareMode="yoy",
    ...
    VizIntent(
        ...
        purpose="bridge",
        statement="CF",
        component="capital_allocation_bridge",
        periodMode="Q",
        compareMode="latest",
