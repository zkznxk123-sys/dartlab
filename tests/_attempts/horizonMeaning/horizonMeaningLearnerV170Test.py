...
TARGET_MEMBER_TRACE_ALIGNMENT_SOURCE_SLOT_CACHE: dict[
    tuple[int, str, tuple[str, ...]], tuple[Counter[str], Counter[str]]
] = {}
TARGET_MEMBER_TRACE_ALIGNMENT_COHORT_CACHE: dict[
    tuple[int, str, str, tuple[str, ...]], tuple[tuple[str, ...], Counter[str]]
] = {}
TARGET_MEMBER_TRACE_ALIGNMENT_CORE_CACHE: dict[tuple[int, str, str, tuple[str, ...]], tuple[float, Counter[str]]] = {}
TARGET_MEMBER_TRACE_ALIGNMENT_PROOF_CACHE: dict[tuple[int, str, str, tuple[str, ...]], tuple[float, Counter[str]]] = {}
TARGET_MEMBER_TRACE_ALIGNMENT_SCORE_CACHE: dict[
    tuple[int, str, tuple[str, ...]], tuple[Counter[str], Counter[str]]
] = {}
...
def main() -> None:
    ...
    print(
        ...
        f"targetMemberTraceAlignProbeBadTop5={targetMemberTraceAlignProbeBadTop5}/{len(NEGATIVE_PROBES)} "
        f"targetMemberTraceAlignPoolRows={targetMemberTraceAlignPoolRows} "
        f"targetMemberTraceAlignScored={targetMemberTraceAlignScored} "
        f"targetMemberTraceAlignRouteRows={targetMemberTraceAlignRouteRows} "
        f"targetMemberTraceAlignProofRows={targetMemberTraceAlignProofRows} "
        f"targetMemberTraceAlignPeerRows={targetMemberTraceAlignPeerRows} "
        f"targetMemberTraceAlignPositiveResidualRows={targetMemberTraceAlignPositiveResidualRows} "
        f"targetMemberTraceAlignNegativeResidualRows={targetMemberTraceAlignNegativeResidualRows} "
        f"targetMemberTraceAlignProofMilli={targetMemberTraceAlignProofMilli} "
        f"targetMemberTraceAlignResidualMilli={targetMemberTraceAlignResidualMilli} "
        ...
        f"targetMemberFrameTraceAlignProofRows={targetMemberFrameTraceAlignProofRows} "
        f"targetMemberFrameTraceAlignPeerRows={targetMemberFrameTraceAlignPeerRows} "
        f"targetMemberFrameTraceAlignPositiveResidualRows={targetMemberFrameTraceAlignPositiveResidualRows} "
        f"targetMemberFrameTraceAlignNegativeResidualRows={targetMemberFrameTraceAlignNegativeResidualRows} "
        f"targetMemberFrameTraceAlignProofMilli={targetMemberFrameTraceAlignProofMilli} "
        f"targetMemberFrameTraceAlignResidualMilli={targetMemberFrameTraceAlignResidualMilli} "
        f"targetMemberFrameTraceAlignFrameInputRows={targetMemberFrameTraceAlignFrameInputRows} "
        f"targetMemberFrameTraceAlignFrameOutputRows={targetMemberFrameTraceAlignFrameOutputRows} "
        f"targetMemberFrameTraceAlignFrameAnchorRows={targetMemberFrameTraceAlignFrameAnchorRows} "
        f"targetMemberFrameTraceAlignFrameCohortRows={targetMemberFrameTraceAlignFrameCohortRows} "
        f"targetMemberFrameTraceAlignFrameInjectedRows={targetMemberFrameTraceAlignFrameInjectedRows} "
        f"targetMemberFrameTraceAlignFrameRejectedRows={targetMemberFrameTraceAlignFrameRejectedRows} "
        f"targetMemberFrameTraceAlignFrameProofMilli={targetMemberFrameTraceAlignFrameProofMilli} "
        f"targetMemberFrameTraceAlignFrameInjectedProofMilli={targetMemberFrameTraceAlignFrameInjectedProofMilli} "
