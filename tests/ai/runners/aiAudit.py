...
사용법::
    ...
    uv run python -X utf8 tests/ai/runners/aiAudit.py              # 9개 전체
    uv run python -X utf8 tests/ai/runners/aiAudit.py --quick      # 3개만
    uv run python -X utf8 tests/ai/runners/aiAudit.py --stock 005930
    uv run python -X utf8 tests/ai/runners/aiAudit.py --provider gemini
