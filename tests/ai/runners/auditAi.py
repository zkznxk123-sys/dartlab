...
사용법::
    ...
    uv run python tests/ai/runners/auditAi.py                    # 전체 질문셋 실행
    uv run python tests/ai/runners/auditAi.py --id single_review # 특정 질문만
    uv run python tests/ai/runners/auditAi.py --id scan_growth   # 특정 질문만
"""
