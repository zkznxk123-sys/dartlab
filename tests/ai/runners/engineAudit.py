...
사용법::
    ...
    uv run python -X utf8 tests/ai/runners/engineAudit.py              # 전체 종목
    uv run python -X utf8 tests/ai/runners/engineAudit.py --stock 005930
    uv run python -X utf8 tests/ai/runners/engineAudit.py --quick      # 핵심만
