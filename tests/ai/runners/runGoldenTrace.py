...
사용:
    uv run python -X utf8 tests/ai/runners/runGoldenTrace.py [--version v1]
    uv run python -X utf8 tests/ai/runners/runGoldenTrace.py --case c1_samsung_health  # 단일 케이스만
"""
