...
사용법::
    ...
    uv run python -X utf8 tests/audit/bootstrapTiming.py

    # 임계치 조정
    uv run python -X utf8 tests/audit/bootstrapTiming.py --threshold 3.0

    # 특정 종목만
    uv run python -X utf8 tests/audit/bootstrapTiming.py --codes 005930 000660
