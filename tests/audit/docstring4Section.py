...
_BASELINE = _REPO / "tests" / "audit" / "_baselines" / "docstring4Section.json"
...
def main() -> int:
    ...
    parser.add_argument("--baseline", default=None, help="baseline JSON path (기본 _baselines/docstring4Section.json)")
