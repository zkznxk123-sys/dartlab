...
사용법:
    uv run python -X utf8 tests/audit/providerGate.py
    uv run python -X utf8 tests/audit/providerGate.py --providers dart,edgar
    uv run python -X utf8 tests/audit/providerGate.py --strict   # baseline 무시
    uv run python -X utf8 tests/audit/providerGate.py --json     # 결과 JSON 출력
"""
...
_AUDIT_SCRIPTS = [
    ("룰 2 — 폴더 mirror", "tests/audit/folderMirror.py"),
    ("룰 3 — LoC 임계", "tests/audit/folderSize.py"),
    ("룰 4 — __init__ thin", "tests/audit/initThin.py"),
    ("룰 5 — _*.py 0", "tests/audit/underscoreModules.py"),
    ("룰 6 — docstring 4-섹션", "tests/audit/docstring4Section.py"),
    ("룰 8 — limit keyword", "tests/audit/limitDefault.py"),
]
