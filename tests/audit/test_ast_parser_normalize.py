...
_ROOT = Path(__file__).resolve().parent.parent.parent / "src" / "dartlab" / "providers" / "dart" / "docs" / "finance"
...
def test_no_global_raw_unit_multiply():
    ...
    """
    docs_root = Path(__file__).resolve().parent.parent.parent / "src" / "dartlab" / "providers" / "dart" / "docs"
