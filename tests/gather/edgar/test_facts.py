...
def test_company_facts_to_rows_callable() -> None:
    ...
    from dartlab.gather.edgar.facts import companyFactsToRows
...
def test_get_company_concept_json_callable() -> None:
    ...
    from dartlab.gather.edgar.facts import getCompanyConceptJson
...
def test_get_company_facts_json_callable() -> None:
    ...
    from dartlab.gather.edgar.facts import getCompanyFactsJson
...
def test_get_frame_json_callable() -> None:
    ...
    from dartlab.gather.edgar.facts import getFrameJson
