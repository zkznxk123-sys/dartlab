...
def test_imports():
    try:
        import dartlab.providers.dart.docs.sectionsArchive.chunker  # noqa: F401
...
def test_chunk_rows_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsArchive.chunker import chunkRows
...
def test_chunk_section_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsArchive.chunker import chunkSection
...
def test_parse_sub_num_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsArchive.chunker import parseSubNum
...
def test_separate_table_and_text_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsArchive.chunker import separateTableAndText
...
def test_split_by_headings_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsArchive.chunker import splitByHeadings
