...
def test_imports():
    try:
        import dartlab.providers.dart.docs.sectionsLegacy.extractors  # noqa: F401
...
def test_parse_subtopic_table_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.extractors import parseSubtopicTable
...
def test_topic_subtables_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.extractors import topicSubtables
