...
def test_imports():
    try:
        import dartlab.providers.dart.docs.sections.mapper  # noqa: F401
...
def test_measure_mapping_rate_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sections.mapper import measureMappingRate
...
def test_normalize_section_title_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sections.mapper import normalizeSectionTitle
