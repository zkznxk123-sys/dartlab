...
def test_imports():
    try:
        import dartlab.providers.dart.docs.sectionsLegacy.mapper  # noqa: F401
...
def test_load_section_mappings_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.mapper import loadSectionMappings
...
def test_normalize_section_title_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.mapper import normalizeSectionTitle
...
def test_strip_section_prefix_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.mapper import stripSectionPrefix
