...
def test_imports():
    try:
        import dartlab.providers.dart.docs.sectionsLegacy.runtime  # noqa: F401
...
def test_apply_projections_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.runtime import applyProjections
...
def test_base_chunk_path_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.runtime import baseChunkPath
...
def test_chapter_teacher_topics_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.runtime import chapterTeacherTopics
...
def test_detail_topic_for_block_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.runtime import detailTopicForBlock
...
def test_detail_topic_for_topic_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.runtime import detailTopicForTopic
...
def test_extract_semantic_units_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.runtime import extractSemanticUnits
...
def test_projection_suppressed_topics_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.runtime import projectionSuppressedTopics
...
def test_semantic_topic_for_block_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.runtime import semanticTopicForBlock
...
def test_semantic_topic_for_label_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.runtime import semanticTopicForLabel
...
def test_split_by_major_heading_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.runtime import splitByMajorHeading
