...
def test_display_period_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sections.sectionsBase import displayPeriod
...
def test_format_period_range_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sections.sectionsBase import formatPeriodRange
...
def test_period_columns_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sections.sectionsBase import periodColumns
...
def test_period_sort_key_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sections.sectionsBase import periodSortKey
...
def test_raw_period_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sections.sectionsBase import rawPeriod
...
def test_reorder_period_columns_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sections.sectionsBase import reorderPeriodColumns
