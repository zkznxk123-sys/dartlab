...
def test_imports():
    try:
        import dartlab.providers.dart.docs.sectionsLegacy.sectionsBase  # noqa: F401
...
def test_base_path_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.sectionsBase import basePath
...
def test_display_period_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.sectionsBase import displayPeriod
...
def test_format_period_range_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.sectionsBase import formatPeriodRange
...
def test_period_columns_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.sectionsBase import periodColumns
...
def test_period_order_value_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.sectionsBase import periodOrderValue
...
def test_period_sort_key_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.sectionsBase import periodSortKey
...
def test_raw_period_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.sectionsBase import rawPeriod
...
def test_reorder_period_columns_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.sectionsBase import reorderPeriodColumns
...
def test_sort_periods_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.sectionsBase import sortPeriods
