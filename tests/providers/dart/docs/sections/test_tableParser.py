...
def test_imports():
    try:
        import dartlab.providers.dart.docs.sectionsLegacy.tableParser  # noqa: F401
...
def test_build_table_data_frame_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.tableParser import buildTableDataFrame
...
def test_split_subtables_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.tableParser import splitSubtables
