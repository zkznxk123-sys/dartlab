...
def test_imports():
    try:
        import dartlab.providers.dart.docs.sectionsLegacy.textStructure  # noqa: F401
...
def test_parse_text_structure_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.textStructure import parseTextStructure
