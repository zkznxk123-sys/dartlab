...
def test_imports():
    try:
        import dartlab.providers.dart.docs.sections.types  # noqa: F401
...
def test_compare_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sections.types import SectionResult
...
def test_by_kind_callable() -> None:
    ...
    from dartlab.providers.dart.docs.sections.types import YearSections
