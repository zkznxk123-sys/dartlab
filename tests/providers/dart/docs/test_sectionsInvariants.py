...
def test_no_pivot_key_collision(stockCode: str, caplog) -> None:
    ...
    with caplog.at_level(logging.WARNING, logger="dartlab.providers.dart.docs.sectionsLegacy.pipeline"):
...
def test_chapter_dedup_8char_recall() -> None:
    ...
    """
    from dartlab.providers.dart.docs.sectionsLegacy.pipeline import _splitContentBlocks
