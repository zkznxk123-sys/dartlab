...
def test_imports():
    try:
        import dartlab.providers.dart.openapi.collector  # noqa: F401
...
def test_iter_uncollected_callable() -> None:
    ...
    from dartlab.providers.dart.openapi.collector import iterUncollected
...
def test_iter_uncollected_kind_callable() -> None:
    ...
    from dartlab.providers.dart.openapi.collector import iterUncollectedKind
...
def test_list_uncollected_callable() -> None:
    ...
    from dartlab.providers.dart.openapi.collector import listUncollected
