...
def test_company_sections_uses_artifact_when_present(monkeypatch, tmp_path):
    ...
    from dartlab.providers.dart.docs.sectionsLegacy.sectionsStorage import hasSectionsArtifact
...
def test_company_sections_falls_back_when_artifact_empty(monkeypatch, tmp_path):
    ...
    code = "EMPTYART"
    from dartlab.providers.dart.docs.sectionsLegacy.sectionsStorage import sectionsDir
