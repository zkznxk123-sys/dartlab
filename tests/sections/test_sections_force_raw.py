...
from dartlab.providers.dart.docs.sectionsArchive.sectionsBuilder import _forceRawSectionContent
...
def test_periodIter_recognizes_no_mixed_env(monkeypatch):
    ...
    from dartlab.providers.dart.docs.sectionsArchive import periodIter
    ...
    monkeypatch.setattr("dartlab.providers.dart.docs.sectionsArchive.periodIter.loadData", lambda *a, **kw: fakeDf)
