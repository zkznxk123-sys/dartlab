...
class TestViewerParseHelpers:
    ...
    def test_tableToMarkdown_simple_table(self):
        ...
        from dartlab.providers.dart._viewerParse import tableToMarkdown
    ...
    def test_htmlToText_preserves_table_markdown(self):
        from dartlab.providers.dart._viewerParse import htmlToText
    ...
    def test_parseSubDocs_multi_page(self):
        from dartlab.providers.dart._viewerParse import parseSubDocs
