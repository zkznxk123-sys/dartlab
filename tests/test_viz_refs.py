...
def test_table_ref_with_period_kind():
    from dartlab.viz import tableRef
...
def test_chart_evidence_binding_minimum():
    from dartlab.viz import chartEvidenceBinding
...
def test_series_point_refs_without_rcept():
    from dartlab.viz import seriesPointRefs
