<script lang="ts">
	...
	const themeStyles = () => ({
		...
		crosshair: { horizontal: { line: { color: 'rgba(255,255,255,0.6)' }, text: { backgroundColor: '#99203f', family: CHART_FONT } }, vertical: { line: { color: 'rgba(255,255,255,0.6)' }, text: { backgroundColor: '#99203f', family: CHART_FONT } } }
	});
