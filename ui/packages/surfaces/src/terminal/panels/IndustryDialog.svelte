...
<style>
	...
	.indGradeLeg { display: inline-flex; align-items: center; gap: 3px; font-size: 9px; color: #aeb6c2; }
	...
	.indFactStrip { display: flex; flex-wrap: wrap; gap: 4px 14px; margin-top: 8px; font-size: 10px; color: #aeb6c2; }
	...
	.indHint { font-size: 9px; color: #aeb6c2; line-height: 1.4; margin-top: 6px; font-style: italic; }
	/* 뷰 토글 + 순위표(보조) */
