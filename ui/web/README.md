...
- 🤖 **AI Model Selection**:  
  - Anthropic, AWS Bedrock, OpenAI, Azure OpenAI, Google, Vertex AI, OpenAI Responses API (incl. Azure)
...
- 💬 **Multimodal & File Interactions**:  
  - Upload and analyze images with Anthropic, GPT-4.5, GPT-4o, o1, Llama-Vision, and Gemini 📸  
