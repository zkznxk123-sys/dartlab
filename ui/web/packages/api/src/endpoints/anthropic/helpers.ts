...
/**
 * Gets the appropriate headers for Anthropic models with cache control
...
/**
 * Configures reasoning-related options for Anthropic models.
...
function configureReasoning(
  ...
  if (extendedOptions.thinking && modelName && supportsAdaptiveThinking(modelName)) {
     ...
     * added with Opus 4.7. The cast is required because the installed
