...
const TOOL_TITLES = {
	...
	engine_call: { in: "엔진 조건", out: "엔진 결과" },
	verify: { in: "검산 대상", out: "검산 결과" },
	ask: { in: "질문",          out: "답변" },
	read_skill: { in: "스킬 키",   out: "스킬 본문" },
	read_capability: { in: "API 키", out: "API 시그니처" },
	web_search: { in: "검색어",   out: "외부 결과" },
	save_artifact: { in: "저장 대상", out: "artifactRef" },
	propose_skill: { in: "절차 후보", out: "skill spec" },
};

/**
 * Tool 별 lucide-svelte 아이콘 이름 매핑.
 * ToolBlock 헤더가 이걸 보고 분기 — Terminal 단일 아이콘 일관성 → 도구 별 시각 식별성으로.
 * 컴포넌트 측에서 이 키로 동적 import 또는 switch.
 */
export const TOOL_ICONS = {
	...
	pastInsight: "History",
	industry: "Factory",
	validateStory: "CheckCheck",
	capabilities: "Wrench",
	pythonExec: "Code2",
	news: "Newspaper",
	liveFilings: "RadioTower",
	filings: "Files",
	disclosure: "FileText",
	diff: "GitCompareArrows",
	sectorInsights: "Building2",
	codeName: "Hash",
	causalWeights: "Network",
	keywordTrend: "TrendingUp",
	search_reference: "Search",
	read_context: "BookOpen",
	inspect_dataset: "Database",
	run_python: "Code2",
	compile_visual: "BarChart3",
	engine_call: "Cpu",
	verify: "CheckCheck",
	ask: "MessageSquare",
	read_skill: "BookOpen",
	read_capability: "Wrench",
	web_search: "Globe",
	save_artifact: "Save",
	propose_skill: "Sparkles",
};
 ...
 *
 * EvidenceModal 등 raw evidence 표면이 이 한 곳만 참조.
